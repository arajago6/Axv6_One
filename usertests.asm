...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
       b:	c7 44 24 04 82 41 00 	movl   $0x4182,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 85 3d 00 00       	call   3da0 <printf>
  fd = open("echo", 0);
      1b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      22:	00 
      23:	c7 04 24 6c 41 00 00 	movl   $0x416c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
      3d:	c7 44 24 04 8d 41 00 	movl   $0x418d,0x4(%esp)
      44:	00 
      45:	89 04 24             	mov    %eax,(%esp)
      48:	e8 53 3d 00 00       	call   3da0 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 a0 41 00 00 	movl   $0x41a0,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
      7f:	c7 44 24 04 ad 41 00 	movl   $0x41ad,0x4(%esp)
      86:	00 
      87:	89 04 24             	mov    %eax,(%esp)
      8a:	e8 11 3d 00 00       	call   3da0 <printf>
    exit();
      8f:	e8 84 3b 00 00       	call   3c18 <exit>
  }
  printf(stdout, "open test ok\n");
      94:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
      99:	c7 44 24 04 cb 41 00 	movl   $0x41cb,0x4(%esp)
      a0:	00 
      a1:	89 04 24             	mov    %eax,(%esp)
      a4:	e8 f7 3c 00 00       	call   3da0 <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
      b6:	c7 44 24 04 d9 41 00 	movl   $0x41d9,0x4(%esp)
      bd:	00 
      be:	89 04 24             	mov    %eax,(%esp)
      c1:	e8 da 3c 00 00       	call   3da0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
      c6:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
      cd:	00 
      ce:	c7 04 24 ea 41 00 00 	movl   $0x41ea,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
      e8:	c7 44 24 04 f0 41 00 	movl   $0x41f0,0x4(%esp)
      ef:	00 
      f0:	89 04 24             	mov    %eax,(%esp)
      f3:	e8 a8 3c 00 00       	call   3da0 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     109:	c7 44 24 04 0b 42 00 	movl   $0x420b,0x4(%esp)
     110:	00 
     111:	89 04 24             	mov    %eax,(%esp)
     114:	e8 87 3c 00 00       	call   3da0 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 27 42 00 	movl   $0x4227,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 34 42 00 	movl   $0x4234,0x4(%esp)
     151:	00 
     152:	89 04 24             	mov    %eax,(%esp)
     155:	e8 46 3c 00 00       	call   3da0 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 58 42 00 	movl   $0x4258,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 64 42 00 	movl   $0x4264,0x4(%esp)
     192:	00 
     193:	89 04 24             	mov    %eax,(%esp)
     196:	e8 05 3c 00 00       	call   3da0 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     1b3:	c7 44 24 04 88 42 00 	movl   $0x4288,0x4(%esp)
     1ba:	00 
     1bb:	89 04 24             	mov    %eax,(%esp)
     1be:	e8 dd 3b 00 00       	call   3da0 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 ea 41 00 00 	movl   $0x41ea,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     1f0:	c7 44 24 04 93 42 00 	movl   $0x4293,0x4(%esp)
     1f7:	00 
     1f8:	89 04 24             	mov    %eax,(%esp)
     1fb:	e8 a0 3b 00 00       	call   3da0 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     22e:	c7 44 24 04 ac 42 00 	movl   $0x42ac,0x4(%esp)
     235:	00 
     236:	89 04 24             	mov    %eax,(%esp)
     239:	e8 62 3b 00 00       	call   3da0 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     248:	c7 44 24 04 c7 42 00 	movl   $0x42c7,0x4(%esp)
     24f:	00 
     250:	89 04 24             	mov    %eax,(%esp)
     253:	e8 48 3b 00 00       	call   3da0 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 ea 41 00 00 	movl   $0x41ea,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     27a:	c7 44 24 04 da 42 00 	movl   $0x42da,0x4(%esp)
     281:	00 
     282:	89 04 24             	mov    %eax,(%esp)
     285:	e8 16 3b 00 00       	call   3da0 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     294:	c7 44 24 04 e7 42 00 	movl   $0x42e7,0x4(%esp)
     29b:	00 
     29c:	89 04 24             	mov    %eax,(%esp)
     29f:	e8 fc 3a 00 00       	call   3da0 <printf>
    exit();
     2a4:	e8 6f 39 00 00       	call   3c18 <exit>
  }
  printf(stdout, "small file test ok\n");
     2a9:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     2ae:	c7 44 24 04 fc 42 00 	movl   $0x42fc,0x4(%esp)
     2b5:	00 
     2b6:	89 04 24             	mov    %eax,(%esp)
     2b9:	e8 e2 3a 00 00       	call   3da0 <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     2cb:	c7 44 24 04 10 43 00 	movl   $0x4310,0x4(%esp)
     2d2:	00 
     2d3:	89 04 24             	mov    %eax,(%esp)
     2d6:	e8 c5 3a 00 00       	call   3da0 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     2db:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     2e2:	00 
     2e3:	c7 04 24 20 43 00 00 	movl   $0x4320,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     2fd:	c7 44 24 04 24 43 00 	movl   $0x4324,0x4(%esp)
     304:	00 
     305:	89 04 24             	mov    %eax,(%esp)
     308:	e8 93 3a 00 00       	call   3da0 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     34c:	8b 55 f4             	mov    -0xc(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 3e 43 00 	movl   $0x433e,0x4(%esp)
     35a:	00 
     35b:	89 04 24             	mov    %eax,(%esp)
     35e:	e8 3d 3a 00 00       	call   3da0 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 20 43 00 00 	movl   $0x4320,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     3a3:	c7 44 24 04 5c 43 00 	movl   $0x435c,0x4(%esp)
     3aa:	00 
     3ab:	89 04 24             	mov    %eax,(%esp)
     3ae:	e8 ed 39 00 00       	call   3da0 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3ec:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     3f1:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f4:	89 54 24 08          	mov    %edx,0x8(%esp)
     3f8:	c7 44 24 04 75 43 00 	movl   $0x4375,0x4(%esp)
     3ff:	00 
     400:	89 04 24             	mov    %eax,(%esp)
     403:	e8 98 39 00 00       	call   3da0 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     419:	c7 04 24 20 43 00 00 	movl   $0x4320,(%esp)
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     49a:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     49f:	c7 44 24 04 c4 43 00 	movl   $0x43c4,0x4(%esp)
     4a6:	00 
     4a7:	89 04 24             	mov    %eax,(%esp)
     4aa:	e8 f1 38 00 00       	call   3da0 <printf>
    exit();
     4af:	e8 64 37 00 00       	call   3c18 <exit>
  }
  printf(stdout, "big files ok\n");
     4b4:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     4b9:	c7 44 24 04 d7 43 00 	movl   $0x43d7,0x4(%esp)
     4c0:	00 
     4c1:	89 04 24             	mov    %eax,(%esp)
     4c4:	e8 d7 38 00 00       	call   3da0 <printf>
}
     4c9:	c9                   	leave  
     4ca:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4d1:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     4d6:	c7 44 24 04 e8 43 00 	movl   $0x43e8,0x4(%esp)
     4dd:	00 
     4de:	89 04 24             	mov    %eax,(%esp)
     4e1:	e8 ba 38 00 00       	call   3da0 <printf>

  name[0] = 'a';
     4e6:	c6 05 a0 a6 00 00 61 	movb   $0x61,0xa6a0
  name[2] = '\0';
     4ed:	c6 05 a2 a6 00 00 00 	movb   $0x0,0xa6a2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     503:	a2 a1 a6 00 00       	mov    %al,0xa6a1
    fd = open(name, O_CREATE|O_RDWR);
     508:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50f:	00 
     510:	c7 04 24 a0 a6 00 00 	movl   $0xa6a0,(%esp)
  ...
  name[0] = 'a';
     534:	c6 05 a0 a6 00 00 61 	movb   $0x61,0xa6a0
  name[2] = '\0';
     53b:	c6 05 a2 a6 00 00 00 	movb   $0x0,0xa6a2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     551:	a2 a1 a6 00 00       	mov    %al,0xa6a1
    unlink(name);
     556:	c7 04 24 a0 a6 00 00 	movl   $0xa6a0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56c:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     571:	c7 44 24 04 10 44 00 	movl   $0x4410,0x4(%esp)
     578:	00 
     579:	89 04 24             	mov    %eax,(%esp)
     57c:	e8 1f 38 00 00       	call   3da0 <printf>
}
     581:	c9                   	leave  
     582:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     589:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     58e:	c7 44 24 04 36 44 00 	movl   $0x4436,0x4(%esp)
     595:	00 
     596:	89 04 24             	mov    %eax,(%esp)
     599:	e8 02 38 00 00       	call   3da0 <printf>

  if(mkdir("dir0") < 0){
     59e:	c7 04 24 42 44 00 00 	movl   $0x4442,(%esp)
     5a5:	e8 d6 36 00 00       	call   3c80 <mkdir>
     5aa:	85 c0                	test   %eax,%eax
     5ac:	79 1a                	jns    5c8 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ae:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     5b3:	c7 44 24 04 47 44 00 	movl   $0x4447,0x4(%esp)
     5ba:	00 
     5bb:	89 04 24             	mov    %eax,(%esp)
     5be:	e8 dd 37 00 00       	call   3da0 <printf>
    exit();
     5c3:	e8 50 36 00 00       	call   3c18 <exit>
  }

  if(chdir("dir0") < 0){
     5c8:	c7 04 24 42 44 00 00 	movl   $0x4442,(%esp)
     5cf:	e8 b4 36 00 00       	call   3c88 <chdir>
     5d4:	85 c0                	test   %eax,%eax
     5d6:	79 1a                	jns    5f2 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d8:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     5dd:	c7 44 24 04 55 44 00 	movl   $0x4455,0x4(%esp)
     5e4:	00 
     5e5:	89 04 24             	mov    %eax,(%esp)
     5e8:	e8 b3 37 00 00       	call   3da0 <printf>
    exit();
     5ed:	e8 26 36 00 00       	call   3c18 <exit>
  }

  if(chdir("..") < 0){
     5f2:	c7 04 24 68 44 00 00 	movl   $0x4468,(%esp)
     5f9:	e8 8a 36 00 00       	call   3c88 <chdir>
     5fe:	85 c0                	test   %eax,%eax
     600:	79 1a                	jns    61c <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     602:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     607:	c7 44 24 04 6b 44 00 	movl   $0x446b,0x4(%esp)
     60e:	00 
     60f:	89 04 24             	mov    %eax,(%esp)
     612:	e8 89 37 00 00       	call   3da0 <printf>
    exit();
     617:	e8 fc 35 00 00       	call   3c18 <exit>
  }

  if(unlink("dir0") < 0){
     61c:	c7 04 24 42 44 00 00 	movl   $0x4442,(%esp)
     623:	e8 40 36 00 00       	call   3c68 <unlink>
     628:	85 c0                	test   %eax,%eax
     62a:	79 1a                	jns    646 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62c:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     631:	c7 44 24 04 7c 44 00 	movl   $0x447c,0x4(%esp)
     638:	00 
     639:	89 04 24             	mov    %eax,(%esp)
     63c:	e8 5f 37 00 00       	call   3da0 <printf>
    exit();
     641:	e8 d2 35 00 00       	call   3c18 <exit>
  }
  printf(stdout, "mkdir test\n");
     646:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     64b:	c7 44 24 04 36 44 00 	movl   $0x4436,0x4(%esp)
     652:	00 
     653:	89 04 24             	mov    %eax,(%esp)
     656:	e8 45 37 00 00       	call   3da0 <printf>
}
     65b:	c9                   	leave  
     65c:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     663:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     668:	c7 44 24 04 90 44 00 	movl   $0x4490,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 28 37 00 00       	call   3da0 <printf>
  if(exec("echo", echoargv) < 0){
     678:	c7 44 24 04 b0 5e 00 	movl   $0x5eb0,0x4(%esp)
     67f:	00 
     680:	c7 04 24 6c 41 00 00 	movl   $0x416c,(%esp)
     687:	e8 c4 35 00 00       	call   3c50 <exec>
     68c:	85 c0                	test   %eax,%eax
     68e:	79 1a                	jns    6aa <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     690:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
     695:	c7 44 24 04 9b 44 00 	movl   $0x449b,0x4(%esp)
     69c:	00 
     69d:	89 04 24             	mov    %eax,(%esp)
     6a0:	e8 fb 36 00 00       	call   3da0 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6c1:	c7 44 24 04 ad 44 00 	movl   $0x44ad,0x4(%esp)
     6c8:	00 
     6c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6d0:	e8 cb 36 00 00       	call   3da0 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     71c:	81 c2 a0 86 00 00    	add    $0x86a0,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     73b:	00 
     73c:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
     743:	00 
     ...
     753:	c7 44 24 04 bc 44 00 	movl   $0x44bc,0x4(%esp)
     75a:	00 
     75b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     762:	e8 39 36 00 00       	call   3da0 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7ac:	05 a0 86 00 00       	add    $0x86a0,%eax
     ...
     7c9:	c7 44 24 04 ca 44 00 	movl   $0x44ca,0x4(%esp)
     7d0:	00 
     7d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d8:	e8 c3 35 00 00       	call   3da0 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     812:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
     819:	00 
    ...
    if(total != 5 * 1033){
     ...
     83f:	c7 44 24 04 d8 44 00 	movl   $0x44d8,0x4(%esp)
     846:	00 
     847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84e:	e8 4d 35 00 00       	call   3da0 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     868:	c7 44 24 04 fe 44 00 	movl   $0x44fe,0x4(%esp)
     86f:	00 
     870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     877:	e8 24 35 00 00       	call   3da0 <printf>
    ...
    printf(1, "fork() failed\n");
     87e:	c7 44 24 04 ef 44 00 	movl   $0x44ef,0x4(%esp)
     885:	00 
     886:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     88d:	e8 0e 35 00 00       	call   3da0 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89f:	c7 44 24 04 08 45 00 	movl   $0x4508,0x4(%esp)
     8a6:	00 
     8a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8ae:	e8 ed 34 00 00       	call   3da0 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     901:	00 
     902:	c7 44 24 04 12 45 00 	movl   $0x4512,0x4(%esp)
     909:	00 
     ...
     917:	c7 44 24 04 14 45 00 	movl   $0x4514,0x4(%esp)
     91e:	00 
     91f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     926:	e8 75 34 00 00       	call   3da0 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     94d:	00 
     94e:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
     955:	00 
    ...
    printf(1, "preempt read error");
     963:	c7 44 24 04 28 45 00 	movl   $0x4528,0x4(%esp)
     96a:	00 
     96b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     972:	e8 29 34 00 00       	call   3da0 <printf>
  ...
  printf(1, "kill... ");
     984:	c7 44 24 04 3b 45 00 	movl   $0x453b,0x4(%esp)
     98b:	00 
     98c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     993:	e8 08 34 00 00       	call   3da0 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b9:	c7 44 24 04 44 45 00 	movl   $0x4544,0x4(%esp)
     9c0:	00 
     9c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c8:	e8 d3 33 00 00       	call   3da0 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9dc:	c7 44 24 04 4d 45 00 	movl   $0x454d,0x4(%esp)
     9e3:	00 
     9e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9eb:	e8 b0 33 00 00       	call   3da0 <printf>
}
     9f0:	c9                   	leave  
     9f1:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0d:	79 16                	jns    a25 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0f:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
     a16:	00 
     a17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1e:	e8 7d 33 00 00       	call   3da0 <printf>
      return;
    ...
    if(pid){
     ...
     a35:	c7 44 24 04 66 45 00 	movl   $0x4566,0x4(%esp)
     a3c:	00 
     a3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a44:	e8 57 33 00 00       	call   3da0 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a5a:	c7 44 24 04 76 45 00 	movl   $0x4576,0x4(%esp)
     a61:	00 
     a62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a69:	e8 32 33 00 00       	call   3da0 <printf>
}
     a6e:	c9                   	leave  
     a6f:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a76:	c7 44 24 04 83 45 00 	movl   $0x4583,0x4(%esp)
     a7d:	00 
     a7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a85:	e8 16 33 00 00       	call   3da0 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac2:	e8 c5 35 00 00       	call   408c <malloc>
    ...
    while(m1){
     ...
     ae0:	e8 6e 34 00 00       	call   3f53 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b30:	e8 1e 34 00 00       	call   3f53 <free>
    printf(1, "mem ok\n");
     b35:	c7 44 24 04 a7 45 00 	movl   $0x45a7,0x4(%esp)
     b3c:	00 
     b3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b44:	e8 57 32 00 00       	call   3da0 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b5b:	c7 44 24 04 af 45 00 	movl   $0x45af,0x4(%esp)
     b62:	00 
     b63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b6a:	e8 31 32 00 00       	call   3da0 <printf>

  unlink("sharedfd");
     b6f:	c7 04 24 be 45 00 00 	movl   $0x45be,(%esp)
     b76:	e8 ed 30 00 00       	call   3c68 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b7b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b82:	00 
     b83:	c7 04 24 be 45 00 00 	movl   $0x45be,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b98:	c7 44 24 04 c8 45 00 	movl   $0x45c8,0x4(%esp)
     b9f:	00 
     ba0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba7:	e8 f4 31 00 00       	call   3da0 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c0a:	c7 44 24 04 f4 45 00 	movl   $0x45f4,0x4(%esp)
     c11:	00 
     c12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c19:	e8 82 31 00 00       	call   3da0 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4f:	00 
     c50:	c7 04 24 be 45 00 00 	movl   $0x45be,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c65:	c7 44 24 04 14 46 00 	movl   $0x4614,0x4(%esp)
     c6c:	00 
     c6d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c74:	e8 27 31 00 00       	call   3da0 <printf>
    return;
  ...
  unlink("sharedfd");
     cf6:	c7 04 24 be 45 00 00 	movl   $0x45be,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d14:	c7 44 24 04 3f 46 00 	movl   $0x463f,0x4(%esp)
     d1b:	00 
     d1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d23:	e8 78 30 00 00       	call   3da0 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d38:	c7 44 24 04 4c 46 00 	movl   $0x464c,0x4(%esp)
     d3f:	00 
     d40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d47:	e8 54 30 00 00       	call   3da0 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d59:	c7 44 24 04 61 46 00 	movl   $0x4661,0x4(%esp)
     d60:	00 
     d61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d68:	e8 33 30 00 00       	call   3da0 <printf>

  unlink("f1");
     d6d:	c7 04 24 70 46 00 00 	movl   $0x4670,(%esp)
     d74:	e8 ef 2e 00 00       	call   3c68 <unlink>
  unlink("f2");
     d79:	c7 04 24 73 46 00 00 	movl   $0x4673,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d93:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
     d9a:	00 
     d9b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     da2:	e8 f9 2f 00 00       	call   3da0 <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     db2:	b8 70 46 00 00       	mov    $0x4670,%eax
     db7:	eb 05                	jmp    dbe <twofiles+0x6b>
     db9:	b8 73 46 00 00       	mov    $0x4673,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     ddd:	c7 44 24 04 76 46 00 	movl   $0x4676,0x4(%esp)
     de4:	00 
     de5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     dec:	e8 af 2f 00 00       	call   3da0 <printf>
    exit();
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e14:	c7 04 24 a0 86 00 00 	movl   $0x86a0,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e30:	00 
     e31:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
     e38:	00 
     ...
     e57:	c7 44 24 04 85 46 00 	movl   $0x4685,0x4(%esp)
     e5e:	00 
     e5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e66:	e8 35 2f 00 00       	call   3da0 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea7:	b8 70 46 00 00       	mov    $0x4670,%eax
     eac:	eb 05                	jmp    eb3 <twofiles+0x160>
     eae:	b8 73 46 00 00       	mov    $0x4673,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     edb:	05 a0 86 00 00       	add    $0x86a0,%eax
     ...
     efa:	74 19                	je     f15 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     efc:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
     f03:	00 
     f04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f0b:	e8 90 2e 00 00       	call   3da0 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f2e:	00 
     f2f:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
     f36:	00 
    ...
    if(total != 12*500){
     ...
     f66:	c7 44 24 04 a2 46 00 	movl   $0x46a2,0x4(%esp)
     f6d:	00 
     f6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f75:	e8 26 2e 00 00       	call   3da0 <printf>
      exit();
  ...
  unlink("f1");
     f8d:	c7 04 24 70 46 00 00 	movl   $0x4670,(%esp)
     f94:	e8 cf 2c 00 00       	call   3c68 <unlink>
  unlink("f2");
     f99:	c7 04 24 73 46 00 00 	movl   $0x4673,(%esp)
     fa0:	e8 c3 2c 00 00       	call   3c68 <unlink>

  printf(1, "twofiles ok\n");
     fa5:	c7 44 24 04 b3 46 00 	movl   $0x46b3,0x4(%esp)
     fac:	00 
     fad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fb4:	e8 e7 2d 00 00       	call   3da0 <printf>
}
     fb9:	c9                   	leave  
     fba:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fc1:	c7 44 24 04 c0 46 00 	movl   $0x46c0,0x4(%esp)
     fc8:	00 
     fc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fd0:	e8 cb 2d 00 00       	call   3da0 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fe3:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
     fea:	00 
     feb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ff2:	e8 a9 2d 00 00       	call   3da0 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1044:	79 19                	jns    105f <createdelete+0xa4>
      printf(1, "create failed\n");
    1046:	c7 44 24 04 76 46 00 	movl   $0x4676,0x4(%esp)
    104d:	00 
    104e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1055:	e8 46 2d 00 00       	call   3da0 <printf>
      exit();
    ...
    109b:	c7 44 24 04 d3 46 00 	movl   $0x46d3,0x4(%esp)
    10a2:	00 
    10a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10aa:	e8 f1 2c 00 00       	call   3da0 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    111a:	c7 44 24 04 e4 46 00 	movl   $0x46e4,0x4(%esp)
    1121:	00 
    1122:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1129:	e8 72 2c 00 00       	call   3da0 <printf>
      exit();
    ...
    114c:	c7 44 24 04 08 47 00 	movl   $0x4708,0x4(%esp)
    1153:	00 
    1154:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    115b:	e8 40 2c 00 00       	call   3da0 <printf>
      exit();
    ...
    11b2:	c7 44 24 04 e4 46 00 	movl   $0x46e4,0x4(%esp)
    11b9:	00 
    11ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11c1:	e8 da 2b 00 00       	call   3da0 <printf>
      exit();
    ...
    11e4:	c7 44 24 04 08 47 00 	movl   $0x4708,0x4(%esp)
    11eb:	00 
    11ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11f3:	e8 a8 2b 00 00       	call   3da0 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1256:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
    125d:	00 
    125e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1265:	e8 36 2b 00 00       	call   3da0 <printf>
}
    126a:	c9                   	leave  
    126b:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1272:	c7 44 24 04 39 47 00 	movl   $0x4739,0x4(%esp)
    1279:	00 
    127a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1281:	e8 1a 2b 00 00       	call   3da0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1286:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    128d:	00 
    128e:	c7 04 24 4a 47 00 00 	movl   $0x474a,(%esp)
  ...
  if(fd < 0){
    ...
    12a3:	c7 44 24 04 55 47 00 	movl   $0x4755,0x4(%esp)
    12aa:	00 
    12ab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b2:	e8 e9 2a 00 00       	call   3da0 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12c3:	00 
    12c4:	c7 44 24 04 6f 47 00 	movl   $0x476f,0x4(%esp)
    12cb:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e9:	00 
    12ea:	c7 04 24 4a 47 00 00 	movl   $0x474a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1385:	00 
    1386:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    138d:	00 
    ...
    139e:	c7 44 24 04 ab 47 00 	movl   $0x47ab,0x4(%esp)
    13a5:	00 
    13a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13ad:	e8 ee 29 00 00       	call   3da0 <printf>
    exit();
    13b2:	e8 61 28 00 00       	call   3c18 <exit>
  }
  if(buf[0] != 'h'){
    13b7:	0f b6 05 a0 86 00 00 	movzbl 0x86a0,%eax
    13be:	3c 68                	cmp    $0x68,%al
    13c0:	74 19                	je     13db <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13c2:	c7 44 24 04 c2 47 00 	movl   $0x47c2,0x4(%esp)
    13c9:	00 
    13ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13d1:	e8 ca 29 00 00       	call   3da0 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13e2:	00 
    13e3:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    13ea:	00 
    ...
    13fb:	c7 44 24 04 d9 47 00 	movl   $0x47d9,0x4(%esp)
    1402:	00 
    1403:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    140a:	e8 91 29 00 00       	call   3da0 <printf>
    exit();
  ...
  unlink("unlinkread");
    141f:	c7 04 24 4a 47 00 00 	movl   $0x474a,(%esp)
    1426:	e8 3d 28 00 00       	call   3c68 <unlink>
  printf(1, "unlinkread ok\n");
    142b:	c7 44 24 04 f2 47 00 	movl   $0x47f2,0x4(%esp)
    1432:	00 
    1433:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    143a:	e8 61 29 00 00       	call   3da0 <printf>
}
    143f:	c9                   	leave  
    1440:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1447:	c7 44 24 04 01 48 00 	movl   $0x4801,0x4(%esp)
    144e:	00 
    144f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1456:	e8 45 29 00 00       	call   3da0 <printf>

  unlink("lf1");
    145b:	c7 04 24 0b 48 00 00 	movl   $0x480b,(%esp)
    1462:	e8 01 28 00 00       	call   3c68 <unlink>
  unlink("lf2");
    1467:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
    146e:	e8 f5 27 00 00       	call   3c68 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1473:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    147a:	00 
    147b:	c7 04 24 0b 48 00 00 	movl   $0x480b,(%esp)
  ...
  if(fd < 0){
    ...
    1490:	c7 44 24 04 13 48 00 	movl   $0x4813,0x4(%esp)
    1497:	00 
    1498:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149f:	e8 fc 28 00 00       	call   3da0 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14b0:	00 
    14b1:	c7 44 24 04 6f 47 00 	movl   $0x476f,0x4(%esp)
    14b8:	00 
    ...
    14c9:	c7 44 24 04 26 48 00 	movl   $0x4826,0x4(%esp)
    14d0:	00 
    14d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d8:	e8 c3 28 00 00       	call   3da0 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    1562:	00 
    1563:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
  ...
  if(fd < 0){
    ...
    1578:	c7 44 24 04 75 48 00 	movl   $0x4875,0x4(%esp)
    157f:	00 
    1580:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1587:	e8 14 28 00 00       	call   3da0 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1598:	00 
    1599:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    15a0:	00 
    ...
    15b1:	c7 44 24 04 86 48 00 	movl   $0x4886,0x4(%esp)
    15b8:	00 
    15b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15c0:	e8 db 27 00 00       	call   3da0 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d5:	c7 44 24 04 0f 48 00 	movl   $0x480f,0x4(%esp)
    15dc:	00 
    15dd:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
    15e4:	e8 8f 26 00 00       	call   3c78 <link>
    15e9:	85 c0                	test   %eax,%eax
    15eb:	78 19                	js     1606 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15ed:	c7 44 24 04 97 48 00 	movl   $0x4897,0x4(%esp)
    15f4:	00 
    15f5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15fc:	e8 9f 27 00 00       	call   3da0 <printf>
    exit();
    1601:	e8 12 26 00 00       	call   3c18 <exit>
  }

  unlink("lf2");
    1606:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
    160d:	e8 56 26 00 00       	call   3c68 <unlink>
  if(link("lf2", "lf1") >= 0){
    1612:	c7 44 24 04 0b 48 00 	movl   $0x480b,0x4(%esp)
    1619:	00 
    161a:	c7 04 24 0f 48 00 00 	movl   $0x480f,(%esp)
    1621:	e8 52 26 00 00       	call   3c78 <link>
    1626:	85 c0                	test   %eax,%eax
    1628:	78 19                	js     1643 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    162a:	c7 44 24 04 b8 48 00 	movl   $0x48b8,0x4(%esp)
    1631:	00 
    1632:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1639:	e8 62 27 00 00       	call   3da0 <printf>
    exit();
    163e:	e8 d5 25 00 00       	call   3c18 <exit>
  }

  if(link(".", "lf1") >= 0){
    1643:	c7 44 24 04 0b 48 00 	movl   $0x480b,0x4(%esp)
    164a:	00 
    164b:	c7 04 24 db 48 00 00 	movl   $0x48db,(%esp)
    1652:	e8 21 26 00 00       	call   3c78 <link>
    1657:	85 c0                	test   %eax,%eax
    1659:	78 19                	js     1674 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    165b:	c7 44 24 04 dd 48 00 	movl   $0x48dd,0x4(%esp)
    1662:	00 
    1663:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    166a:	e8 31 27 00 00       	call   3da0 <printf>
    exit();
    166f:	e8 a4 25 00 00       	call   3c18 <exit>
  }

  printf(1, "linktest ok\n");
    1674:	c7 44 24 04 f9 48 00 	movl   $0x48f9,0x4(%esp)
    167b:	00 
    167c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1683:	e8 18 27 00 00       	call   3da0 <printf>
}
    1688:	c9                   	leave  
    1689:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1690:	c7 44 24 04 06 49 00 	movl   $0x4906,0x4(%esp)
    1697:	00 
    1698:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169f:	e8 fc 26 00 00       	call   3da0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1703:	c7 04 24 16 49 00 00 	movl   $0x4916,(%esp)
    ...
    1746:	c7 04 24 16 49 00 00 	movl   $0x4916,(%esp)
    ...
    1777:	c7 44 24 04 19 49 00 	movl   $0x4919,0x4(%esp)
    177e:	00 
    177f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1786:	e8 15 26 00 00       	call   3da0 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17db:	00 
    17dc:	c7 04 24 db 48 00 00 	movl   $0x48db,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    183e:	c7 44 24 04 35 49 00 	movl   $0x4935,0x4(%esp)
    1845:	00 
    1846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184d:	e8 4e 25 00 00       	call   3da0 <printf>
        exit();
    ...
    1870:	c7 44 24 04 4e 49 00 	movl   $0x494e,0x4(%esp)
    1877:	00 
    1878:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    187f:	e8 1c 25 00 00       	call   3da0 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18cb:	c7 44 24 04 6c 49 00 	movl   $0x496c,0x4(%esp)
    18d2:	00 
    18d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18da:	e8 c1 24 00 00       	call   3da0 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1905:	79 19                	jns    1920 <concreate+0x296>
      printf(1, "fork failed\n");
    1907:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
    190e:	00 
    190f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1916:	e8 85 24 00 00       	call   3da0 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a27:	c7 44 24 04 9d 49 00 	movl   $0x499d,0x4(%esp)
    1a2e:	00 
    1a2f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a36:	e8 65 23 00 00       	call   3da0 <printf>
}
    1a3b:	c9                   	leave  
    1a3c:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a43:	c7 44 24 04 ab 49 00 	movl   $0x49ab,0x4(%esp)
    1a4a:	00 
    1a4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a52:	e8 49 23 00 00       	call   3da0 <printf>

  unlink("x");
    1a57:	c7 04 24 12 45 00 00 	movl   $0x4512,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a71:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
    1a78:	00 
    1a79:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a80:	e8 1b 23 00 00       	call   3da0 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1adf:	00 
    1ae0:	c7 04 24 12 45 00 00 	movl   $0x4512,(%esp)
    ...
    1b11:	75 16                	jne    1b29 <linkunlink+0xec>
      link("cat", "x");
    1b13:	c7 44 24 04 12 45 00 	movl   $0x4512,0x4(%esp)
    1b1a:	00 
    1b1b:	c7 04 24 bc 49 00 00 	movl   $0x49bc,(%esp)
    1b22:	e8 51 21 00 00       	call   3c78 <link>
    1b27:	eb 0c                	jmp    1b35 <linkunlink+0xf8>
    } else {
      unlink("x");
    1b29:	c7 04 24 12 45 00 00 	movl   $0x4512,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b55:	c7 44 24 04 c0 49 00 	movl   $0x49c0,0x4(%esp)
    1b5c:	00 
    1b5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b64:	e8 37 22 00 00       	call   3da0 <printf>
}
    1b69:	c9                   	leave  
    1b6a:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b71:	c7 44 24 04 cf 49 00 	movl   $0x49cf,0x4(%esp)
    1b78:	00 
    1b79:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b80:	e8 1b 22 00 00       	call   3da0 <printf>
  unlink("bd");
    1b85:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
    1b8c:	e8 d7 20 00 00       	call   3c68 <unlink>

  fd = open("bd", O_CREATE);
    1b91:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b98:	00 
    1b99:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
  ...
  if(fd < 0){
    ...
    1bae:	c7 44 24 04 df 49 00 	movl   $0x49df,0x4(%esp)
    1bb5:	00 
    1bb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bbd:	e8 de 21 00 00       	call   3da0 <printf>
    exit();
  ...
  unlink("bd");
    1c48:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9c:	c7 44 24 04 09 4a 00 	movl   $0x4a09,0x4(%esp)
    1ca3:	00 
    1ca4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cab:	e8 f0 20 00 00       	call   3da0 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc2:	c7 44 24 04 1e 4a 00 	movl   $0x4a1e,0x4(%esp)
    1cc9:	00 
    1cca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd1:	e8 ca 20 00 00       	call   3da0 <printf>
}
    1cd6:	c9                   	leave  
    1cd7:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cde:	c7 44 24 04 29 4a 00 	movl   $0x4a29,0x4(%esp)
    1ce5:	00 
    1ce6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ced:	e8 ae 20 00 00       	call   3da0 <printf>

  unlink("ff");
    1cf2:	c7 04 24 36 4a 00 00 	movl   $0x4a36,(%esp)
    1cf9:	e8 6a 1f 00 00       	call   3c68 <unlink>
  if(mkdir("dd") != 0){
    1cfe:	c7 04 24 39 4a 00 00 	movl   $0x4a39,(%esp)
    1d05:	e8 76 1f 00 00       	call   3c80 <mkdir>
    1d0a:	85 c0                	test   %eax,%eax
    1d0c:	74 19                	je     1d27 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0e:	c7 44 24 04 3c 4a 00 	movl   $0x4a3c,0x4(%esp)
    1d15:	00 
    1d16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1d:	e8 7e 20 00 00       	call   3da0 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2e:	00 
    1d2f:	c7 04 24 54 4a 00 00 	movl   $0x4a54,(%esp)
  ...
  if(fd < 0){
    ...
    1d44:	c7 44 24 04 5a 4a 00 	movl   $0x4a5a,0x4(%esp)
    1d4b:	00 
    1d4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d53:	e8 48 20 00 00       	call   3da0 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d64:	00 
    1d65:	c7 44 24 04 36 4a 00 	movl   $0x4a36,0x4(%esp)
    1d6c:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddc:	00 
    1ddd:	c7 04 24 b8 4a 00 00 	movl   $0x4ab8,(%esp)
  ...
  if(fd < 0){
    ...
    1df2:	c7 44 24 04 c1 4a 00 	movl   $0x4ac1,0x4(%esp)
    1df9:	00 
    1dfa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e01:	e8 9a 1f 00 00       	call   3da0 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e12:	00 
    1e13:	c7 44 24 04 d9 4a 00 	movl   $0x4ad9,0x4(%esp)
    1e1a:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e38:	00 
    1e39:	c7 04 24 dc 4a 00 00 	movl   $0x4adc,(%esp)
  ...
  if(fd < 0){
    ...
    1e4e:	c7 44 24 04 e8 4a 00 	movl   $0x4ae8,0x4(%esp)
    1e55:	00 
    1e56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5d:	e8 3e 1f 00 00       	call   3da0 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e6e:	00 
    1e6f:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    1e76:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8b:	0f b6 05 a0 86 00 00 	movzbl 0x86a0,%eax
    1e92:	3c 66                	cmp    $0x66,%al
    1e94:	74 19                	je     1eaf <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e96:	c7 44 24 04 01 4b 00 	movl   $0x4b01,0x4(%esp)
    1e9d:	00 
    1e9e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea5:	e8 f6 1e 00 00       	call   3da0 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ff0:	00 
    1ff1:	c7 04 24 1c 4b 00 00 	movl   $0x4b1c,(%esp)
  ...
  if(fd < 0){
    ...
    2006:	c7 44 24 04 e6 4b 00 	movl   $0x4be6,0x4(%esp)
    200d:	00 
    200e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2015:	e8 86 1d 00 00       	call   3da0 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2026:	00 
    2027:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    202e:	00 
    ...
    203f:	c7 44 24 04 fe 4b 00 	movl   $0x4bfe,0x4(%esp)
    2046:	00 
    2047:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204e:	e8 4d 1d 00 00       	call   3da0 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2424:	c7 44 24 04 78 4e 00 	movl   $0x4e78,0x4(%esp)
    242b:	00 
    242c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2433:	e8 68 19 00 00       	call   3da0 <printf>

  unlink("bigwrite");
    2438:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2457:	00 
    2458:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
    ...
    246d:	c7 44 24 04 90 4e 00 	movl   $0x4e90,0x4(%esp)
    2474:	00 
    2475:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247c:	e8 1f 19 00 00       	call   3da0 <printf>
      exit();
    ...
    2496:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    249d:	00 
    ...
    24c2:	c7 44 24 04 a8 4e 00 	movl   $0x4ea8,0x4(%esp)
    24c9:	00 
    24ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d1:	e8 ca 18 00 00       	call   3da0 <printf>
        exit();
    ...
    unlink("bigwrite");
    24f0:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2510:	c7 44 24 04 ba 4e 00 	movl   $0x4eba,0x4(%esp)
    2517:	00 
    2518:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251f:	e8 7c 18 00 00       	call   3da0 <printf>
}
    2524:	c9                   	leave  
    2525:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252c:	c7 44 24 04 c7 4e 00 	movl   $0x4ec7,0x4(%esp)
    2533:	00 
    2534:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253b:	e8 60 18 00 00       	call   3da0 <printf>

  unlink("bigfile");
    2540:	c7 04 24 d5 4e 00 00 	movl   $0x4ed5,(%esp)
    2547:	e8 1c 17 00 00       	call   3c68 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254c:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2553:	00 
    2554:	c7 04 24 d5 4e 00 00 	movl   $0x4ed5,(%esp)
  ...
  if(fd < 0){
    ...
    2569:	c7 44 24 04 dd 4e 00 	movl   $0x4edd,0x4(%esp)
    2570:	00 
    2571:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2578:	e8 23 18 00 00       	call   3da0 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    259a:	c7 04 24 a0 86 00 00 	movl   $0x86a0,(%esp)
    25a1:	e8 c5 14 00 00       	call   3a6b <memset>
    if(write(fd, buf, 600) != 600){
    25a6:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ad:	00 
    25ae:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    25b5:	00 
    ...
    25c8:	c7 44 24 04 f3 4e 00 	movl   $0x4ef3,0x4(%esp)
    25cf:	00 
    25d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d7:	e8 c4 17 00 00       	call   3da0 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fd:	00 
    25fe:	c7 04 24 d5 4e 00 00 	movl   $0x4ed5,(%esp)
  ...
  if(fd < 0){
    ...
    2613:	c7 44 24 04 09 4f 00 	movl   $0x4f09,0x4(%esp)
    261a:	00 
    261b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2622:	e8 79 17 00 00       	call   3da0 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    2641:	00 
    2642:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    2649:	00 
    ...
    265e:	c7 44 24 04 1e 4f 00 	movl   $0x4f1e,0x4(%esp)
    2665:	00 
    2666:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266d:	e8 2e 17 00 00       	call   3da0 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    26a1:	c7 44 24 04 33 4f 00 	movl   $0x4f33,0x4(%esp)
    26a8:	00 
    26a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26b0:	e8 eb 16 00 00       	call   3da0 <printf>
      exit();
    26b5:	e8 5e 15 00 00       	call   3c18 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    26ba:	0f b6 05 a0 86 00 00 	movzbl 0x86a0,%eax
    ...
    26d4:	0f b6 05 cb 87 00 00 	movzbl 0x87cb,%eax
    ...
    26ec:	74 19                	je     2707 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    26ee:	c7 44 24 04 47 4f 00 	movl   $0x4f47,0x4(%esp)
    26f5:	00 
    26f6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26fd:	e8 9e 16 00 00       	call   3da0 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    2716:	c7 44 24 04 60 4f 00 	movl   $0x4f60,0x4(%esp)
    271d:	00 
    271e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2725:	e8 76 16 00 00       	call   3da0 <printf>
    exit();
    272a:	e8 e9 14 00 00       	call   3c18 <exit>
  }
  unlink("bigfile");
    272f:	c7 04 24 d5 4e 00 00 	movl   $0x4ed5,(%esp)
    2736:	e8 2d 15 00 00       	call   3c68 <unlink>

  printf(1, "bigfile test ok\n");
    273b:	c7 44 24 04 7a 4f 00 	movl   $0x4f7a,0x4(%esp)
    2742:	00 
    2743:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    274a:	e8 51 16 00 00       	call   3da0 <printf>
}
    274f:	c9                   	leave  
    2750:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27c4:	00 
    27c5:	c7 04 24 18 50 00 00 	movl   $0x5018,(%esp)
  ...
  if(fd < 0){
    ...
    27da:	c7 44 24 04 48 50 00 	movl   $0x5048,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e9:	e8 b2 15 00 00       	call   3da0 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2805:	00 
    2806:	c7 04 24 88 50 00 00 	movl   $0x5088,(%esp)
  ...
  if(fd < 0){
    ...
    281b:	c7 44 24 04 b8 50 00 	movl   $0x50b8,0x4(%esp)
    2822:	00 
    2823:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    282a:	e8 71 15 00 00       	call   3da0 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a25:	c7 44 24 04 61 52 00 	movl   $0x5261,0x4(%esp)
    2a2c:	00 
    2a2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a34:	e8 67 13 00 00       	call   3da0 <printf>

  fd = open("dirfile", O_CREATE);
    2a39:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a40:	00 
    2a41:	c7 04 24 6e 52 00 00 	movl   $0x526e,(%esp)
  ...
  if(fd < 0){
    ...
    2a56:	c7 44 24 04 76 52 00 	movl   $0x5276,0x4(%esp)
    2a5d:	00 
    2a5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a65:	e8 36 13 00 00       	call   3da0 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aaa:	00 
    2aab:	c7 04 24 a7 52 00 00 	movl   $0x52a7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ac0:	c7 44 24 04 b2 52 00 	movl   $0x52b2,0x4(%esp)
    2ac7:	00 
    2ac8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2acf:	e8 cc 12 00 00       	call   3da0 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ae0:	00 
    2ae1:	c7 04 24 a7 52 00 00 	movl   $0x52a7,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bc2:	00 
    2bc3:	c7 04 24 db 48 00 00 	movl   $0x48db,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd8:	c7 44 24 04 4c 53 00 	movl   $0x534c,0x4(%esp)
    2bdf:	00 
    2be0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be7:	e8 b4 11 00 00       	call   3da0 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c27:	c7 44 24 04 6b 53 00 	movl   $0x536b,0x4(%esp)
    2c2e:	00 
    2c2f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c36:	e8 65 11 00 00       	call   3da0 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c4b:	c7 44 24 04 7f 53 00 	movl   $0x537f,0x4(%esp)
    2c52:	00 
    2c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c5a:	e8 41 11 00 00       	call   3da0 <printf>
}
    2c5f:	c9                   	leave  
    2c60:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c67:	c7 44 24 04 8f 53 00 	movl   $0x538f,0x4(%esp)
    2c6e:	00 
    2c6f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c76:	e8 25 11 00 00       	call   3da0 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d28:	00 
    2d29:	c7 04 24 cf 53 00 00 	movl   $0x53cf,(%esp)
    ...
    unlink("xx");
    2d49:	c7 04 24 cf 53 00 00 	movl   $0x53cf,(%esp)
  ...
  chdir("/");
    2d63:	c7 04 24 f2 51 00 00 	movl   $0x51f2,(%esp)
    2d6a:	e8 19 0f 00 00       	call   3c88 <chdir>
  printf(1, "empty file name OK\n");
    2d6f:	c7 44 24 04 d2 53 00 	movl   $0x53d2,0x4(%esp)
    2d76:	00 
    2d77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d7e:	e8 1d 10 00 00       	call   3da0 <printf>
}
    2d83:	c9                   	leave  
    2d84:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d8b:	c7 44 24 04 e6 53 00 	movl   $0x53e6,0x4(%esp)
    2d92:	00 
    2d93:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d9a:	e8 01 10 00 00       	call   3da0 <printf>
    ...
    2dbe:	e8 55 0e 00 00       	call   3c18 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd9:	c7 44 24 04 f4 53 00 	movl   $0x53f4,0x4(%esp)
    2de0:	00 
    2de1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de8:	e8 b3 0f 00 00       	call   3da0 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2dfd:	c7 44 24 04 16 54 00 	movl   $0x5416,0x4(%esp)
    2e04:	00 
    2e05:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e0c:	e8 8f 0f 00 00       	call   3da0 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e2a:	c7 44 24 04 2a 54 00 	movl   $0x542a,0x4(%esp)
    2e31:	00 
    2e32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e39:	e8 62 0f 00 00       	call   3da0 <printf>
    exit();
    2e3e:	e8 d5 0d 00 00       	call   3c18 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e43:	c7 44 24 04 3d 54 00 	movl   $0x543d,0x4(%esp)
    2e4a:	00 
    2e4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e52:	e8 49 0f 00 00       	call   3da0 <printf>
}
    2e57:	c9                   	leave  
    2e58:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e63:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2e68:	c7 44 24 04 4b 54 00 	movl   $0x544b,0x4(%esp)
    2e6f:	00 
    2e70:	89 04 24             	mov    %eax,(%esp)
    2e73:	e8 28 0f 00 00       	call   3da0 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eb6:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    ...
    2ed0:	c7 44 24 04 56 54 00 	movl   $0x5456,0x4(%esp)
    2ed7:	00 
    2ed8:	89 04 24             	mov    %eax,(%esp)
    2edb:	e8 c0 0e 00 00       	call   3da0 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f0f:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2f14:	c7 44 24 04 71 54 00 	movl   $0x5471,0x4(%esp)
    2f1b:	00 
    2f1c:	89 04 24             	mov    %eax,(%esp)
    2f1f:	e8 7c 0e 00 00       	call   3da0 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f52:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2f57:	c7 44 24 04 88 54 00 	movl   $0x5488,0x4(%esp)
    2f5e:	00 
    2f5f:	89 04 24             	mov    %eax,(%esp)
    2f62:	e8 39 0e 00 00       	call   3da0 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2fb0:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    2fb5:	c7 44 24 04 a4 54 00 	movl   $0x54a4,0x4(%esp)
    2fbc:	00 
    2fbd:	89 04 24             	mov    %eax,(%esp)
    2fc0:	e8 db 0d 00 00       	call   3da0 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ffb:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3000:	c7 44 24 04 e2 54 00 	movl   $0x54e2,0x4(%esp)
    3007:	00 
    3008:	89 04 24             	mov    %eax,(%esp)
    300b:	e8 90 0d 00 00       	call   3da0 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    3031:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    ...
    3044:	c7 44 24 04 00 55 00 	movl   $0x5500,0x4(%esp)
    304b:	00 
    304c:	89 04 24             	mov    %eax,(%esp)
    304f:	e8 4c 0d 00 00       	call   3da0 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3098:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    ...
    30ab:	c7 44 24 04 38 55 00 	movl   $0x5538,0x4(%esp)
    30b2:	00 
    30b3:	89 04 24             	mov    %eax,(%esp)
    30b6:	e8 e5 0c 00 00       	call   3da0 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30ca:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    30cf:	c7 44 24 04 60 55 00 	movl   $0x5560,0x4(%esp)
    30d6:	00 
    30d7:	89 04 24             	mov    %eax,(%esp)
    30da:	e8 c1 0c 00 00       	call   3da0 <printf>
    exit();
  ...
  if(c != a){
    ...
    3119:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    ...
    312c:	c7 44 24 04 90 55 00 	movl   $0x5590,0x4(%esp)
    3133:	00 
    3134:	89 04 24             	mov    %eax,(%esp)
    3137:	e8 64 0c 00 00       	call   3da0 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3160:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3165:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
    316c:	00 
    316d:	89 04 24             	mov    %eax,(%esp)
    3170:	e8 2b 0c 00 00       	call   3da0 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31e1:	c7 44 24 04 ad 44 00 	movl   $0x44ad,0x4(%esp)
    31e8:	00 
    31e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31f0:	e8 ab 0b 00 00       	call   3da0 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3244:	00 
    3245:	c7 44 24 04 12 45 00 	movl   $0x4512,0x4(%esp)
    324c:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e5:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    32ea:	c7 44 24 04 ca 55 00 	movl   $0x55ca,0x4(%esp)
    32f1:	00 
    32f2:	89 04 24             	mov    %eax,(%esp)
    32f5:	e8 a6 0a 00 00       	call   3da0 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332b:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3330:	c7 44 24 04 e5 55 00 	movl   $0x55e5,0x4(%esp)
    3337:	00 
    3338:	89 04 24             	mov    %eax,(%esp)
    333b:	e8 60 0a 00 00       	call   3da0 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3371:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3376:	c7 44 24 04 f3 55 00 	movl   $0x55f3,0x4(%esp)
    337d:	00 
    337e:	89 04 24             	mov    %eax,(%esp)
    3381:	e8 1a 0a 00 00       	call   3da0 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33e3:	c7 04 24 02 56 00 00 	movl   $0x5602,(%esp)
    33ea:	e8 89 08 00 00       	call   3c78 <link>
    33ef:	83 f8 ff             	cmp    $0xffffffff,%eax
    33f2:	74 1a                	je     340e <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33f4:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    33f9:	c7 44 24 04 0d 56 00 	movl   $0x560d,0x4(%esp)
    3400:	00 
    3401:	89 04 24             	mov    %eax,(%esp)
    3404:	e8 97 09 00 00       	call   3da0 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    3421:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3426:	c7 44 24 04 26 56 00 	movl   $0x5626,0x4(%esp)
    342d:	00 
    342e:	89 04 24             	mov    %eax,(%esp)
    3431:	e8 6a 09 00 00       	call   3da0 <printf>
}
    3436:	c9                   	leave  
    3437:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    343e:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3443:	c7 44 24 04 33 56 00 	movl   $0x5633,0x4(%esp)
    344a:	00 
    344b:	89 04 24             	mov    %eax,(%esp)
    344e:	e8 4d 09 00 00       	call   3da0 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    3453:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    345a:	eb 2d                	jmp    3489 <bsstest+0x51>
    if(uninit[i] != '\0'){
    345c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    345f:	05 80 5f 00 00       	add    $0x5f80,%eax
    3464:	0f b6 00             	movzbl (%eax),%eax
    3467:	84 c0                	test   %al,%al
    3469:	74 1a                	je     3485 <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    346b:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3470:	c7 44 24 04 3d 56 00 	movl   $0x563d,0x4(%esp)
    3477:	00 
    3478:	89 04 24             	mov    %eax,(%esp)
    347b:	e8 20 09 00 00       	call   3da0 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3493:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3498:	c7 44 24 04 4e 56 00 	movl   $0x564e,0x4(%esp)
    349f:	00 
    34a0:	89 04 24             	mov    %eax,(%esp)
    34a3:	e8 f8 08 00 00       	call   3da0 <printf>
}
    34a8:	c9                   	leave  
    34a9:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34b0:	c7 04 24 5b 56 00 00 	movl   $0x565b,(%esp)
  ...
  if(pid == 0){
    ...
    34da:	c7 04 85 e0 5e 00 00 	movl   $0x5668,0x5ee0(,%eax,4)
    34e1:	68 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34ed:	7e e8                	jle    34d7 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34ef:	c7 05 5c 5f 00 00 00 	movl   $0x0,0x5f5c
    34f6:	00 00 00 
    printf(stdout, "bigarg test\n");
    34f9:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    34fe:	c7 44 24 04 45 57 00 	movl   $0x5745,0x4(%esp)
    3505:	00 
    3506:	89 04 24             	mov    %eax,(%esp)
    3509:	e8 92 08 00 00       	call   3da0 <printf>
    exec("echo", args);
    350e:	c7 44 24 04 e0 5e 00 	movl   $0x5ee0,0x4(%esp)
    3515:	00 
    3516:	c7 04 24 6c 41 00 00 	movl   $0x416c,(%esp)
    351d:	e8 2e 07 00 00       	call   3c50 <exec>
    printf(stdout, "bigarg test ok\n");
    3522:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3527:	c7 44 24 04 52 57 00 	movl   $0x5752,0x4(%esp)
    352e:	00 
    352f:	89 04 24             	mov    %eax,(%esp)
    3532:	e8 69 08 00 00       	call   3da0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3537:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    353e:	00 
    353f:	c7 04 24 5b 56 00 00 	movl   $0x565b,(%esp)
    ...
    3564:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    3569:	c7 44 24 04 62 57 00 	movl   $0x5762,0x4(%esp)
    3570:	00 
    3571:	89 04 24             	mov    %eax,(%esp)
    3574:	e8 27 08 00 00       	call   3da0 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    358a:	00 
    358b:	c7 04 24 5b 56 00 00 	movl   $0x565b,(%esp)
  ...
  if(fd < 0){
    ...
    35a0:	a1 c4 5e 00 00       	mov    0x5ec4,%eax
    35a5:	c7 44 24 04 7b 57 00 	movl   $0x577b,0x4(%esp)
    35ac:	00 
    35ad:	89 04 24             	mov    %eax,(%esp)
    35b0:	e8 eb 07 00 00       	call   3da0 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35c5:	c7 04 24 5b 56 00 00 	movl   $0x565b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35e1:	c7 44 24 04 90 57 00 	movl   $0x5790,0x4(%esp)
    35e8:	00 
    35e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35f0:	e8 ab 07 00 00       	call   3da0 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36cb:	c7 44 24 04 9d 57 00 	movl   $0x579d,0x4(%esp)
    36d2:	00 
    36d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36da:	e8 c1 06 00 00       	call   3da0 <printf>
    ...
    3702:	c7 44 24 04 a9 57 00 	movl   $0x57a9,0x4(%esp)
    3709:	00 
    370a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3711:	e8 8a 06 00 00       	call   3da0 <printf>
      break;
    ...
    3726:	00 
    3727:	c7 44 24 04 a0 86 00 	movl   $0x86a0,0x4(%esp)
    372e:	00 
    ...
    374e:	c7 44 24 04 b9 57 00 	movl   $0x57b9,0x4(%esp)
    3755:	00 
    3756:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    375d:	e8 3e 06 00 00       	call   3da0 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3872:	c7 44 24 04 c9 57 00 	movl   $0x57c9,0x4(%esp)
    3879:	00 
    387a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3881:	e8 1a 05 00 00       	call   3da0 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    388f:	a1 c8 5e 00 00       	mov    0x5ec8,%eax
    3894:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    389a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    389f:	a3 c8 5e 00 00       	mov    %eax,0x5ec8
  return randstate;
    38a4:	a1 c8 5e 00 00       	mov    0x5ec8,%eax
}
    38a9:	5d                   	pop    %ebp
    38aa:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3900:	00 
    3901:	c7 04 24 f3 57 00 00 	movl   $0x57f3,(%esp)
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3ce1:	e8 52 ff ff ff       	call   3c38 <write>
}
    3ce6:	c9                   	leave  
    3ce7:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3cf0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3cf7:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3cfb:	74 17                	je     3d14 <printint+0x2c>
    3cfd:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d01:	79 11                	jns    3d14 <printint+0x2c>
    neg = 1;
    3d03:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3d0a:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d0d:	f7 d8                	neg    %eax
    3d0f:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d12:	eb 06                	jmp    3d1a <printint+0x32>
  } else {
    x = xx;
    3d14:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d17:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3d1a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d21:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    3d24:	8d 41 01             	lea    0x1(%ecx),%eax
    3d27:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3d2a:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3d2d:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d30:	ba 00 00 00 00       	mov    $0x0,%edx
    3d35:	f7 f3                	div    %ebx
    3d37:	89 d0                	mov    %edx,%eax
    3d39:	0f b6 80 cc 5e 00 00 	movzbl 0x5ecc(%eax),%eax
    3d40:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    3d44:	8b 75 10             	mov    0x10(%ebp),%esi
    3d47:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d4a:	ba 00 00 00 00       	mov    $0x0,%edx
    3d4f:	f7 f6                	div    %esi
    3d51:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d54:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d58:	75 c7                	jne    3d21 <printint+0x39>
  if(neg)
    3d5a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d5e:	74 10                	je     3d70 <printint+0x88>
    buf[i++] = '-';
    3d60:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d63:	8d 50 01             	lea    0x1(%eax),%edx
    3d66:	89 55 f4             	mov    %edx,-0xc(%ebp)
    3d69:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    3d6e:	eb 1f                	jmp    3d8f <printint+0xa7>
    3d70:	eb 1d                	jmp    3d8f <printint+0xa7>
    putc(fd, buf[i]);
    3d72:	8d 55 dc             	lea    -0x24(%ebp),%edx
    3d75:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d78:	01 d0                	add    %edx,%eax
    3d7a:	0f b6 00             	movzbl (%eax),%eax
    3d7d:	0f be c0             	movsbl %al,%eax
    3d80:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d84:	8b 45 08             	mov    0x8(%ebp),%eax
    3d87:	89 04 24             	mov    %eax,(%esp)
    3d8a:	e8 31 ff ff ff       	call   3cc0 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3d8f:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3d93:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3d97:	79 d9                	jns    3d72 <printint+0x8a>
    putc(fd, buf[i]);
}
    3d99:	83 c4 30             	add    $0x30,%esp
    3d9c:	5b                   	pop    %ebx
    3d9d:	5e                   	pop    %esi
    3d9e:	5d                   	pop    %ebp
    3d9f:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    3da3:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3da6:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3dad:	8d 45 0c             	lea    0xc(%ebp),%eax
    3db0:	83 c0 04             	add    $0x4,%eax
    3db3:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3db6:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3dbd:	e9 7c 01 00 00       	jmp    3f3e <printf+0x19e>
    c = fmt[i] & 0xff;
    3dc2:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dc5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3dc8:	01 d0                	add    %edx,%eax
    3dca:	0f b6 00             	movzbl (%eax),%eax
    3dcd:	0f be c0             	movsbl %al,%eax
    3dd0:	25 ff 00 00 00       	and    $0xff,%eax
    3dd5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3dd8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3ddc:	75 2c                	jne    3e0a <printf+0x6a>
      if(c == '%'){
    3dde:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3de2:	75 0c                	jne    3df0 <printf+0x50>
        state = '%';
    3de4:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3deb:	e9 4a 01 00 00       	jmp    3f3a <printf+0x19a>
      } else {
        putc(fd, c);
    3df0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3df3:	0f be c0             	movsbl %al,%eax
    3df6:	89 44 24 04          	mov    %eax,0x4(%esp)
    3dfa:	8b 45 08             	mov    0x8(%ebp),%eax
    3dfd:	89 04 24             	mov    %eax,(%esp)
    3e00:	e8 bb fe ff ff       	call   3cc0 <putc>
    3e05:	e9 30 01 00 00       	jmp    3f3a <printf+0x19a>
      }
    } else if(state == '%'){
    3e0a:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e0e:	0f 85 26 01 00 00    	jne    3f3a <printf+0x19a>
      if(c == 'd'){
    3e14:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e18:	75 2d                	jne    3e47 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e1a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e1d:	8b 00                	mov    (%eax),%eax
    3e1f:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e26:	00 
    3e27:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e2e:	00 
    3e2f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e33:	8b 45 08             	mov    0x8(%ebp),%eax
    3e36:	89 04 24             	mov    %eax,(%esp)
    3e39:	e8 aa fe ff ff       	call   3ce8 <printint>
        ap++;
    3e3e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e42:	e9 ec 00 00 00       	jmp    3f33 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    3e47:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e4b:	74 06                	je     3e53 <printf+0xb3>
    3e4d:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e51:	75 2d                	jne    3e80 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e53:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e56:	8b 00                	mov    (%eax),%eax
    3e58:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e5f:	00 
    3e60:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e67:	00 
    3e68:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e6c:	8b 45 08             	mov    0x8(%ebp),%eax
    3e6f:	89 04 24             	mov    %eax,(%esp)
    3e72:	e8 71 fe ff ff       	call   3ce8 <printint>
        ap++;
    3e77:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e7b:	e9 b3 00 00 00       	jmp    3f33 <printf+0x193>
      } else if(c == 's'){
    3e80:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3e84:	75 45                	jne    3ecb <printf+0x12b>
        s = (char*)*ap;
    3e86:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e89:	8b 00                	mov    (%eax),%eax
    3e8b:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3e8e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3e92:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3e96:	75 09                	jne    3ea1 <printf+0x101>
          s = "(null)";
    3e98:	c7 45 f4 2e 58 00 00 	movl   $0x582e,-0xc(%ebp)
        while(*s != 0){
    3e9f:	eb 1e                	jmp    3ebf <printf+0x11f>
    3ea1:	eb 1c                	jmp    3ebf <printf+0x11f>
          putc(fd, *s);
    ...
    3eb6:	e8 05 fe ff ff       	call   3cc0 <putc>
          s++;
    3ebb:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    3ec7:	75 da                	jne    3ea3 <printf+0x103>
    3ec9:	eb 68                	jmp    3f33 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3ecb:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3ecf:	75 1d                	jne    3eee <printf+0x14e>
        putc(fd, *ap);
    ...
    3ee3:	e8 d8 fd ff ff       	call   3cc0 <putc>
        ap++;
    3ee8:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3eec:	eb 45                	jmp    3f33 <printf+0x193>
      } else if(c == '%'){
    3eee:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3ef2:	75 17                	jne    3f0b <printf+0x16b>
        putc(fd, c);
    ...
    3f04:	e8 b7 fd ff ff       	call   3cc0 <putc>
    3f09:	eb 28                	jmp    3f33 <printf+0x193>
      } else {
    ...
    3f19:	e8 a2 fd ff ff       	call   3cc0 <putc>
        putc(fd, c);
    ...
    3f2e:	e8 8d fd ff ff       	call   3cc0 <putc>
      }
      state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3f4b:	0f 85 71 fe ff ff    	jne    3dc2 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f62:	a1 68 5f 00 00       	mov    0x5f68,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    402d:	a3 68 5f 00 00       	mov    %eax,0x5f68
}
    4032:	c9                   	leave  
    4033:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    403a:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4041:	77 07                	ja     404a <morecore+0x16>
    nu = 4096;
    4043:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    404a:	8b 45 08             	mov    0x8(%ebp),%eax
    404d:	c1 e0 03             	shl    $0x3,%eax
    4050:	89 04 24             	mov    %eax,(%esp)
    4053:	e8 48 fc ff ff       	call   3ca0 <sbrk>
    4058:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    405b:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    405f:	75 07                	jne    4068 <morecore+0x34>
    return 0;
    4061:	b8 00 00 00 00       	mov    $0x0,%eax
    4066:	eb 22                	jmp    408a <morecore+0x56>
  hp = (Header*)p;
    4068:	8b 45 f4             	mov    -0xc(%ebp),%eax
    406b:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    406e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4071:	8b 55 08             	mov    0x8(%ebp),%edx
    4074:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4077:	8b 45 f0             	mov    -0x10(%ebp),%eax
    407a:	83 c0 08             	add    $0x8,%eax
    407d:	89 04 24             	mov    %eax,(%esp)
    4080:	e8 ce fe ff ff       	call   3f53 <free>
  return freep;
    4085:	a1 68 5f 00 00       	mov    0x5f68,%eax
}
    408a:	c9                   	leave  
    408b:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    408f:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4092:	8b 45 08             	mov    0x8(%ebp),%eax
    4095:	83 c0 07             	add    $0x7,%eax
    4098:	c1 e8 03             	shr    $0x3,%eax
    409b:	83 c0 01             	add    $0x1,%eax
    409e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    40a1:	a1 68 5f 00 00       	mov    0x5f68,%eax
    40a6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40a9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40ad:	75 23                	jne    40d2 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40af:	c7 45 f0 60 5f 00 00 	movl   $0x5f60,-0x10(%ebp)
    40b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40b9:	a3 68 5f 00 00       	mov    %eax,0x5f68
    40be:	a1 68 5f 00 00       	mov    0x5f68,%eax
    40c3:	a3 60 5f 00 00       	mov    %eax,0x5f60
    base.s.size = 0;
    40c8:	c7 05 64 5f 00 00 00 	movl   $0x0,0x5f64
    40cf:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    40d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40d5:	8b 00                	mov    (%eax),%eax
    40d7:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    40da:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40dd:	8b 40 04             	mov    0x4(%eax),%eax
    40e0:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    40e3:	72 4d                	jb     4132 <malloc+0xa6>
      if(p->s.size == nunits)
    40e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40e8:	8b 40 04             	mov    0x4(%eax),%eax
    40eb:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    40ee:	75 0c                	jne    40fc <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    40f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40f3:	8b 10                	mov    (%eax),%edx
    40f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40f8:	89 10                	mov    %edx,(%eax)
    40fa:	eb 26                	jmp    4122 <malloc+0x96>
      else {
        p->s.size -= nunits;
    40fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40ff:	8b 40 04             	mov    0x4(%eax),%eax
    4102:	2b 45 ec             	sub    -0x14(%ebp),%eax
    4105:	89 c2                	mov    %eax,%edx
    4107:	8b 45 f4             	mov    -0xc(%ebp),%eax
    410a:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    410d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4110:	8b 40 04             	mov    0x4(%eax),%eax
    4113:	c1 e0 03             	shl    $0x3,%eax
    4116:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4119:	8b 45 f4             	mov    -0xc(%ebp),%eax
    411c:	8b 55 ec             	mov    -0x14(%ebp),%edx
    411f:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4122:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4125:	a3 68 5f 00 00       	mov    %eax,0x5f68
      return (void*)(p + 1);
    412a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    412d:	83 c0 08             	add    $0x8,%eax
    4130:	eb 38                	jmp    416a <malloc+0xde>
    }
    if(p == freep)
    4132:	a1 68 5f 00 00       	mov    0x5f68,%eax
    4137:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    413a:	75 1b                	jne    4157 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    413c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    413f:	89 04 24             	mov    %eax,(%esp)
    4142:	e8 ed fe ff ff       	call   4034 <morecore>
    4147:	89 45 f4             	mov    %eax,-0xc(%ebp)
    414a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    414e:	75 07                	jne    4157 <malloc+0xcb>
        return 0;
    4150:	b8 00 00 00 00       	mov    $0x0,%eax
    4155:	eb 13                	jmp    416a <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    415a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    415d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4160:	8b 00                	mov    (%eax),%eax
    4162:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    4165:	e9 70 ff ff ff       	jmp    40da <malloc+0x4e>
}
    416a:	c9                   	leave  
    416b:	c3                   	ret    
