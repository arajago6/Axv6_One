...
80100049:	e8 19 4d 00 00       	call   80104d67 <initlock>
...
801000bd:	e8 c6 4c 00 00       	call   80104d88 <acquire>
...
80100104:	e8 e1 4c 00 00       	call   80104dea <release>
        return b;
...
8010017c:	e8 69 4c 00 00       	call   80104dea <release>
      return b;
...
8010023c:	e8 47 4b 00 00       	call   80104d88 <acquire>
...
801002a9:	e8 3c 4b 00 00       	call   80104dea <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 c8 49 00 00       	call   80104d88 <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 e2 85 10 80 	movl   $0x801085e2,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec eb 85 10 80 	movl   $0x801085eb,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 b2 48 00 00       	call   80104dea <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 f2 85 10 80 	movl   $0x801085f2,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 01 86 10 80 	movl   $0x80108601,(%esp)
...
8010058f:	e8 a5 48 00 00       	call   80104e39 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 03 86 10 80 	movl   $0x80108603,(%esp)
...
801006b2:	e8 eb 4a 00 00       	call   801051a2 <memmove>
    pos -= 80;
...
801006e1:	e8 ed 49 00 00       	call   801050d3 <memset>
  }
...
80100776:	e8 83 64 00 00       	call   80106bfe <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 77 64 00 00       	call   80106bfe <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 6b 64 00 00       	call   80106bfe <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 5e 64 00 00       	call   80106bfe <uartputc>
  cgaputc(c);
...
801007ba:	e8 c9 45 00 00       	call   80104d88 <acquire>
  while((c = getc()) >= 0){
...
80100914:	e8 d1 44 00 00       	call   80104dea <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 4a 44 00 00       	call   80104d88 <acquire>
  while(n > 0){
...
80100959:	e8 8c 44 00 00       	call   80104dea <release>
        ilock(ip);
...
801009fe:	e8 e7 43 00 00       	call   80104dea <release>
  ilock(ip);
...
80100a32:	e8 51 43 00 00       	call   80104d88 <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 79 43 00 00       	call   80104dea <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 07 86 10 	movl   $0x80108607,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
80100a96:	e8 cc 42 00 00       	call   80104d67 <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 0f 86 10 	movl   $0x8010860f,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 c0 dd 10 80 	movl   $0x8010ddc0,(%esp)
80100aaa:	e8 b8 42 00 00       	call   80104d67 <initlock>
...
80100b64:	e9 64 03 00 00       	jmp    80100ecd <exec+0x3de>
  ...
  if((pgdir = setupkvm()) == 0)
80100b69:	e8 e1 71 00 00       	call   80107d4f <setupkvm>
...
80100c0a:	e8 0e 75 00 00       	call   8010811d <allocuvm>
...
80100c48:	e8 e5 73 00 00       	call   80108032 <loaduvm>
...
80100cb1:	e8 67 74 00 00       	call   8010811d <allocuvm>
...
80100cd6:	e8 72 76 00 00       	call   8010834d <clearpteu>
  sp = sz;
...
80100d0c:	e8 2c 46 00 00       	call   8010533d <strlen>
...
80100d35:	e8 03 46 00 00       	call   8010533d <strlen>
...
80100d65:	e8 a8 77 00 00       	call   80108512 <copyout>
...
80100e0c:	e8 01 77 00 00       	call   80108512 <copyout>
...
80100e64:	e8 8a 44 00 00       	call   801052f3 <safestrcpy>
...
80100eb6:	e8 85 6f 00 00       	call   80107e40 <switchuvm>
  freevm(oldpgdir);
80100ebb:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ebe:	89 04 24             	mov    %eax,(%esp)
80100ec1:	e8 ed 73 00 00       	call   801082b3 <freevm>
  return 0;
...
80100ed9:	e8 d5 73 00 00       	call   801082b3 <freevm>
  if(ip)
...
80100efc:	c7 44 24 04 15 86 10 	movl   $0x80108615,0x4(%esp)
80100f03:	80 
80100f04:	c7 04 24 80 de 10 80 	movl   $0x8010de80,(%esp)
80100f0b:	e8 57 3e 00 00       	call   80104d67 <initlock>
}
80100f10:	c9                   	leave  
80100f11:	c3                   	ret    
...
80100f1f:	e8 64 3e 00 00       	call   80104d88 <acquire>
...
80100f48:	e8 9d 3e 00 00       	call   80104dea <release>
      return f;
...
80100f66:	e8 7f 3e 00 00       	call   80104dea <release>
  return 0;
...
80100f7f:	e8 04 3e 00 00       	call   80104d88 <acquire>
  if(f->ref < 1)
...
80100f8c:	7f 0c                	jg     80100f9a <filedup+0x28>
    panic("filedup");
80100f8e:	c7 04 24 1c 86 10 80 	movl   $0x8010861c,(%esp)
...
80100fb0:	e8 35 3e 00 00       	call   80104dea <release>
  return f;
...
80100fc7:	e8 bc 3d 00 00       	call   80104d88 <acquire>
  if(f->ref < 1)
...
80100fd4:	7f 0c                	jg     80100fe2 <fileclose+0x28>
    panic("fileclose");
80100fd6:	c7 04 24 24 86 10 80 	movl   $0x80108624,(%esp)
...
80101002:	e8 e3 3d 00 00       	call   80104dea <release>
...
8010104c:	e8 99 3d 00 00       	call   80104dea <release>
...
8010118b:	eb 0c                	jmp    80101199 <fileread+0xba>
  ...
  panic("fileread");
8010118d:	c7 04 24 2e 86 10 80 	movl   $0x8010862e,(%esp)
...
80101299:	c7 04 24 37 86 10 80 	movl   $0x80108637,(%esp)
...
801012c9:	eb 0c                	jmp    801012d7 <filewrite+0x13c>
  ...
  panic("filewrite");
801012cb:	c7 04 24 47 86 10 80 	movl   $0x80108647,(%esp)
...
80101311:	e8 8c 3e 00 00       	call   801051a2 <memmove>
  brelse(bp);
...
80101357:	e8 77 3d 00 00       	call   801050d3 <memset>
  log_write(bp);
...
801014b4:	c7 04 24 51 86 10 80 	movl   $0x80108651,(%esp)
...
80101546:	c7 04 24 67 86 10 80 	movl   $0x80108667,(%esp)
...
80101596:	c7 44 24 04 7a 86 10 	movl   $0x8010867a,0x4(%esp)
8010159d:	80 
8010159e:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
801015a5:	e8 bd 37 00 00       	call   80104d67 <initlock>
}
801015aa:	c9                   	leave  
801015ab:	c3                   	ret    
...
80101627:	e8 a7 3a 00 00       	call   801050d3 <memset>
      dip->type = type;
...
8010167d:	c7 04 24 81 86 10 80 	movl   $0x80108681,(%esp)
...
80101726:	e8 77 3a 00 00       	call   801051a2 <memmove>
  log_write(bp);
...
80101750:	e8 33 36 00 00       	call   80104d88 <acquire>
...
8010179a:	e8 4b 36 00 00       	call   80104dea <release>
      return ip;
...
801017cd:	c7 04 24 93 86 10 80 	movl   $0x80108693,(%esp)
...
8010180b:	e8 da 35 00 00       	call   80104dea <release>
...
80101822:	e8 61 35 00 00       	call   80104d88 <acquire>
  ip->ref++;
...
8010183d:	e8 a8 35 00 00       	call   80104dea <release>
  return ip;
...
8010185b:	7f 0c                	jg     80101869 <ilock+0x22>
    panic("ilock");
8010185d:	c7 04 24 a3 86 10 80 	movl   $0x801086a3,(%esp)
80101864:	e8 d1 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
80101869:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
80101870:	e8 13 35 00 00       	call   80104d88 <acquire>
...
801018af:	e8 36 35 00 00       	call   80104dea <release>
...
8010195a:	e8 43 38 00 00       	call   801051a2 <memmove>
    brelse(bp);
...
80101985:	75 0c                	jne    80101993 <ilock+0x14c>
      panic("ilock: no type");
80101987:	c7 04 24 a9 86 10 80 	movl   $0x801086a9,(%esp)
...
801019b6:	7f 0c                	jg     801019c4 <iunlock+0x2f>
    panic("iunlock");
801019b8:	c7 04 24 b8 86 10 80 	movl   $0x801086b8,(%esp)
801019bf:	e8 76 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019c4:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
801019cb:	e8 b8 33 00 00       	call   80104d88 <acquire>
  ip->flags &= ~I_BUSY;
...
801019f3:	e8 f2 33 00 00       	call   80104dea <release>
}
801019f8:	c9                   	leave  
801019f9:	c3                   	ret    
...
80101a07:	e8 7c 33 00 00       	call   80104d88 <acquire>
...
80101a43:	74 0c                	je     80101a51 <iput+0x57>
      panic("iput busy");
80101a45:	c7 04 24 c0 86 10 80 	movl   $0x801086c0,(%esp)
...
80101a69:	e8 7c 33 00 00       	call   80104dea <release>
    itrunc(ip);
...
80101a94:	e8 ef 32 00 00       	call   80104d88 <acquire>
    ip->flags = 0;
...
80101ac4:	e8 21 33 00 00       	call   80104dea <release>
}
80101ac9:	c9                   	leave  
80101aca:	c3                   	ret    
...
80101be4:	c7 04 24 ca 86 10 80 	movl   $0x801086ca,(%esp)
...
80101e85:	e8 18 33 00 00       	call   801051a2 <memmove>
    brelse(bp);
...
80101fe4:	e8 b9 31 00 00       	call   801051a2 <memmove>
    log_write(bp);
...
80102062:	e8 de 31 00 00       	call   80105245 <strncmp>
}
80102067:	c9                   	leave  
80102068:	c3                   	ret    
...
8010207c:	c7 04 24 dd 86 10 80 	movl   $0x801086dd,(%esp)
...
801020b8:	74 0c                	je     801020c6 <dirlookup+0x5d>
      panic("dirlink read");
801020ba:	c7 04 24 ef 86 10 80 	movl   $0x801086ef,(%esp)
...
8010219d:	74 0c                	je     801021ab <dirlink+0x79>
      panic("dirlink read");
8010219f:	c7 04 24 ef 86 10 80 	movl   $0x801086ef,(%esp)
...
801021e4:	e8 b2 30 00 00       	call   8010529b <strncpy>
  de.inum = inum;
...
80102214:	74 0c                	je     80102222 <dirlink+0xf0>
    panic("dirlink");
80102216:	c7 04 24 fc 86 10 80 	movl   $0x801086fc,(%esp)
...
8010229b:	e8 02 2f 00 00       	call   801051a2 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022b6:	e8 e7 2e 00 00       	call   801051a2 <memmove>
    name[len] = 0;
...
80102505:	c7 44 24 04 04 87 10 	movl   $0x80108704,0x4(%esp)
8010250c:	80 
8010250d:	c7 04 24 20 b6 10 80 	movl   $0x8010b620,(%esp)
80102514:	e8 4e 28 00 00       	call   80104d67 <initlock>
  picenable(IRQ_IDE);
...
801025af:	75 0c                	jne    801025bd <idestart+0x18>
    panic("idestart");
801025b1:	c7 04 24 08 87 10 80 	movl   $0x80108708,(%esp)
...
801026d7:	e8 ac 26 00 00       	call   80104d88 <acquire>
  if((b = idequeue) == 0){
...
801026f1:	e8 f4 26 00 00       	call   80104dea <release>
...
80102786:	e8 5f 26 00 00       	call   80104dea <release>
}
8010278b:	c9                   	leave  
8010278c:	c3                   	ret    
...
8010279f:	c7 04 24 11 87 10 80 	movl   $0x80108711,(%esp)
...
801027b8:	c7 04 24 25 87 10 80 	movl   $0x80108725,(%esp)
...
8010285e:	e8 87 25 00 00       	call   80104dea <release>
}
80102863:	c9                   	leave  
80102864:	c3                   	ret    
...
801028ec:	c7 04 24 58 87 10 80 	movl   $0x80108758,(%esp)
...
801029a6:	c7 44 24 04 8a 87 10 	movl   $0x8010878a,0x4(%esp)
801029ad:	80 
801029ae:	c7 04 24 60 f8 10 80 	movl   $0x8010f860,(%esp)
801029b5:	e8 ad 23 00 00       	call   80104d67 <initlock>
  kmem.use_lock = 0;
...
80102a47:	81 7d 08 3c 51 11 80 	cmpl   $0x8011513c,0x8(%ebp)
...
80102a60:	76 0c                	jbe    80102a6e <kfree+0x39>
    panic("kfree");
80102a62:	c7 04 24 8f 87 10 80 	movl   $0x8010878f,(%esp)
...
80102a84:	e8 4a 26 00 00       	call   801050d3 <memset>
...
80102a99:	e8 ea 22 00 00       	call   80104d88 <acquire>
  r = (struct run*)v;
...
80102ac7:	e8 1e 23 00 00       	call   80104dea <release>
}
80102acc:	c9                   	leave  
80102acd:	c3                   	ret    
...
80102ae4:	e8 9f 22 00 00       	call   80104d88 <acquire>
  r = kmem.freelist;
...
80102b11:	e8 d4 22 00 00       	call   80104dea <release>
  return (char*)r;
...
80102e74:	c7 04 24 98 87 10 80 	movl   $0x80108798,(%esp)
...
80102fc9:	c7 44 24 04 c4 87 10 	movl   $0x801087c4,0x4(%esp)
80102fd0:	80 
80102fd1:	c7 04 24 a0 f8 10 80 	movl   $0x8010f8a0,(%esp)
80102fd8:	e8 8a 1d 00 00       	call   80104d67 <initlock>
  readsb(ROOTDEV, &sb);
...
8010308c:	e8 11 21 00 00       	call   801051a2 <memmove>
...
801031de:	e8 a5 1b 00 00       	call   80104d88 <acquire>
  while (log.busy) {
...
80103213:	e8 d2 1b 00 00       	call   80104dea <release>
}
80103218:	c9                   	leave  
80103219:	c3                   	ret    
...
80103249:	e8 3a 1b 00 00       	call   80104d88 <acquire>
  log.busy = 0;
...
8010326b:	e8 7a 1b 00 00       	call   80104dea <release>
}
80103270:	c9                   	leave  
80103271:	c3                   	ret    
...
80103294:	c7 04 24 c8 87 10 80 	movl   $0x801087c8,(%esp)
...
801032a9:	c7 04 24 de 87 10 80 	movl   $0x801087de,(%esp)
...
8010333a:	e8 63 1e 00 00       	call   801051a2 <memmove>
  bwrite(lbuf);
...
801033f2:	c7 04 24 f5 87 10 80 	movl   $0x801087f5,(%esp)
...
8010340d:	e8 dc 36 00 00       	call   80106aee <uartinit>
  pinit();         // process table
80103412:	e8 6f 0b 00 00       	call   80103f86 <pinit>
  tvinit();        // trap vectors
80103417:	e8 84 32 00 00       	call   801066a0 <tvinit>
  binit();         // buffer cache
...
80103439:	e8 ad 31 00 00       	call   801065eb <timerinit>
...
80103464:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103467:	e8 b7 49 00 00       	call   80107e23 <switchkvm>
  seginit();
8010346c:	e8 2e 43 00 00       	call   8010779f <seginit>
  lapicinit();
...
80103491:	c7 04 24 0c 88 10 80 	movl   $0x8010880c,(%esp)
80103498:	e8 03 cf ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
8010349d:	e8 72 33 00 00       	call   80106814 <idtinit>
...
801034ef:	e8 ae 1c 00 00       	call   801051a2 <memmove>
...
80103670:	00 
80103671:	c7 44 24 04 20 88 10 	movl   $0x80108820,0x4(%esp)
80103678:	80 
80103679:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010367c:	89 04 24             	mov    %eax,(%esp)
8010367f:	e8 c6 1a 00 00       	call   8010514a <memcmp>
...
801037b1:	00 
801037b2:	c7 44 24 04 25 88 10 	movl   $0x80108825,0x4(%esp)
801037b9:	80 
801037ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037bd:	89 04 24             	mov    %eax,(%esp)
801037c0:	e8 85 19 00 00       	call   8010514a <memcmp>
...
8010388e:	8b 04 85 68 88 10 80 	mov    -0x7fef7798(,%eax,4),%eax
...
801038c7:	c7 04 24 2a 88 10 80 	movl   $0x8010882a,(%esp)
...
8010395a:	c7 04 24 48 88 10 80 	movl   $0x80108848,(%esp)
...
80103c53:	c7 44 24 04 7c 88 10 	movl   $0x8010887c,0x4(%esp)
80103c5a:	80 
80103c5b:	89 04 24             	mov    %eax,(%esp)
80103c5e:	e8 04 11 00 00       	call   80104d67 <initlock>
  (*f0)->type = FD_PIPE;
...
80103d0a:	e8 79 10 00 00       	call   80104d88 <acquire>
  if(writable){
...
80103d71:	e8 74 10 00 00       	call   80104dea <release>
    kfree((char*)p);
...
80103d89:	e8 5c 10 00 00       	call   80104dea <release>
}
80103d8e:	c9                   	leave  
80103d8f:	c3                   	ret    
...
80103d9c:	e8 e7 0f 00 00       	call   80104d88 <acquire>
  for(i = 0; i < n; i++){
...
80103dcf:	e8 16 10 00 00       	call   80104dea <release>
        return -1;
...
80103e75:	e8 70 0f 00 00       	call   80104dea <release>
  return n;
...
80103e8c:	e8 f7 0e 00 00       	call   80104d88 <acquire>
...
80103ea6:	e8 3f 0f 00 00       	call   80104dea <release>
      return -1;
...
80103f62:	e8 83 0e 00 00       	call   80104dea <release>
  return i;
...
80103f8c:	c7 44 24 04 81 88 10 	movl   $0x80108881,0x4(%esp)
80103f93:	80 
80103f94:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80103f9b:	e8 c7 0d 00 00       	call   80104d67 <initlock>
}
80103fa0:	c9                   	leave  
80103fa1:	c3                   	ret    
...
80103fa5:	83 ec 28             	sub    $0x28,%esp
  ...
  char *sp;
  acquire(&ptable.lock);
80103fa8:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80103faf:	e8 d4 0d 00 00       	call   80104d88 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fb4:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
...
80103fe3:	89 42 10             	mov    %eax,0x10(%edx)
  release(&ptable.lock);
80103fe6:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80103fed:	e8 f8 0d 00 00       	call   80104dea <release>
...
allocproc(void)
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104009:	81 45 f4 f8 00 00 00 	addl   $0xf8,-0xc(%ebp)
80104010:	81 7d f4 74 3d 11 80 	cmpl   $0x80113d74,-0xc(%ebp)
80104017:	72 a4                	jb     80103fbd <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104019:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104020:	e8 c5 0d 00 00       	call   80104dea <release>
  return 0;
...
80104062:	ba 5b 66 10 80       	mov    $0x8010665b,%edx
...
80104092:	e8 3c 10 00 00       	call   801050d3 <memset>
...
801040be:	e8 10 10 00 00       	call   801050d3 <memset>
...
801040d9:	a3 68 b6 10 80       	mov    %eax,0x8010b668
  if((p->pgdir = setupkvm()) == 0)
801040de:	e8 6c 3c 00 00       	call   80107d4f <setupkvm>
...
801040f3:	c7 04 24 88 88 10 80 	movl   $0x80108888,(%esp)
...
8010410e:	c7 44 24 04 00 b5 10 	movl   $0x8010b500,0x4(%esp)
80104115:	80 
80104116:	89 04 24             	mov    %eax,(%esp)
80104119:	e8 89 3e 00 00       	call   80107fa7 <inituvm>
  p->sz = PGSIZE;
...
80104140:	e8 8e 0f 00 00       	call   801050d3 <memset>
...
801041b9:	00 
801041ba:	c7 44 24 04 a1 88 10 	movl   $0x801088a1,0x4(%esp)
801041c1:	80 
801041c2:	89 04 24             	mov    %eax,(%esp)
801041c5:	e8 29 11 00 00       	call   801052f3 <safestrcpy>
  p->cwd = namei("/");
801041ca:	c7 04 24 aa 88 10 80 	movl   $0x801088aa,(%esp)
...
8010421e:	e8 fa 3e 00 00       	call   8010811d <allocuvm>
...
80104258:	e8 9a 3f 00 00       	call   801081f7 <deallocuvm>
...
80104281:	e8 ba 3b 00 00       	call   80107e40 <switchuvm>
  return 0;
...
801042c6:	e8 c8 40 00 00       	call   80108393 <copyuvm>
...
801043e0:	e8 0e 0f 00 00       	call   801052f3 <safestrcpy>
  return pid;
...
801043fd:	a1 68 b6 10 80       	mov    0x8010b668,%eax
80104402:	39 c2                	cmp    %eax,%edx
80104404:	75 0c                	jne    80104412 <exit+0x22>
    panic("init exiting");
80104406:	c7 04 24 ac 88 10 80 	movl   $0x801088ac,(%esp)
...
8010447c:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)
  ...
  acquire(&ptable.lock);
80104483:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010448a:	e8 f9 08 00 00       	call   80104d88 <acquire>
...
8010449b:	e8 c3 03 00 00       	call   80104863 <wakeup1>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044a0:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
...
801044b7:	75 24                	jne    801044dd <exit+0xed>
      p->parent = initproc;
801044b9:	8b 15 68 b6 10 80    	mov    0x8010b668,%edx
...
801044ce:	75 0d                	jne    801044dd <exit+0xed>
        wakeup1(initproc);
801044d0:	a1 68 b6 10 80       	mov    0x8010b668,%eax
...
801044d8:	e8 86 03 00 00       	call   80104863 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044dd:	81 45 f4 f8 00 00 00 	addl   $0xf8,-0xc(%ebp)
801044e4:	81 7d f4 74 3d 11 80 	cmpl   $0x80113d74,-0xc(%ebp)
...
801044fa:	e8 b9 01 00 00       	call   801046b8 <sched>
  panic("zombie exit");
801044ff:	c7 04 24 b9 88 10 80 	movl   $0x801088b9,(%esp)
...
8010450e:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104511:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104518:	e8 6b 08 00 00       	call   80104d88 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
8010451d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104524:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
...
80104581:	e8 2d 3d 00 00       	call   801082b3 <freevm>
        p->state = UNUSED;
...
801045ae:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
801045b5:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801045bc:	e8 29 08 00 00       	call   80104dea <release>
        return pid;
...
801045c4:	eb 55                	jmp    8010461b <wait+0x110>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801045c6:	81 45 f4 f8 00 00 00 	addl   $0xf8,-0xc(%ebp)
801045cd:	81 7d f4 74 3d 11 80 	cmpl   $0x80113d74,-0xc(%ebp)
...
801045eb:	74 13                	je     80104600 <wait+0xf5>
      release(&ptable.lock);
801045ed:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801045f4:	e8 f1 07 00 00       	call   80104dea <release>
      return -1;
...
80104606:	c7 44 24 04 40 ff 10 	movl   $0x8010ff40,0x4(%esp)
8010460d:	80 
...
80104623:	e8 58 f9 ff ff       	call   80103f80 <sti>
    ...
    acquire(&ptable.lock);
80104628:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010462f:	e8 54 07 00 00       	call   80104d88 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104634:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
...
80104659:	e8 e2 37 00 00       	call   80107e40 <switchuvm>
      p->state = RUNNING;
...
80104682:	e8 dd 0c 00 00       	call   80105364 <swtch>
      switchkvm();
80104687:	e8 97 37 00 00       	call   80107e23 <switchkvm>
...
80104693:	00 00 00 00 
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104697:	81 45 f4 f8 00 00 00 	addl   $0xf8,-0xc(%ebp)
8010469e:	81 7d f4 74 3d 11 80 	cmpl   $0x80113d74,-0xc(%ebp)
801046a5:	72 96                	jb     8010463d <scheduler+0x20>
    ...
    release(&ptable.lock);
801046a7:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801046ae:	e8 37 07 00 00       	call   80104dea <release>
...
801046be:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801046c5:	e8 e8 07 00 00       	call   80104eb2 <holding>
801046ca:	85 c0                	test   %eax,%eax
801046cc:	75 0c                	jne    801046da <sched+0x22>
    panic("sched ptable.lock");
801046ce:	c7 04 24 c5 88 10 80 	movl   $0x801088c5,(%esp)
...
801046e9:	74 0c                	je     801046f7 <sched+0x3f>
    panic("sched locks");
801046eb:	c7 04 24 d7 88 10 80 	movl   $0x801088d7,(%esp)
...
80104703:	75 0c                	jne    80104711 <sched+0x59>
    panic("sched running");
80104705:	c7 04 24 e3 88 10 80 	movl   $0x801088e3,(%esp)
...
8010471f:	c7 04 24 f1 88 10 80 	movl   $0x801088f1,(%esp)
...
80104754:	e8 0b 0c 00 00       	call   80105364 <swtch>
  cpu->intena = intena;
...
80104770:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104777:	e8 0c 06 00 00       	call   80104d88 <acquire>
  proc->state = RUNNABLE;
...
80104789:	e8 2a ff ff ff       	call   801046b8 <sched>
  release(&ptable.lock);
8010478e:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104795:	e8 50 06 00 00       	call   80104dea <release>
}
8010479a:	c9                   	leave  
8010479b:	c3                   	ret    
...
8010479f:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
801047a2:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801047a9:	e8 3c 06 00 00       	call   80104dea <release>
...
801047d6:	75 0c                	jne    801047e4 <sleep+0x1c>
    panic("sleep");
801047d8:	c7 04 24 05 89 10 80 	movl   $0x80108905,(%esp)
...
801047ea:	c7 04 24 0b 89 10 80 	movl   $0x8010890b,(%esp)
...
80104841:	81 7d 0c 40 ff 10 80 	cmpl   $0x8010ff40,0xc(%ebp)
80104848:	74 17                	je     80104861 <sleep+0x99>
    release(&ptable.lock);
8010484a:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104851:	e8 94 05 00 00       	call   80104dea <release>
    acquire(lk);
80104856:	8b 45 0c             	mov    0xc(%ebp),%eax
80104859:	89 04 24             	mov    %eax,(%esp)
8010485c:	e8 27 05 00 00       	call   80104d88 <acquire>
  }
}
80104861:	c9                   	leave  
80104862:	c3                   	ret    
...
80104866:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104869:	c7 45 fc 74 ff 10 80 	movl   $0x8010ff74,-0x4(%ebp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104892:	81 45 fc f8 00 00 00 	addl   $0xf8,-0x4(%ebp)
80104899:	81 7d fc 74 3d 11 80 	cmpl   $0x80113d74,-0x4(%ebp)
...
801048a7:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
801048aa:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801048b1:	e8 d2 04 00 00       	call   80104d88 <acquire>
  wakeup1(chan);
...
801048c8:	e8 1d 05 00 00       	call   80104dea <release>
}
801048cd:	c9                   	leave  
801048ce:	c3                   	ret    
...
801048d2:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
801048d5:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801048dc:	e8 a7 04 00 00       	call   80104d88 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048e1:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
...
8010490d:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104914:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010491b:	e8 ca 04 00 00       	call   80104dea <release>
      return 0;
...
kill(int pid)
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104927:	81 45 f4 f8 00 00 00 	addl   $0xf8,-0xc(%ebp)
8010492e:	81 7d f4 74 3d 11 80 	cmpl   $0x80113d74,-0xc(%ebp)
80104935:	72 b3                	jb     801048ea <kill+0x1b>
  ...
  release(&ptable.lock);
80104937:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010493e:	e8 a7 04 00 00       	call   80104dea <release>
  return -1;
...
8010494d:	83 ec 58             	sub    $0x58,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104950:	c7 45 f0 74 ff 10 80 	movl   $0x8010ff74,-0x10(%ebp)
...
80104997:	eb 07                	jmp    801049a0 <procdump+0x56>
      ...
      state = "???";
80104999:	c7 45 ec 1c 89 10 80 	movl   $0x8010891c,-0x14(%ebp)
...
801049bb:	c7 04 24 20 89 10 80 	movl   $0x80108920,(%esp)
...
801049e8:	e8 4c 04 00 00       	call   80104e39 <getcallerpcs>
...
80104a01:	c7 04 24 29 89 10 80 	movl   $0x80108929,(%esp)
...
80104a20:	75 d4                	jne    801049f6 <procdump+0xac>
    ...
    cprintf("\n");
80104a22:	c7 04 24 2d 89 10 80 	movl   $0x8010892d,(%esp)
80104a29:	e8 72 b9 ff ff       	call   801003a0 <cprintf>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a2e:	81 45 f0 f8 00 00 00 	addl   $0xf8,-0x10(%ebp)
80104a35:	81 7d f0 74 3d 11 80 	cmpl   $0x80113d74,-0x10(%ebp)
...
80104a4a:	83 ec 3c             	sub    $0x3c,%esp
  int i, pid;
  struct proc *np;
  // Allocate process.
  if((np = allocproc()) == 0)
80104a4d:	e8 50 f5 ff ff       	call   80103fa2 <allocproc>
80104a52:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104a55:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104a59:	75 0a                	jne    80104a65 <thread_create+0x21>
     return -1;
80104a5b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a60:	e9 a2 01 00 00       	jmp    80104c07 <thread_create+0x1c3>
  // Copy the parent's process state
  np->pgdir = proc->pgdir;
80104a65:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a6b:	8b 50 04             	mov    0x4(%eax),%edx
80104a6e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104a71:	89 50 04             	mov    %edx,0x4(%eax)
  np->sz = proc->sz;
...
80104aaf:	8b 40 18             	mov    0x18(%eax),%eax
80104ab2:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
...
80104abf:	8b 40 18             	mov    0x18(%eax),%eax
...
80104ad3:	29 c2                	sub    %eax,%edx
80104ad5:	89 d0                	mov    %edx,%eax
80104ad7:	89 45 dc             	mov    %eax,-0x24(%ebp)
  // Shift stack pointer the trapframe bottom
  np->tf->esp = (uint)stack+PGSIZE - sizeofstack;
80104ada:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104add:	8b 40 18             	mov    0x18(%eax),%eax
80104ae0:	8b 55 0c             	mov    0xc(%ebp),%edx
80104ae3:	2b 55 dc             	sub    -0x24(%ebp),%edx
80104ae6:	81 c2 00 10 00 00    	add    $0x1000,%edx
80104aec:	89 50 44             	mov    %edx,0x44(%eax)
  // Derive the size needed above ebp
  uint sizeofcrown = *(uint *)proc->tf->ebp - proc->tf->ebp;
80104aef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104af5:	8b 40 18             	mov    0x18(%eax),%eax
80104af8:	8b 40 08             	mov    0x8(%eax),%eax
80104afb:	8b 10                	mov    (%eax),%edx
...
80104b0b:	89 d0                	mov    %edx,%eax
80104b0d:	89 45 d8             	mov    %eax,-0x28(%ebp)
...
80104b19:	2b 55 d8             	sub    -0x28(%ebp),%edx
80104b1c:	81 c2 00 10 00 00    	add    $0x1000,%edx
80104b22:	89 50 08             	mov    %edx,0x8(%eax)
...
80104b2e:	8b 40 44             	mov    0x44(%eax),%eax
80104b31:	89 c2                	mov    %eax,%edx
80104b33:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104b36:	8b 40 18             	mov    0x18(%eax),%eax
80104b39:	8b 40 44             	mov    0x44(%eax),%eax
80104b3c:	8b 4d dc             	mov    -0x24(%ebp),%ecx
80104b3f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80104b43:	89 54 24 04          	mov    %edx,0x4(%esp)
80104b47:	89 04 24             	mov    %eax,(%esp)
80104b4a:	e8 53 06 00 00       	call   801051a2 <memmove>
...
80104b5b:	89 50 38             	mov    %edx,0x38(%eax)

  for(i = 0; i < NOFILE; i++)
80104b5e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104b65:	eb 3d                	jmp    80104ba4 <thread_create+0x160>
    if(proc->ofile[i])
80104b67:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b6d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104b70:	83 c2 08             	add    $0x8,%edx
80104b73:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104b77:	85 c0                	test   %eax,%eax
80104b79:	74 25                	je     80104ba0 <thread_create+0x15c>
      np->ofile[i] = filedup(proc->ofile[i]);
80104b7b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b81:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104b84:	83 c2 08             	add    $0x8,%edx
80104b87:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104b8b:	89 04 24             	mov    %eax,(%esp)
80104b8e:	e8 df c3 ff ff       	call   80100f72 <filedup>
80104b93:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104b96:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104b99:	83 c1 08             	add    $0x8,%ecx
80104b9c:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  // Copy parent processee's stack to child where needed to get the arg 
  memmove((void *)(np->tf->esp),(const void *)(proc->tf->esp), sizeofstack);
  ...
  for(i = 0; i < NOFILE; i++)
80104ba0:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104ba4:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104ba8:	7e bd                	jle    80104b67 <thread_create+0x123>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
80104baa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bb0:	8b 40 68             	mov    0x68(%eax),%eax
80104bb3:	89 04 24             	mov    %eax,(%esp)
80104bb6:	e8 5a cc ff ff       	call   80101815 <idup>
80104bbb:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104bbe:	89 42 68             	mov    %eax,0x68(%edx)

  pid = np->pid;
80104bc1:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104bc4:	8b 40 10             	mov    0x10(%eax),%eax
80104bc7:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  np->state = RUNNABLE;
80104bca:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104bcd:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  safestrcpy(np->name, proc->name, sizeof(proc->name));
80104bd4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bda:	8d 50 6c             	lea    0x6c(%eax),%edx
80104bdd:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104be0:	83 c0 6c             	add    $0x6c,%eax
80104be3:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104bea:	00 
80104beb:	89 54 24 04          	mov    %edx,0x4(%esp)
80104bef:	89 04 24             	mov    %eax,(%esp)
80104bf2:	e8 fc 06 00 00       	call   801052f3 <safestrcpy>

  np->is_thread = 1;
80104bf7:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104bfa:	c7 80 f4 00 00 00 01 	movl   $0x1,0xf4(%eax)
80104c01:	00 00 00 
  return pid;
80104c04:	8b 45 d4             	mov    -0x2c(%ebp),%eax
}	
80104c07:	83 c4 3c             	add    $0x3c,%esp
80104c0a:	5b                   	pop    %ebx
80104c0b:	5e                   	pop    %esi
80104c0c:	5f                   	pop    %edi
80104c0d:	5d                   	pop    %ebp
...
80104c0f <thread_join>:

int thread_join(void **stack){
80104c0f:	55                   	push   %ebp
80104c10:	89 e5                	mov    %esp,%ebp
80104c12:	83 ec 28             	sub    $0x28,%esp

  struct proc *prs;
  int havekids, pid;

  acquire(&ptable.lock);
80104c15:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104c1c:	e8 67 01 00 00       	call   80104d88 <acquire>
  for(;;){
    // Scan through entire table looking for zombie children.
    havekids = 0;
80104c21:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(prs = ptable.proc; prs < &ptable.proc[NPROC]; prs++){
80104c28:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
80104c2f:	e9 ad 00 00 00       	jmp    80104ce1 <thread_join+0xd2>
      //check if proc is a child of p and a thread
      if(prs->parent != proc && prs->is_thread==1)
80104c34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c37:	8b 50 14             	mov    0x14(%eax),%edx
80104c3a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c40:	39 c2                	cmp    %eax,%edx
80104c42:	74 13                	je     80104c57 <thread_join+0x48>
80104c44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c47:	8b 80 f4 00 00 00    	mov    0xf4(%eax),%eax
80104c4d:	83 f8 01             	cmp    $0x1,%eax
80104c50:	75 05                	jne    80104c57 <thread_join+0x48>
        continue;
80104c52:	e9 83 00 00 00       	jmp    80104cda <thread_join+0xcb>
      havekids = 1;
80104c57:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(prs->state == ZOMBIE){
80104c5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c61:	8b 40 0c             	mov    0xc(%eax),%eax
80104c64:	83 f8 05             	cmp    $0x5,%eax
80104c67:	75 71                	jne    80104cda <thread_join+0xcb>
        // Found one.
        pid = prs->pid;
80104c69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c6c:	8b 40 10             	mov    0x10(%eax),%eax
80104c6f:	89 45 ec             	mov    %eax,-0x14(%ebp)
        prs->kstack = 0;
...
80104c85:	e8 29 36 00 00       	call   801082b3 <freevm>
        prs->state = UNUSED;
80104c8a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c8d:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        prs->pid = 0;
80104c94:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c97:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        prs->parent = 0;
80104c9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ca1:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        prs->name[0] = 0;
80104ca8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cab:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        prs->killed = 0;
80104caf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cb2:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104cb9:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104cc0:	e8 25 01 00 00       	call   80104dea <release>
        *stack= (void*)prs->tf->esp;
80104cc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cc8:	8b 40 18             	mov    0x18(%eax),%eax
80104ccb:	8b 40 44             	mov    0x44(%eax),%eax
80104cce:	89 c2                	mov    %eax,%edx
80104cd0:	8b 45 08             	mov    0x8(%ebp),%eax
80104cd3:	89 10                	mov    %edx,(%eax)
        return pid;
80104cd5:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104cd8:	eb 55                	jmp    80104d2f <thread_join+0x120>
  ...
  for(;;){
    ...
    havekids = 0;
    for(prs = ptable.proc; prs < &ptable.proc[NPROC]; prs++){
80104cda:	81 45 f4 f8 00 00 00 	addl   $0xf8,-0xc(%ebp)
80104ce1:	81 7d f4 74 3d 11 80 	cmpl   $0x80113d74,-0xc(%ebp)
80104ce8:	0f 82 46 ff ff ff    	jb     80104c34 <thread_join+0x25>
        return pid;
      }
    }
    ...
    // No point waiting if we don't have any children.
    if(!havekids || proc->killed){
80104cee:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104cf2:	74 0d                	je     80104d01 <thread_join+0xf2>
80104cf4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cfa:	8b 40 24             	mov    0x24(%eax),%eax
80104cfd:	85 c0                	test   %eax,%eax
80104cff:	74 13                	je     80104d14 <thread_join+0x105>
      release(&ptable.lock);
80104d01:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104d08:	e8 dd 00 00 00       	call   80104dea <release>
      return -1;
80104d0d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d12:	eb 1b                	jmp    80104d2f <thread_join+0x120>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104d14:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d1a:	c7 44 24 04 40 ff 10 	movl   $0x8010ff40,0x4(%esp)
80104d21:	80 
80104d22:	89 04 24             	mov    %eax,(%esp)
80104d25:	e8 9e fa ff ff       	call   801047c8 <sleep>
  }
80104d2a:	e9 f2 fe ff ff       	jmp    80104c21 <thread_join+0x12>
  return 0;
...
80104d37:	9c                   	pushf  
80104d38:	58                   	pop    %eax
80104d39:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
...
80104d50:	83 ec 10             	sub    $0x10,%esp
  uint result;
  
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
80104d53:	8b 55 08             	mov    0x8(%ebp),%edx
80104d56:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d59:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104d5c:	f0 87 02             	lock xchg %eax,(%edx)
80104d5f:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80104d62:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80104d65:	c9                   	leave  
80104d66:	c3                   	ret    
...
80104d6d:	8b 55 0c             	mov    0xc(%ebp),%edx
80104d70:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80104d73:	8b 45 08             	mov    0x8(%ebp),%eax
80104d76:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80104d7c:	8b 45 08             	mov    0x8(%ebp),%eax
80104d7f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104d86:	5d                   	pop    %ebp
80104d87:	c3                   	ret    
...
80104d8e:	e8 49 01 00 00       	call   80104edc <pushcli>
  if(holding(lk))
80104d93:	8b 45 08             	mov    0x8(%ebp),%eax
80104d96:	89 04 24             	mov    %eax,(%esp)
80104d99:	e8 14 01 00 00       	call   80104eb2 <holding>
80104d9e:	85 c0                	test   %eax,%eax
80104da0:	74 0c                	je     80104dae <acquire+0x26>
    panic("acquire");
80104da2:	c7 04 24 59 89 10 80 	movl   $0x80108959,(%esp)
80104da9:	e8 8c b7 ff ff       	call   8010053a <panic>
...
80104dbd:	e8 8b ff ff ff       	call   80104d4d <xchg>
80104dc2:	85 c0                	test   %eax,%eax
80104dc4:	75 e9                	jne    80104daf <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104dc6:	8b 45 08             	mov    0x8(%ebp),%eax
80104dc9:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104dd0:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104dd3:	8b 45 08             	mov    0x8(%ebp),%eax
80104dd6:	83 c0 0c             	add    $0xc,%eax
80104dd9:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ddd:	8d 45 08             	lea    0x8(%ebp),%eax
80104de0:	89 04 24             	mov    %eax,(%esp)
80104de3:	e8 51 00 00 00       	call   80104e39 <getcallerpcs>
}
80104de8:	c9                   	leave  
80104de9:	c3                   	ret    
...
80104df6:	e8 b7 00 00 00       	call   80104eb2 <holding>
80104dfb:	85 c0                	test   %eax,%eax
80104dfd:	75 0c                	jne    80104e0b <release+0x21>
    panic("release");
80104dff:	c7 04 24 61 89 10 80 	movl   $0x80108961,(%esp)
80104e06:	e8 2f b7 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104e0b:	8b 45 08             	mov    0x8(%ebp),%eax
80104e0e:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
...
80104e22:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104e29:	00 
80104e2a:	89 04 24             	mov    %eax,(%esp)
80104e2d:	e8 1b ff ff ff       	call   80104d4d <xchg>

  popcli();
80104e32:	e8 e9 00 00 00       	call   80104f20 <popcli>
}
80104e37:	c9                   	leave  
80104e38:	c3                   	ret    

80104e39 <getcallerpcs>:
...
80104e42:	83 e8 08             	sub    $0x8,%eax
80104e45:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104e48:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104e4f:	eb 38                	jmp    80104e89 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104e51:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104e55:	74 38                	je     80104e8f <getcallerpcs+0x56>
80104e57:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104e5e:	76 2f                	jbe    80104e8f <getcallerpcs+0x56>
80104e60:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104e64:	74 29                	je     80104e8f <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104e66:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104e69:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104e70:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e73:	01 c2                	add    %eax,%edx
80104e75:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e78:	8b 40 04             	mov    0x4(%eax),%eax
80104e7b:	89 02                	mov    %eax,(%edx)
    ebp = (uint*)ebp[0]; // saved %ebp
80104e7d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e80:	8b 00                	mov    (%eax),%eax
80104e82:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  uint *ebp;
  int i;
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104e85:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104e89:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104e8d:	7e c2                	jle    80104e51 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104e8f:	eb 19                	jmp    80104eaa <getcallerpcs+0x71>
    pcs[i] = 0;
80104e91:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104e94:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104e9b:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e9e:	01 d0                	add    %edx,%eax
...
80104eaa:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104eae:	7e e1                	jle    80104e91 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80104eb0:	c9                   	leave  
80104eb1:	c3                   	ret    
...
80104ebc:	74 17                	je     80104ed5 <holding+0x23>
80104ebe:	8b 45 08             	mov    0x8(%ebp),%eax
80104ec1:	8b 50 08             	mov    0x8(%eax),%edx
80104ec4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104eca:	39 c2                	cmp    %eax,%edx
80104ecc:	75 07                	jne    80104ed5 <holding+0x23>
80104ece:	b8 01 00 00 00       	mov    $0x1,%eax
80104ed3:	eb 05                	jmp    80104eda <holding+0x28>
...
80104edf:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104ee2:	e8 4a fe ff ff       	call   80104d31 <readeflags>
80104ee7:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104eea:	e8 52 fe ff ff       	call   80104d41 <cli>
  if(cpu->ncli++ == 0)
80104eef:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104ef6:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
80104efc:	8d 48 01             	lea    0x1(%eax),%ecx
80104eff:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
80104f05:	85 c0                	test   %eax,%eax
80104f07:	75 15                	jne    80104f1e <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80104f09:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f0f:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104f12:	81 e2 00 02 00 00    	and    $0x200,%edx
80104f18:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104f1e:	c9                   	leave  
80104f1f:	c3                   	ret    
...
80104f23:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104f26:	e8 06 fe ff ff       	call   80104d31 <readeflags>
80104f2b:	25 00 02 00 00       	and    $0x200,%eax
80104f30:	85 c0                	test   %eax,%eax
80104f32:	74 0c                	je     80104f40 <popcli+0x20>
    panic("popcli - interruptible");
80104f34:	c7 04 24 69 89 10 80 	movl   $0x80108969,(%esp)
80104f3b:	e8 fa b5 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80104f40:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f46:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104f4c:	83 ea 01             	sub    $0x1,%edx
80104f4f:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104f55:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104f5b:	85 c0                	test   %eax,%eax
80104f5d:	79 0c                	jns    80104f6b <popcli+0x4b>
    panic("popcli");
80104f5f:	c7 04 24 80 89 10 80 	movl   $0x80108980,(%esp)
80104f66:	e8 cf b5 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
80104f6b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f71:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104f77:	85 c0                	test   %eax,%eax
80104f79:	75 15                	jne    80104f90 <popcli+0x70>
80104f7b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f81:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104f87:	85 c0                	test   %eax,%eax
80104f89:	74 05                	je     80104f90 <popcli+0x70>
    sti();
80104f8b:	e8 b7 fd ff ff       	call   80104d47 <sti>
}
80104f90:	c9                   	leave  
80104f91:	c3                   	ret    
...
80104f98:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104f9c:	78 0a                	js     80104fa8 <mtx_unlock+0x16>
80104f9e:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80104fa3:	39 45 08             	cmp    %eax,0x8(%ebp)
80104fa6:	7e 07                	jle    80104faf <mtx_unlock+0x1d>
    return -1;
80104fa8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104fad:	eb 36                	jmp    80104fe5 <mtx_unlock+0x53>
  }
  if(mutex_array[lock_id] != proc->pid){
80104faf:	8b 45 08             	mov    0x8(%ebp),%eax
80104fb2:	8b 14 85 c0 47 11 80 	mov    -0x7feeb840(,%eax,4),%edx
80104fb9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fbf:	8b 40 10             	mov    0x10(%eax),%eax
80104fc2:	39 c2                	cmp    %eax,%edx
80104fc4:	74 07                	je     80104fcd <mtx_unlock+0x3b>
    return -2;
80104fc6:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80104fcb:	eb 18                	jmp    80104fe5 <mtx_unlock+0x53>
  }
  release(&mutex_locks[lock_id]);
80104fcd:	8b 45 08             	mov    0x8(%ebp),%eax
80104fd0:	6b c0 34             	imul   $0x34,%eax,%eax
80104fd3:	05 80 3d 11 80       	add    $0x80113d80,%eax
80104fd8:	89 04 24             	mov    %eax,(%esp)
80104fdb:	e8 0a fe ff ff       	call   80104dea <release>
  return 0;
...
80104fea:	83 ec 18             	sub    $0x18,%esp
  if(lock_id < 0 || lock_id > mutex_index){
80104fed:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104ff1:	78 0a                	js     80104ffd <mtx_lock+0x16>
80104ff3:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80104ff8:	39 45 08             	cmp    %eax,0x8(%ebp)
80104ffb:	7e 07                	jle    80105004 <mtx_lock+0x1d>
    return -1;
80104ffd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105002:	eb 2b                	jmp    8010502f <mtx_lock+0x48>
  }
  acquire(&mutex_locks[lock_id]);
80105004:	8b 45 08             	mov    0x8(%ebp),%eax
80105007:	6b c0 34             	imul   $0x34,%eax,%eax
8010500a:	05 80 3d 11 80       	add    $0x80113d80,%eax
8010500f:	89 04 24             	mov    %eax,(%esp)
80105012:	e8 71 fd ff ff       	call   80104d88 <acquire>
  mutex_array[lock_id] = proc->pid;
80105017:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010501d:	8b 50 10             	mov    0x10(%eax),%edx
80105020:	8b 45 08             	mov    0x8(%ebp),%eax
80105023:	89 14 85 c0 47 11 80 	mov    %edx,-0x7feeb840(,%eax,4)
  return 0;
...
80105034:	83 ec 28             	sub    $0x28,%esp
  char* mutnm = "mutex";
80105037:	c7 45 f4 87 89 10 80 	movl   $0x80108987,-0xc(%ebp)
  if(mutex_index < NMUTEX){
8010503e:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80105043:	83 f8 31             	cmp    $0x31,%eax
80105046:	7f 3a                	jg     80105082 <mtx_create+0x51>
    initlock(&mutex_locks[mutex_index], mutnm);
80105048:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
8010504d:	6b c0 34             	imul   $0x34,%eax,%eax
80105050:	8d 90 80 3d 11 80    	lea    -0x7feec280(%eax),%edx
80105056:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105059:	89 44 24 04          	mov    %eax,0x4(%esp)
8010505d:	89 14 24             	mov    %edx,(%esp)
80105060:	e8 02 fd ff ff       	call   80104d67 <initlock>
    if(locked){
80105065:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80105069:	74 0d                	je     80105078 <mtx_create+0x47>
      mtx_lock(mutex_index);
8010506b:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80105070:	89 04 24             	mov    %eax,(%esp)
80105073:	e8 6f ff ff ff       	call   80104fe7 <mtx_lock>
    }
    return(mutex_index + 1);
80105078:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
8010507d:	83 c0 01             	add    $0x1,%eax
80105080:	eb 05                	jmp    80105087 <mtx_create+0x56>
  }
  return -1;
...
8010508e:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105091:	8b 55 10             	mov    0x10(%ebp),%edx
80105094:	8b 45 0c             	mov    0xc(%ebp),%eax
80105097:	89 cb                	mov    %ecx,%ebx
80105099:	89 df                	mov    %ebx,%edi
8010509b:	89 d1                	mov    %edx,%ecx
8010509d:	fc                   	cld    
8010509e:	f3 aa                	rep stos %al,%es:(%edi)
801050a0:	89 ca                	mov    %ecx,%edx
801050a2:	89 fb                	mov    %edi,%ebx
801050a4:	89 5d 08             	mov    %ebx,0x8(%ebp)
801050a7:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
801050c2:	fc                   	cld    
801050c3:	f3 ab                	rep stos %eax,%es:(%edi)
...
801050dc:	83 e0 03             	and    $0x3,%eax
801050df:	85 c0                	test   %eax,%eax
801050e1:	75 49                	jne    8010512c <memset+0x59>
801050e3:	8b 45 10             	mov    0x10(%ebp),%eax
801050e6:	83 e0 03             	and    $0x3,%eax
801050e9:	85 c0                	test   %eax,%eax
801050eb:	75 3f                	jne    8010512c <memset+0x59>
    c &= 0xFF;
801050ed:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801050f4:	8b 45 10             	mov    0x10(%ebp),%eax
801050f7:	c1 e8 02             	shr    $0x2,%eax
801050fa:	89 c2                	mov    %eax,%edx
801050fc:	8b 45 0c             	mov    0xc(%ebp),%eax
801050ff:	c1 e0 18             	shl    $0x18,%eax
80105102:	89 c1                	mov    %eax,%ecx
80105104:	8b 45 0c             	mov    0xc(%ebp),%eax
80105107:	c1 e0 10             	shl    $0x10,%eax
8010510a:	09 c1                	or     %eax,%ecx
8010510c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010510f:	c1 e0 08             	shl    $0x8,%eax
80105112:	09 c8                	or     %ecx,%eax
80105114:	0b 45 0c             	or     0xc(%ebp),%eax
80105117:	89 54 24 08          	mov    %edx,0x8(%esp)
8010511b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010511f:	8b 45 08             	mov    0x8(%ebp),%eax
80105122:	89 04 24             	mov    %eax,(%esp)
80105125:	e8 84 ff ff ff       	call   801050ae <stosl>
8010512a:	eb 19                	jmp    80105145 <memset+0x72>
  } else
    stosb(dst, c, n);
8010512c:	8b 45 10             	mov    0x10(%ebp),%eax
8010512f:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105140:	e8 44 ff ff ff       	call   80105089 <stosb>
  return dst;
...
80105159:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
8010515c:	eb 30                	jmp    8010518e <memcmp+0x44>
    if(*s1 != *s2)
8010515e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105161:	0f b6 10             	movzbl (%eax),%edx
80105164:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105167:	0f b6 00             	movzbl (%eax),%eax
8010516a:	38 c2                	cmp    %al,%dl
8010516c:	74 18                	je     80105186 <memcmp+0x3c>
      return *s1 - *s2;
8010516e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105171:	0f b6 00             	movzbl (%eax),%eax
80105174:	0f b6 d0             	movzbl %al,%edx
80105177:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010517a:	0f b6 00             	movzbl (%eax),%eax
8010517d:	0f b6 c0             	movzbl %al,%eax
80105180:	29 c2                	sub    %eax,%edx
80105182:	89 d0                	mov    %edx,%eax
80105184:	eb 1a                	jmp    801051a0 <memcmp+0x56>
    s1++, s2++;
80105186:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
80105199:	75 c3                	jne    8010515e <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801051ab:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
801051ae:	8b 45 08             	mov    0x8(%ebp),%eax
801051b1:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801051b4:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051b7:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801051ba:	73 3d                	jae    801051f9 <memmove+0x57>
801051bc:	8b 45 10             	mov    0x10(%ebp),%eax
801051bf:	8b 55 fc             	mov    -0x4(%ebp),%edx
801051c2:	01 d0                	add    %edx,%eax
801051c4:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801051c7:	76 30                	jbe    801051f9 <memmove+0x57>
    s += n;
801051c9:	8b 45 10             	mov    0x10(%ebp),%eax
801051cc:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801051cf:	8b 45 10             	mov    0x10(%ebp),%eax
801051d2:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801051d5:	eb 13                	jmp    801051ea <memmove+0x48>
      *--d = *--s;
801051d7:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801051db:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
801051df:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051e2:	0f b6 10             	movzbl (%eax),%edx
801051e5:	8b 45 f8             	mov    -0x8(%ebp),%eax
801051e8:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
801051ed:	8d 50 ff             	lea    -0x1(%eax),%edx
801051f0:	89 55 10             	mov    %edx,0x10(%ebp)
801051f3:	85 c0                	test   %eax,%eax
801051f5:	75 e0                	jne    801051d7 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801051f7:	eb 26                	jmp    8010521f <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
801051f9:	eb 17                	jmp    80105212 <memmove+0x70>
      *d++ = *s++;
801051fb:	8b 45 f8             	mov    -0x8(%ebp),%eax
801051fe:	8d 50 01             	lea    0x1(%eax),%edx
80105201:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105204:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105207:	8d 4a 01             	lea    0x1(%edx),%ecx
8010520a:	89 4d fc             	mov    %ecx,-0x4(%ebp)
8010520d:	0f b6 12             	movzbl (%edx),%edx
80105210:	88 10                	mov    %dl,(%eax)
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
8010521d:	75 dc                	jne    801051fb <memmove+0x59>
      *d++ = *s++;
...
8010523e:	e8 5f ff ff ff       	call   801051a2 <memmove>
}
80105243:	c9                   	leave  
80105244:	c3                   	ret    
...
80105246:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105248:	eb 0c                	jmp    80105256 <strncmp+0x11>
    n--, p++, q++;
8010524a:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010524e:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105252:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
80105256:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010525a:	74 1a                	je     80105276 <strncmp+0x31>
8010525c:	8b 45 08             	mov    0x8(%ebp),%eax
8010525f:	0f b6 00             	movzbl (%eax),%eax
80105262:	84 c0                	test   %al,%al
80105264:	74 10                	je     80105276 <strncmp+0x31>
80105266:	8b 45 08             	mov    0x8(%ebp),%eax
80105269:	0f b6 10             	movzbl (%eax),%edx
8010526c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010526f:	0f b6 00             	movzbl (%eax),%eax
80105272:	38 c2                	cmp    %al,%dl
80105274:	74 d4                	je     8010524a <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80105276:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010527a:	75 07                	jne    80105283 <strncmp+0x3e>
    return 0;
8010527c:	b8 00 00 00 00       	mov    $0x0,%eax
80105281:	eb 16                	jmp    80105299 <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
80105283:	8b 45 08             	mov    0x8(%ebp),%eax
80105286:	0f b6 00             	movzbl (%eax),%eax
80105289:	0f b6 d0             	movzbl %al,%edx
8010528c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010528f:	0f b6 00             	movzbl (%eax),%eax
80105292:	0f b6 c0             	movzbl %al,%eax
80105295:	29 c2                	sub    %eax,%edx
...
801052a4:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
801052a7:	90                   	nop
801052a8:	8b 45 10             	mov    0x10(%ebp),%eax
801052ab:	8d 50 ff             	lea    -0x1(%eax),%edx
801052ae:	89 55 10             	mov    %edx,0x10(%ebp)
801052b1:	85 c0                	test   %eax,%eax
801052b3:	7e 1e                	jle    801052d3 <strncpy+0x38>
801052b5:	8b 45 08             	mov    0x8(%ebp),%eax
801052b8:	8d 50 01             	lea    0x1(%eax),%edx
801052bb:	89 55 08             	mov    %edx,0x8(%ebp)
801052be:	8b 55 0c             	mov    0xc(%ebp),%edx
801052c1:	8d 4a 01             	lea    0x1(%edx),%ecx
801052c4:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801052c7:	0f b6 12             	movzbl (%edx),%edx
801052ca:	88 10                	mov    %dl,(%eax)
801052cc:	0f b6 00             	movzbl (%eax),%eax
801052cf:	84 c0                	test   %al,%al
801052d1:	75 d5                	jne    801052a8 <strncpy+0xd>
    ;
  while(n-- > 0)
801052d3:	eb 0c                	jmp    801052e1 <strncpy+0x46>
    *s++ = 0;
801052d5:	8b 45 08             	mov    0x8(%ebp),%eax
801052d8:	8d 50 01             	lea    0x1(%eax),%edx
801052db:	89 55 08             	mov    %edx,0x8(%ebp)
801052de:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
801052ec:	7f e7                	jg     801052d5 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
801052f6:	83 ec 10             	sub    $0x10,%esp
  char *os;
...
801052fc:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
801052ff:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105303:	7f 05                	jg     8010530a <safestrcpy+0x17>
    return os;
80105305:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105308:	eb 31                	jmp    8010533b <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
8010530a:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010530e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105312:	7e 1e                	jle    80105332 <safestrcpy+0x3f>
80105314:	8b 45 08             	mov    0x8(%ebp),%eax
80105317:	8d 50 01             	lea    0x1(%eax),%edx
8010531a:	89 55 08             	mov    %edx,0x8(%ebp)
8010531d:	8b 55 0c             	mov    0xc(%ebp),%edx
80105320:	8d 4a 01             	lea    0x1(%edx),%ecx
80105323:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105326:	0f b6 12             	movzbl (%edx),%edx
80105329:	88 10                	mov    %dl,(%eax)
8010532b:	0f b6 00             	movzbl (%eax),%eax
8010532e:	84 c0                	test   %al,%al
80105330:	75 d8                	jne    8010530a <safestrcpy+0x17>
    ;
  *s = 0;
80105332:	8b 45 08             	mov    0x8(%ebp),%eax
80105335:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80105340:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
80105343:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010534a:	eb 04                	jmp    80105350 <strlen+0x13>
8010534c:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
8010535d:	75 ed                	jne    8010534c <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80105364:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105368:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010536f:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105370:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105372:	89 d4                	mov    %edx,%esp
...
80105384:	3b 45 08             	cmp    0x8(%ebp),%eax
80105387:	76 12                	jbe    8010539b <fetchint+0x22>
80105389:	8b 45 08             	mov    0x8(%ebp),%eax
8010538c:	8d 50 04             	lea    0x4(%eax),%edx
8010538f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105395:	8b 00                	mov    (%eax),%eax
80105397:	39 c2                	cmp    %eax,%edx
80105399:	76 07                	jbe    801053a2 <fetchint+0x29>
    return -1;
8010539b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053a0:	eb 0f                	jmp    801053b1 <fetchint+0x38>
  *ip = *(int*)(addr);
...
801053b6:	83 ec 10             	sub    $0x10,%esp
  ...
  if(addr >= proc->sz)
801053b9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053bf:	8b 00                	mov    (%eax),%eax
801053c1:	3b 45 08             	cmp    0x8(%ebp),%eax
801053c4:	77 07                	ja     801053cd <fetchstr+0x1a>
    return -1;
801053c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053cb:	eb 46                	jmp    80105413 <fetchstr+0x60>
  *pp = (char*)addr;
801053cd:	8b 55 08             	mov    0x8(%ebp),%edx
...
801053dd:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
801053e0:	8b 45 0c             	mov    0xc(%ebp),%eax
801053e3:	8b 00                	mov    (%eax),%eax
801053e5:	89 45 fc             	mov    %eax,-0x4(%ebp)
801053e8:	eb 1c                	jmp    80105406 <fetchstr+0x53>
    if(*s == 0)
801053ea:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053ed:	0f b6 00             	movzbl (%eax),%eax
801053f0:	84 c0                	test   %al,%al
801053f2:	75 0e                	jne    80105402 <fetchstr+0x4f>
      return s - *pp;
801053f4:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053f7:	8b 45 0c             	mov    0xc(%ebp),%eax
801053fa:	8b 00                	mov    (%eax),%eax
801053fc:	29 c2                	sub    %eax,%edx
801053fe:	89 d0                	mov    %edx,%eax
80105400:	eb 11                	jmp    80105413 <fetchstr+0x60>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
80105402:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105406:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105409:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010540c:	72 dc                	jb     801053ea <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010541b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105421:	8b 40 18             	mov    0x18(%eax),%eax
80105424:	8b 50 44             	mov    0x44(%eax),%edx
...
80105439:	89 14 24             	mov    %edx,(%esp)
8010543c:	e8 38 ff ff ff       	call   80105379 <fetchint>
}
80105441:	c9                   	leave  
80105442:	c3                   	ret    
...
80105475:	73 16                	jae    8010548d <argptr+0x4a>
80105477:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010547a:	89 c2                	mov    %eax,%edx
...
8010548b:	76 07                	jbe    80105494 <argptr+0x51>
    return -1;
8010548d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105492:	eb 0f                	jmp    801054a3 <argptr+0x60>
  *pp = (char*)i;
...
801054d5:	e8 d9 fe ff ff       	call   801053b3 <fetchstr>
}
801054da:	c9                   	leave  
801054db:	c3                   	ret    
...
801054e0:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
801054e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054e9:	8b 40 18             	mov    0x18(%eax),%eax
801054ec:	8b 40 1c             	mov    0x1c(%eax),%eax
801054ef:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801054f2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801054f6:	7e 5a                	jle    80105552 <syscall+0x76>
801054f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054fb:	83 f8 1b             	cmp    $0x1b,%eax
801054fe:	77 52                	ja     80105552 <syscall+0x76>
80105500:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105503:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010550a:	85 c0                	test   %eax,%eax
8010550c:	74 44                	je     80105552 <syscall+0x76>
...
80105517:	8d 5a ff             	lea    -0x1(%edx),%ebx
8010551a:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105521:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80105524:	83 e9 01             	sub    $0x1,%ecx
80105527:	83 c1 1c             	add    $0x1c,%ecx
8010552a:	8b 54 8a 0c          	mov    0xc(%edx,%ecx,4),%edx
8010552e:	8d 4a 01             	lea    0x1(%edx),%ecx
80105531:	8d 53 1c             	lea    0x1c(%ebx),%edx
80105534:	89 4c 90 0c          	mov    %ecx,0xc(%eax,%edx,4)
    proc->tf->eax = syscalls[num]();
80105538:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010553e:	8b 58 18             	mov    0x18(%eax),%ebx
80105541:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105544:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010554b:	ff d0                	call   *%eax
8010554d:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105550:	eb 3d                	jmp    8010558f <syscall+0xb3>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105552:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105558:	8d 48 6c             	lea    0x6c(%eax),%ecx
8010555b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105561:	8b 40 10             	mov    0x10(%eax),%eax
80105564:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105567:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010556b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010556f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105573:	c7 04 24 8d 89 10 80 	movl   $0x8010898d,(%esp)
8010557a:	e8 21 ae ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
...
8010558f:	83 c4 24             	add    $0x24,%esp
80105592:	5b                   	pop    %ebx
80105593:	5d                   	pop    %ebp
80105594:	c3                   	ret    
...
801055a8:	e8 68 fe ff ff       	call   80105415 <argint>
801055ad:	85 c0                	test   %eax,%eax
801055af:	79 07                	jns    801055b8 <argfd+0x23>
    return -1;
801055b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055b6:	eb 50                	jmp    80105608 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801055b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055bb:	85 c0                	test   %eax,%eax
801055bd:	78 21                	js     801055e0 <argfd+0x4b>
801055bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055c2:	83 f8 0f             	cmp    $0xf,%eax
801055c5:	7f 19                	jg     801055e0 <argfd+0x4b>
801055c7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055cd:	8b 55 f0             	mov    -0x10(%ebp),%edx
801055d0:	83 c2 08             	add    $0x8,%edx
801055d3:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801055d7:	89 45 f4             	mov    %eax,-0xc(%ebp)
801055da:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801055de:	75 07                	jne    801055e7 <argfd+0x52>
    return -1;
801055e0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055e5:	eb 21                	jmp    80105608 <argfd+0x73>
  if(pfd)
801055e7:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801055eb:	74 08                	je     801055f5 <argfd+0x60>
    *pfd = fd;
801055ed:	8b 55 f0             	mov    -0x10(%ebp),%edx
801055f0:	8b 45 0c             	mov    0xc(%ebp),%eax
801055f3:	89 10                	mov    %edx,(%eax)
  if(pf)
801055f5:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801055f9:	74 08                	je     80105603 <argfd+0x6e>
    *pf = f;
...
80105643:	eb 0f                	jmp    80105654 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105645:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105649:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
8010564d:	7e ca                	jle    80105619 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
8010565f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105663:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010566a:	00 
8010566b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105672:	e8 1e ff ff ff       	call   80105595 <argfd>
80105677:	85 c0                	test   %eax,%eax
80105679:	79 07                	jns    80105682 <sys_dup+0x2c>
    return -1;
8010567b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105680:	eb 29                	jmp    801056ab <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105682:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105685:	89 04 24             	mov    %eax,(%esp)
80105688:	e8 7d ff ff ff       	call   8010560a <fdalloc>
8010568d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105690:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105694:	79 07                	jns    8010569d <sys_dup+0x47>
    return -1;
80105696:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010569b:	eb 0e                	jmp    801056ab <sys_dup+0x55>
  filedup(f);
8010569d:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056a0:	89 04 24             	mov    %eax,(%esp)
801056a3:	e8 ca b8 ff ff       	call   80100f72 <filedup>
  return fd;
...
801056b0:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
801056b6:	89 44 24 08          	mov    %eax,0x8(%esp)
801056ba:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801056c1:	00 
801056c2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056c9:	e8 c7 fe ff ff       	call   80105595 <argfd>
801056ce:	85 c0                	test   %eax,%eax
801056d0:	78 35                	js     80105707 <sys_read+0x5a>
801056d2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056d5:	89 44 24 04          	mov    %eax,0x4(%esp)
801056d9:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801056e0:	e8 30 fd ff ff       	call   80105415 <argint>
801056e5:	85 c0                	test   %eax,%eax
801056e7:	78 1e                	js     80105707 <sys_read+0x5a>
801056e9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056ec:	89 44 24 08          	mov    %eax,0x8(%esp)
801056f0:	8d 45 ec             	lea    -0x14(%ebp),%eax
801056f3:	89 44 24 04          	mov    %eax,0x4(%esp)
801056f7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801056fe:	e8 40 fd ff ff       	call   80105443 <argptr>
80105703:	85 c0                	test   %eax,%eax
80105705:	79 07                	jns    8010570e <sys_read+0x61>
    return -1;
80105707:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010570c:	eb 19                	jmp    80105727 <sys_read+0x7a>
  return fileread(f, p, n);
8010570e:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105711:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105714:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105717:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010571b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010571f:	89 04 24             	mov    %eax,(%esp)
80105722:	e8 b8 b9 ff ff       	call   801010df <fileread>
}
80105727:	c9                   	leave  
80105728:	c3                   	ret    
...
80105736:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010573d:	00 
8010573e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105745:	e8 4b fe ff ff       	call   80105595 <argfd>
8010574a:	85 c0                	test   %eax,%eax
8010574c:	78 35                	js     80105783 <sys_write+0x5a>
8010574e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105751:	89 44 24 04          	mov    %eax,0x4(%esp)
80105755:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010575c:	e8 b4 fc ff ff       	call   80105415 <argint>
80105761:	85 c0                	test   %eax,%eax
80105763:	78 1e                	js     80105783 <sys_write+0x5a>
...
80105773:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010577a:	e8 c4 fc ff ff       	call   80105443 <argptr>
8010577f:	85 c0                	test   %eax,%eax
80105781:	79 07                	jns    8010578a <sys_write+0x61>
    return -1;
80105783:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105788:	eb 19                	jmp    801057a3 <sys_write+0x7a>
  return filewrite(f, p, n);
8010578a:	8b 4d f0             	mov    -0x10(%ebp),%ecx
8010578d:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105790:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105793:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105797:	89 54 24 04          	mov    %edx,0x4(%esp)
8010579b:	89 04 24             	mov    %eax,(%esp)
8010579e:	e8 f8 b9 ff ff       	call   8010119b <filewrite>
}
801057a3:	c9                   	leave  
801057a4:	c3                   	ret    
...
801057c0:	e8 d0 fd ff ff       	call   80105595 <argfd>
801057c5:	85 c0                	test   %eax,%eax
801057c7:	79 07                	jns    801057d0 <sys_close+0x2b>
    return -1;
801057c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057ce:	eb 24                	jmp    801057f4 <sys_close+0x4f>
  proc->ofile[fd] = 0;
801057d0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057d6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801057d9:	83 c2 08             	add    $0x8,%edx
801057dc:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801057e3:	00 
  fileclose(f);
801057e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057e7:	89 04 24             	mov    %eax,(%esp)
801057ea:	e8 cb b7 ff ff       	call   80100fba <fileclose>
  return 0;
801057ef:	b8 00 00 00 00       	mov    $0x0,%eax
}
801057f4:	c9                   	leave  
801057f5:	c3                   	ret    
...
801057f9:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
  
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
801057fc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801057ff:	89 44 24 08          	mov    %eax,0x8(%esp)
80105803:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010580a:	00 
8010580b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105812:	e8 7e fd ff ff       	call   80105595 <argfd>
80105817:	85 c0                	test   %eax,%eax
80105819:	78 1f                	js     8010583a <sys_fstat+0x44>
8010581b:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105822:	00 
80105823:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105826:	89 44 24 04          	mov    %eax,0x4(%esp)
8010582a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105831:	e8 0d fc ff ff       	call   80105443 <argptr>
80105836:	85 c0                	test   %eax,%eax
80105838:	79 07                	jns    80105841 <sys_fstat+0x4b>
    return -1;
8010583a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010583f:	eb 12                	jmp    80105853 <sys_fstat+0x5d>
  return filestat(f, st);
80105841:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105844:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105847:	89 54 24 04          	mov    %edx,0x4(%esp)
8010584b:	89 04 24             	mov    %eax,(%esp)
8010584e:	e8 3d b8 ff ff       	call   80101090 <filestat>
}
80105853:	c9                   	leave  
80105854:	c3                   	ret    
...
8010585b:	8d 45 d8             	lea    -0x28(%ebp),%eax
8010585e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105862:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105869:	e8 37 fc ff ff       	call   801054a5 <argstr>
8010586e:	85 c0                	test   %eax,%eax
80105870:	78 17                	js     80105889 <sys_link+0x34>
80105872:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105875:	89 44 24 04          	mov    %eax,0x4(%esp)
80105879:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105880:	e8 20 fc ff ff       	call   801054a5 <argstr>
80105885:	85 c0                	test   %eax,%eax
80105887:	79 0a                	jns    80105893 <sys_link+0x3e>
    return -1;
80105889:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010588e:	e9 3d 01 00 00       	jmp    801059d0 <sys_link+0x17b>
  if((ip = namei(old)) == 0)
80105893:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105896:	89 04 24             	mov    %eax,(%esp)
80105899:	e8 54 cb ff ff       	call   801023f2 <namei>
8010589e:	89 45 f4             	mov    %eax,-0xc(%ebp)
801058a1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801058a5:	75 0a                	jne    801058b1 <sys_link+0x5c>
    return -1;
801058a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058ac:	e9 1f 01 00 00       	jmp    801059d0 <sys_link+0x17b>

  begin_trans();
801058b1:	e8 1b d9 ff ff       	call   801031d1 <begin_trans>

  ilock(ip);
801058b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b9:	89 04 24             	mov    %eax,(%esp)
801058bc:	e8 86 bf ff ff       	call   80101847 <ilock>
  if(ip->type == T_DIR){
801058c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058c4:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801058c8:	66 83 f8 01          	cmp    $0x1,%ax
801058cc:	75 1a                	jne    801058e8 <sys_link+0x93>
    iunlockput(ip);
801058ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058d1:	89 04 24             	mov    %eax,(%esp)
801058d4:	e8 f2 c1 ff ff       	call   80101acb <iunlockput>
    commit_trans();
801058d9:	e8 3c d9 ff ff       	call   8010321a <commit_trans>
    return -1;
801058de:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058e3:	e9 e8 00 00 00       	jmp    801059d0 <sys_link+0x17b>
  }
...
801058ff:	e8 87 bd ff ff       	call   8010168b <iupdate>
  iunlock(ip);
80105904:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105907:	89 04 24             	mov    %eax,(%esp)
8010590a:	e8 86 c0 ff ff       	call   80101995 <iunlock>
...
8010591c:	e8 f3 ca ff ff       	call   80102414 <nameiparent>
80105921:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105924:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105928:	75 02                	jne    8010592c <sys_link+0xd7>
    goto bad;
8010592a:	eb 68                	jmp    80105994 <sys_link+0x13f>
  ilock(dp);
8010592c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010592f:	89 04 24             	mov    %eax,(%esp)
80105932:	e8 10 bf ff ff       	call   80101847 <ilock>
...
80105943:	75 20                	jne    80105965 <sys_link+0x110>
...
8010595c:	e8 d1 c7 ff ff       	call   80102132 <dirlink>
80105961:	85 c0                	test   %eax,%eax
80105963:	79 0d                	jns    80105972 <sys_link+0x11d>
    iunlockput(dp);
80105965:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105968:	89 04 24             	mov    %eax,(%esp)
8010596b:	e8 5b c1 ff ff       	call   80101acb <iunlockput>
    goto bad;
80105970:	eb 22                	jmp    80105994 <sys_link+0x13f>
  }
  iunlockput(dp);
80105972:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105975:	89 04 24             	mov    %eax,(%esp)
80105978:	e8 4e c1 ff ff       	call   80101acb <iunlockput>
  iput(ip);
8010597d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105980:	89 04 24             	mov    %eax,(%esp)
80105983:	e8 72 c0 ff ff       	call   801019fa <iput>

  commit_trans();
80105988:	e8 8d d8 ff ff       	call   8010321a <commit_trans>

  return 0;
8010598d:	b8 00 00 00 00       	mov    $0x0,%eax
80105992:	eb 3c                	jmp    801059d0 <sys_link+0x17b>

bad:
  ilock(ip);
80105994:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105997:	89 04 24             	mov    %eax,(%esp)
8010599a:	e8 a8 be ff ff       	call   80101847 <ilock>
  ip->nlink--;
...
801059fd:	e8 52 c3 ff ff       	call   80101d54 <readi>
80105a02:	83 f8 10             	cmp    $0x10,%eax
80105a05:	74 0c                	je     80105a13 <isdirempty+0x41>
      panic("isdirempty: readi");
80105a07:	c7 04 24 a9 89 10 80 	movl   $0x801089a9,(%esp)
...
80105a74:	e8 9b c9 ff ff       	call   80102414 <nameiparent>
...
80105a87:	e9 85 01 00 00       	jmp    80105c11 <sys_unlink+0x1d1>

  begin_trans();
80105a8c:	e8 40 d7 ff ff       	call   801031d1 <begin_trans>

  ilock(dp);
80105a91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a94:	89 04 24             	mov    %eax,(%esp)
80105a97:	e8 ab bd ff ff       	call   80101847 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105a9c:	c7 44 24 04 bb 89 10 	movl   $0x801089bb,0x4(%esp)
80105aa3:	80 
80105aa4:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105aa7:	89 04 24             	mov    %eax,(%esp)
80105aaa:	e8 98 c5 ff ff       	call   80102047 <namecmp>
80105aaf:	85 c0                	test   %eax,%eax
80105ab1:	0f 84 45 01 00 00    	je     80105bfc <sys_unlink+0x1bc>
80105ab7:	c7 44 24 04 bd 89 10 	movl   $0x801089bd,0x4(%esp)
80105abe:	80 
80105abf:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105ac2:	89 04 24             	mov    %eax,(%esp)
80105ac5:	e8 7d c5 ff ff       	call   80102047 <namecmp>
80105aca:	85 c0                	test   %eax,%eax
80105acc:	0f 84 2a 01 00 00    	je     80105bfc <sys_unlink+0x1bc>
    goto bad;
...
80105ae6:	e8 7e c5 ff ff       	call   80102069 <dirlookup>
80105aeb:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105aee:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105af2:	75 05                	jne    80105af9 <sys_unlink+0xb9>
    goto bad;
80105af4:	e9 03 01 00 00       	jmp    80105bfc <sys_unlink+0x1bc>
  ilock(ip);
80105af9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105afc:	89 04 24             	mov    %eax,(%esp)
80105aff:	e8 43 bd ff ff       	call   80101847 <ilock>

  if(ip->nlink < 1)
80105b04:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b07:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b0b:	66 85 c0             	test   %ax,%ax
80105b0e:	7f 0c                	jg     80105b1c <sys_unlink+0xdc>
    panic("unlink: nlink < 1");
80105b10:	c7 04 24 c0 89 10 80 	movl   $0x801089c0,(%esp)
...
80105b27:	75 1f                	jne    80105b48 <sys_unlink+0x108>
80105b29:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b2c:	89 04 24             	mov    %eax,(%esp)
80105b2f:	e8 9e fe ff ff       	call   801059d2 <isdirempty>
80105b34:	85 c0                	test   %eax,%eax
80105b36:	75 10                	jne    80105b48 <sys_unlink+0x108>
    iunlockput(ip);
80105b38:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3b:	89 04 24             	mov    %eax,(%esp)
80105b3e:	e8 88 bf ff ff       	call   80101acb <iunlockput>
    goto bad;
80105b43:	e9 b4 00 00 00       	jmp    80105bfc <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105b48:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105b4f:	00 
80105b50:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b57:	00 
80105b58:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b5b:	89 04 24             	mov    %eax,(%esp)
80105b5e:	e8 70 f5 ff ff       	call   801050d3 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b63:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105b66:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105b6d:	00 
80105b6e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b72:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b75:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b7c:	89 04 24             	mov    %eax,(%esp)
80105b7f:	e8 34 c3 ff ff       	call   80101eb8 <writei>
80105b84:	83 f8 10             	cmp    $0x10,%eax
80105b87:	74 0c                	je     80105b95 <sys_unlink+0x155>
    panic("unlink: writei");
80105b89:	c7 04 24 d2 89 10 80 	movl   $0x801089d2,(%esp)
80105b90:	e8 a5 a9 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105b95:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b98:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b9c:	66 83 f8 01          	cmp    $0x1,%ax
80105ba0:	75 1c                	jne    80105bbe <sys_unlink+0x17e>
    dp->nlink--;
80105ba2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ba5:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80105bc4:	e8 02 bf ff ff       	call   80101acb <iunlockput>

  ip->nlink--;
80105bc9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bcc:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105bd0:	8d 50 ff             	lea    -0x1(%eax),%edx
80105bd3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bd6:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105bda:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bdd:	89 04 24             	mov    %eax,(%esp)
80105be0:	e8 a6 ba ff ff       	call   8010168b <iupdate>
  iunlockput(ip);
80105be5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105be8:	89 04 24             	mov    %eax,(%esp)
80105beb:	e8 db be ff ff       	call   80101acb <iunlockput>

  commit_trans();
80105bf0:	e8 25 d6 ff ff       	call   8010321a <commit_trans>

  return 0;
80105bf5:	b8 00 00 00 00       	mov    $0x0,%eax
80105bfa:	eb 15                	jmp    80105c11 <sys_unlink+0x1d1>

bad:
  iunlockput(dp);
80105bfc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bff:	89 04 24             	mov    %eax,(%esp)
80105c02:	e8 c4 be ff ff       	call   80101acb <iunlockput>
  commit_trans();
80105c07:	e8 0e d6 ff ff       	call   8010321a <commit_trans>
  return -1;
...
80105c16:	83 ec 48             	sub    $0x48,%esp
80105c19:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105c1c:	8b 55 10             	mov    0x10(%ebp),%edx
80105c1f:	8b 45 14             	mov    0x14(%ebp),%eax
80105c22:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105c26:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105c2a:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105c2e:	8d 45 de             	lea    -0x22(%ebp),%eax
80105c31:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c35:	8b 45 08             	mov    0x8(%ebp),%eax
80105c38:	89 04 24             	mov    %eax,(%esp)
80105c3b:	e8 d4 c7 ff ff       	call   80102414 <nameiparent>
80105c40:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c43:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c47:	75 0a                	jne    80105c53 <create+0x40>
    return 0;
80105c49:	b8 00 00 00 00       	mov    $0x0,%eax
80105c4e:	e9 7e 01 00 00       	jmp    80105dd1 <create+0x1be>
  ilock(dp);
80105c53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c56:	89 04 24             	mov    %eax,(%esp)
80105c59:	e8 e9 bb ff ff       	call   80101847 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105c5e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105c61:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c65:	8d 45 de             	lea    -0x22(%ebp),%eax
80105c68:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c6c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c6f:	89 04 24             	mov    %eax,(%esp)
80105c72:	e8 f2 c3 ff ff       	call   80102069 <dirlookup>
80105c77:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c7a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c7e:	74 47                	je     80105cc7 <create+0xb4>
    iunlockput(dp);
80105c80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c83:	89 04 24             	mov    %eax,(%esp)
80105c86:	e8 40 be ff ff       	call   80101acb <iunlockput>
    ilock(ip);
80105c8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c8e:	89 04 24             	mov    %eax,(%esp)
80105c91:	e8 b1 bb ff ff       	call   80101847 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105c96:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105c9b:	75 15                	jne    80105cb2 <create+0x9f>
80105c9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ca0:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ca4:	66 83 f8 02          	cmp    $0x2,%ax
80105ca8:	75 08                	jne    80105cb2 <create+0x9f>
      return ip;
80105caa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cad:	e9 1f 01 00 00       	jmp    80105dd1 <create+0x1be>
    iunlockput(ip);
80105cb2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cb5:	89 04 24             	mov    %eax,(%esp)
80105cb8:	e8 0e be ff ff       	call   80101acb <iunlockput>
    return 0;
80105cbd:	b8 00 00 00 00       	mov    $0x0,%eax
80105cc2:	e9 0a 01 00 00       	jmp    80105dd1 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105cc7:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105ccb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cce:	8b 00                	mov    (%eax),%eax
80105cd0:	89 54 24 04          	mov    %edx,0x4(%esp)
80105cd4:	89 04 24             	mov    %eax,(%esp)
80105cd7:	e8 d0 b8 ff ff       	call   801015ac <ialloc>
80105cdc:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105cdf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ce3:	75 0c                	jne    80105cf1 <create+0xde>
    panic("create: ialloc");
80105ce5:	c7 04 24 e1 89 10 80 	movl   $0x801089e1,(%esp)
80105cec:	e8 49 a8 ff ff       	call   8010053a <panic>

  ilock(ip);
80105cf1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cf4:	89 04 24             	mov    %eax,(%esp)
80105cf7:	e8 4b bb ff ff       	call   80101847 <ilock>
  ip->major = major;
80105cfc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cff:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105d03:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105d07:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d0a:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105d0e:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105d12:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d15:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105d1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d1e:	89 04 24             	mov    %eax,(%esp)
80105d21:	e8 65 b9 ff ff       	call   8010168b <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105d26:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105d2b:	75 6a                	jne    80105d97 <create+0x184>
    dp->nlink++;  // for ".."
...
80105d44:	e8 42 b9 ff ff       	call   8010168b <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105d49:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d4c:	8b 40 04             	mov    0x4(%eax),%eax
80105d4f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d53:	c7 44 24 04 bb 89 10 	movl   $0x801089bb,0x4(%esp)
80105d5a:	80 
80105d5b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d5e:	89 04 24             	mov    %eax,(%esp)
80105d61:	e8 cc c3 ff ff       	call   80102132 <dirlink>
80105d66:	85 c0                	test   %eax,%eax
80105d68:	78 21                	js     80105d8b <create+0x178>
80105d6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d6d:	8b 40 04             	mov    0x4(%eax),%eax
80105d70:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d74:	c7 44 24 04 bd 89 10 	movl   $0x801089bd,0x4(%esp)
80105d7b:	80 
80105d7c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d7f:	89 04 24             	mov    %eax,(%esp)
80105d82:	e8 ab c3 ff ff       	call   80102132 <dirlink>
80105d87:	85 c0                	test   %eax,%eax
80105d89:	79 0c                	jns    80105d97 <create+0x184>
      panic("create dots");
80105d8b:	c7 04 24 f0 89 10 80 	movl   $0x801089f0,(%esp)
80105d92:	e8 a3 a7 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105d97:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d9a:	8b 40 04             	mov    0x4(%eax),%eax
...
80105dae:	e8 7f c3 ff ff       	call   80102132 <dirlink>
80105db3:	85 c0                	test   %eax,%eax
80105db5:	79 0c                	jns    80105dc3 <create+0x1b0>
    panic("create: dirlink");
80105db7:	c7 04 24 fc 89 10 80 	movl   $0x801089fc,(%esp)
80105dbe:	e8 77 a7 ff ff       	call   8010053a <panic>

  iunlockput(dp);
80105dc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dc6:	89 04 24             	mov    %eax,(%esp)
80105dc9:	e8 fd bc ff ff       	call   80101acb <iunlockput>
...
80105dd9:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105ddc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105de0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105de7:	e8 b9 f6 ff ff       	call   801054a5 <argstr>
80105dec:	85 c0                	test   %eax,%eax
80105dee:	78 17                	js     80105e07 <sys_open+0x34>
80105df0:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105df3:	89 44 24 04          	mov    %eax,0x4(%esp)
80105df7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105dfe:	e8 12 f6 ff ff       	call   80105415 <argint>
80105e03:	85 c0                	test   %eax,%eax
80105e05:	79 0a                	jns    80105e11 <sys_open+0x3e>
    return -1;
80105e07:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e0c:	e9 48 01 00 00       	jmp    80105f59 <sys_open+0x186>
  if(omode & O_CREATE){
80105e11:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e14:	25 00 02 00 00       	and    $0x200,%eax
80105e19:	85 c0                	test   %eax,%eax
80105e1b:	74 40                	je     80105e5d <sys_open+0x8a>
    begin_trans();
80105e1d:	e8 af d3 ff ff       	call   801031d1 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105e22:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e25:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105e2c:	00 
80105e2d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105e34:	00 
80105e35:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105e3c:	00 
80105e3d:	89 04 24             	mov    %eax,(%esp)
80105e40:	e8 ce fd ff ff       	call   80105c13 <create>
80105e45:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105e48:	e8 cd d3 ff ff       	call   8010321a <commit_trans>
    if(ip == 0)
80105e4d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e51:	75 5c                	jne    80105eaf <sys_open+0xdc>
      return -1;
80105e53:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e58:	e9 fc 00 00 00       	jmp    80105f59 <sys_open+0x186>
  } else {
    if((ip = namei(path)) == 0)
80105e5d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e60:	89 04 24             	mov    %eax,(%esp)
80105e63:	e8 8a c5 ff ff       	call   801023f2 <namei>
80105e68:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e6b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e6f:	75 0a                	jne    80105e7b <sys_open+0xa8>
      return -1;
80105e71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e76:	e9 de 00 00 00       	jmp    80105f59 <sys_open+0x186>
    ilock(ip);
80105e7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e7e:	89 04 24             	mov    %eax,(%esp)
80105e81:	e8 c1 b9 ff ff       	call   80101847 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105e86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e89:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e8d:	66 83 f8 01          	cmp    $0x1,%ax
80105e91:	75 1c                	jne    80105eaf <sys_open+0xdc>
80105e93:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e96:	85 c0                	test   %eax,%eax
80105e98:	74 15                	je     80105eaf <sys_open+0xdc>
      iunlockput(ip);
80105e9a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e9d:	89 04 24             	mov    %eax,(%esp)
80105ea0:	e8 26 bc ff ff       	call   80101acb <iunlockput>
      return -1;
80105ea5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eaa:	e9 aa 00 00 00       	jmp    80105f59 <sys_open+0x186>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105eaf:	e8 5e b0 ff ff       	call   80100f12 <filealloc>
80105eb4:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105eb7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ebb:	74 14                	je     80105ed1 <sys_open+0xfe>
80105ebd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ec0:	89 04 24             	mov    %eax,(%esp)
80105ec3:	e8 42 f7 ff ff       	call   8010560a <fdalloc>
80105ec8:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105ecb:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105ecf:	79 23                	jns    80105ef4 <sys_open+0x121>
    if(f)
80105ed1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ed5:	74 0b                	je     80105ee2 <sys_open+0x10f>
      fileclose(f);
80105ed7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eda:	89 04 24             	mov    %eax,(%esp)
80105edd:	e8 d8 b0 ff ff       	call   80100fba <fileclose>
    iunlockput(ip);
...
80105ef2:	eb 65                	jmp    80105f59 <sys_open+0x186>
  }
  iunlock(ip);
80105ef4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ef7:	89 04 24             	mov    %eax,(%esp)
80105efa:	e8 96 ba ff ff       	call   80101995 <iunlock>
...
80105f23:	0f 94 c0             	sete   %al
80105f26:	89 c2                	mov    %eax,%edx
80105f28:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f2b:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105f2e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f31:	83 e0 01             	and    $0x1,%eax
80105f34:	85 c0                	test   %eax,%eax
80105f36:	75 0a                	jne    80105f42 <sys_open+0x16f>
80105f38:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f3b:	83 e0 02             	and    $0x2,%eax
80105f3e:	85 c0                	test   %eax,%eax
80105f40:	74 07                	je     80105f49 <sys_open+0x176>
80105f42:	b8 01 00 00 00       	mov    $0x1,%eax
80105f47:	eb 05                	jmp    80105f4e <sys_open+0x17b>
80105f49:	b8 00 00 00 00       	mov    $0x0,%eax
80105f4e:	89 c2                	mov    %eax,%edx
80105f50:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f53:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105f56:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105f59:	c9                   	leave  
80105f5a:	c3                   	ret    
...
80105f5e:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
80105f61:	e8 6b d2 ff ff       	call   801031d1 <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80105f66:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105f69:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f6d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f74:	e8 2c f5 ff ff       	call   801054a5 <argstr>
80105f79:	85 c0                	test   %eax,%eax
80105f7b:	78 2c                	js     80105fa9 <sys_mkdir+0x4e>
80105f7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f80:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105f87:	00 
80105f88:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105f8f:	00 
80105f90:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105f97:	00 
80105f98:	89 04 24             	mov    %eax,(%esp)
80105f9b:	e8 73 fc ff ff       	call   80105c13 <create>
80105fa0:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105fa3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105fa7:	75 0c                	jne    80105fb5 <sys_mkdir+0x5a>
    commit_trans();
80105fa9:	e8 6c d2 ff ff       	call   8010321a <commit_trans>
    return -1;
80105fae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fb3:	eb 15                	jmp    80105fca <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105fb5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fb8:	89 04 24             	mov    %eax,(%esp)
80105fbb:	e8 0b bb ff ff       	call   80101acb <iunlockput>
  commit_trans();
80105fc0:	e8 55 d2 ff ff       	call   8010321a <commit_trans>
  return 0;
...
80105fcf:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
...
80106008:	78 47                	js     80106051 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010600a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010600d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106011:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106018:	e8 f8 f3 ff ff       	call   80105415 <argint>
  int len;
  int major, minor;
...
8010601f:	78 30                	js     80106051 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106021:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106024:	0f bf c8             	movswl %ax,%ecx
80106027:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010602a:	0f bf d0             	movswl %ax,%edx
8010602d:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106030:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106034:	89 54 24 08          	mov    %edx,0x8(%esp)
80106038:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010603f:	00 
80106040:	89 04 24             	mov    %eax,(%esp)
80106043:	e8 cb fb ff ff       	call   80105c13 <create>
80106048:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010604b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010604f:	75 0c                	jne    8010605d <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80106051:	e8 c4 d1 ff ff       	call   8010321a <commit_trans>
    return -1;
80106056:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010605b:	eb 15                	jmp    80106072 <sys_mknod+0xa6>
  }
  iunlockput(ip);
8010605d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106060:	89 04 24             	mov    %eax,(%esp)
80106063:	e8 63 ba ff ff       	call   80101acb <iunlockput>
  commit_trans();
80106068:	e8 ad d1 ff ff       	call   8010321a <commit_trans>
  return 0;
...
80106108:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
8010611c:	e8 84 f3 ff ff       	call   801054a5 <argstr>
80106121:	85 c0                	test   %eax,%eax
80106123:	78 1a                	js     8010613f <sys_exec+0x3a>
80106125:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
8010612b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010612f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106136:	e8 da f2 ff ff       	call   80105415 <argint>
8010613b:	85 c0                	test   %eax,%eax
8010613d:	79 0a                	jns    80106149 <sys_exec+0x44>
    return -1;
8010613f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106144:	e9 c8 00 00 00       	jmp    80106211 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
80106149:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106150:	00 
80106151:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106158:	00 
80106159:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010615f:	89 04 24             	mov    %eax,(%esp)
80106162:	e8 6c ef ff ff       	call   801050d3 <memset>
  for(i=0;; i++){
80106167:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
8010616e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106171:	83 f8 1f             	cmp    $0x1f,%eax
80106174:	76 0a                	jbe    80106180 <sys_exec+0x7b>
      return -1;
80106176:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010617b:	e9 91 00 00 00       	jmp    80106211 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106180:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106183:	c1 e0 02             	shl    $0x2,%eax
80106186:	89 c2                	mov    %eax,%edx
80106188:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
8010618e:	01 c2                	add    %eax,%edx
80106190:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106196:	89 44 24 04          	mov    %eax,0x4(%esp)
8010619a:	89 14 24             	mov    %edx,(%esp)
8010619d:	e8 d7 f1 ff ff       	call   80105379 <fetchint>
801061a2:	85 c0                	test   %eax,%eax
801061a4:	79 07                	jns    801061ad <sys_exec+0xa8>
      return -1;
801061a6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061ab:	eb 64                	jmp    80106211 <sys_exec+0x10c>
    if(uarg == 0){
801061ad:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801061b3:	85 c0                	test   %eax,%eax
801061b5:	75 26                	jne    801061dd <sys_exec+0xd8>
      argv[i] = 0;
801061b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ba:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801061c1:	00 00 00 00 
      break;
801061c5:	90                   	nop
    }
...
801061c9:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801061cf:	89 54 24 04          	mov    %edx,0x4(%esp)
801061d3:	89 04 24             	mov    %eax,(%esp)
801061d6:	e8 14 a9 ff ff       	call   80100aef <exec>
801061db:	eb 34                	jmp    80106211 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
801061dd:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801061e3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801061e6:	c1 e2 02             	shl    $0x2,%edx
801061e9:	01 c2                	add    %eax,%edx
801061eb:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801061f1:	89 54 24 04          	mov    %edx,0x4(%esp)
801061f5:	89 04 24             	mov    %eax,(%esp)
801061f8:	e8 b6 f1 ff ff       	call   801053b3 <fetchstr>
801061fd:	85 c0                	test   %eax,%eax
801061ff:	79 07                	jns    80106208 <sys_exec+0x103>
      return -1;
80106201:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106206:	eb 09                	jmp    80106211 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106208:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
8010620c:	e9 5d ff ff ff       	jmp    8010616e <sys_exec+0x69>
  return exec(path, argv);
}
80106211:	c9                   	leave  
80106212:	c3                   	ret    
...
80106216:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106219:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106220:	00 
80106221:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106224:	89 44 24 04          	mov    %eax,0x4(%esp)
80106228:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010622f:	e8 0f f2 ff ff       	call   80105443 <argptr>
80106234:	85 c0                	test   %eax,%eax
80106236:	79 0a                	jns    80106242 <sys_pipe+0x2f>
    return -1;
80106238:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010623d:	e9 9b 00 00 00       	jmp    801062dd <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106242:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106245:	89 44 24 04          	mov    %eax,0x4(%esp)
80106249:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010624c:	89 04 24             	mov    %eax,(%esp)
8010624f:	e8 67 d9 ff ff       	call   80103bbb <pipealloc>
80106254:	85 c0                	test   %eax,%eax
80106256:	79 07                	jns    8010625f <sys_pipe+0x4c>
    return -1;
80106258:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010625d:	eb 7e                	jmp    801062dd <sys_pipe+0xca>
  fd0 = -1;
8010625f:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106266:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106269:	89 04 24             	mov    %eax,(%esp)
8010626c:	e8 99 f3 ff ff       	call   8010560a <fdalloc>
80106271:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106274:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106278:	78 14                	js     8010628e <sys_pipe+0x7b>
8010627a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010627d:	89 04 24             	mov    %eax,(%esp)
80106280:	e8 85 f3 ff ff       	call   8010560a <fdalloc>
80106285:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106288:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010628c:	79 37                	jns    801062c5 <sys_pipe+0xb2>
    if(fd0 >= 0)
8010628e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106292:	78 14                	js     801062a8 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106294:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010629a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010629d:	83 c2 08             	add    $0x8,%edx
801062a0:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801062a7:	00 
    fileclose(rf);
801062a8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062ab:	89 04 24             	mov    %eax,(%esp)
801062ae:	e8 07 ad ff ff       	call   80100fba <fileclose>
    fileclose(wf);
801062b3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062b6:	89 04 24             	mov    %eax,(%esp)
801062b9:	e8 fc ac ff ff       	call   80100fba <fileclose>
    return -1;
801062be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062c3:	eb 18                	jmp    801062dd <sys_pipe+0xca>
  }
  fd[0] = fd0;
801062c5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801062c8:	8b 55 f4             	mov    -0xc(%ebp),%edx
801062cb:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
801062cd:	8b 45 ec             	mov    -0x14(%ebp),%eax
801062d0:	8d 50 04             	lea    0x4(%eax),%edx
801062d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062d6:	89 02                	mov    %eax,(%edx)
  return 0;
...
801062e2:	83 ec 08             	sub    $0x8,%esp
  return fork();
801062e5:	e8 a3 df ff ff       	call   8010428d <fork>
}
801062ea:	c9                   	leave  
801062eb:	c3                   	ret    
...
801062ef:	83 ec 08             	sub    $0x8,%esp
  exit();
801062f2:	e8 f9 e0 ff ff       	call   801043f0 <exit>
...
80106301:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106304:	e8 02 e2 ff ff       	call   8010450b <wait>
}
80106309:	c9                   	leave  
8010630a:	c3                   	ret    
...
8010630e:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &pid) < 0)
80106311:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106314:	89 44 24 04          	mov    %eax,0x4(%esp)
80106318:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010631f:	e8 f1 f0 ff ff       	call   80105415 <argint>
80106324:	85 c0                	test   %eax,%eax
80106326:	79 07                	jns    8010632f <sys_kill+0x24>
    return -1;
80106328:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010632d:	eb 0b                	jmp    8010633a <sys_kill+0x2f>
  return kill(pid);
8010632f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106332:	89 04 24             	mov    %eax,(%esp)
80106335:	e8 95 e5 ff ff       	call   801048cf <kill>
}
8010633a:	c9                   	leave  
8010633b:	c3                   	ret    
...
80106345:	8b 40 10             	mov    0x10(%eax),%eax
}
80106348:	5d                   	pop    %ebp
80106349:	c3                   	ret    
...
8010634d:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;
...
8010635e:	e8 b2 f0 ff ff       	call   80105415 <argint>
80106363:	85 c0                	test   %eax,%eax
80106365:	79 07                	jns    8010636e <sys_sbrk+0x24>
    return -1;
80106367:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010636c:	eb 24                	jmp    80106392 <sys_sbrk+0x48>
  addr = proc->sz;
8010636e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
8010637f:	e8 64 de ff ff       	call   801041e8 <growproc>
80106384:	85 c0                	test   %eax,%eax
80106386:	79 07                	jns    8010638f <sys_sbrk+0x45>
    return -1;
80106388:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010638d:	eb 03                	jmp    80106392 <sys_sbrk+0x48>
  return addr;
...
801063a8:	e8 68 f0 ff ff       	call   80105415 <argint>
801063ad:	85 c0                	test   %eax,%eax
801063af:	79 07                	jns    801063b8 <sys_sleep+0x24>
    return -1;
801063b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063b6:	eb 6c                	jmp    80106424 <sys_sleep+0x90>
  acquire(&tickslock);
801063b8:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
801063bf:	e8 c4 e9 ff ff       	call   80104d88 <acquire>
  ticks0 = ticks;
801063c4:	a1 e0 50 11 80       	mov    0x801150e0,%eax
801063c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801063cc:	eb 34                	jmp    80106402 <sys_sleep+0x6e>
    if(proc->killed){
801063ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063d4:	8b 40 24             	mov    0x24(%eax),%eax
801063d7:	85 c0                	test   %eax,%eax
801063d9:	74 13                	je     801063ee <sys_sleep+0x5a>
      release(&tickslock);
801063db:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
801063e2:	e8 03 ea ff ff       	call   80104dea <release>
      return -1;
801063e7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063ec:	eb 36                	jmp    80106424 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801063ee:	c7 44 24 04 a0 48 11 	movl   $0x801148a0,0x4(%esp)
801063f5:	80 
801063f6:	c7 04 24 e0 50 11 80 	movl   $0x801150e0,(%esp)
801063fd:	e8 c6 e3 ff ff       	call   801047c8 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106402:	a1 e0 50 11 80       	mov    0x801150e0,%eax
80106407:	2b 45 f4             	sub    -0xc(%ebp),%eax
8010640a:	89 c2                	mov    %eax,%edx
8010640c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010640f:	39 c2                	cmp    %eax,%edx
80106411:	72 bb                	jb     801063ce <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106413:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
8010641a:	e8 cb e9 ff ff       	call   80104dea <release>
  return 0;
...
80106429:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
8010642c:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
80106433:	e8 50 e9 ff ff       	call   80104d88 <acquire>
  xticks = ticks;
80106438:	a1 e0 50 11 80       	mov    0x801150e0,%eax
8010643d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106440:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
80106447:	e8 9e e9 ff ff       	call   80104dea <release>
  return xticks;
...
80106454:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &scid) < 0)
80106457:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010645a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010645e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106465:	e8 ab ef ff ff       	call   80105415 <argint>
8010646a:	85 c0                	test   %eax,%eax
8010646c:	79 07                	jns    80106475 <sys_getcount+0x24>
    return -1;
8010646e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106473:	eb 13                	jmp    80106488 <sys_getcount+0x37>
  return proc->sccount[scid-1];
80106475:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010647b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010647e:	83 ea 01             	sub    $0x1,%edx
80106481:	83 c2 1c             	add    $0x1c,%edx
80106484:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
}
80106488:	c9                   	leave  
80106489:	c3                   	ret    

8010648a <sys_thread_create>:
...
8010648d:	83 ec 28             	sub    $0x28,%esp
  int tMain, arg, stack;
  if(argint(0, &tMain) < 0)
80106490:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106493:	89 44 24 04          	mov    %eax,0x4(%esp)
80106497:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010649e:	e8 72 ef ff ff       	call   80105415 <argint>
801064a3:	85 c0                	test   %eax,%eax
801064a5:	79 07                	jns    801064ae <sys_thread_create+0x24>
    return -1;
801064a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064ac:	eb 59                	jmp    80106507 <sys_thread_create+0x7d>
  if(argint(2, &arg) < 0)
801064ae:	8d 45 f0             	lea    -0x10(%ebp),%eax
801064b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801064b5:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801064bc:	e8 54 ef ff ff       	call   80105415 <argint>
801064c1:	85 c0                	test   %eax,%eax
801064c3:	79 07                	jns    801064cc <sys_thread_create+0x42>
    return -1;
801064c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064ca:	eb 3b                	jmp    80106507 <sys_thread_create+0x7d>
  if(argint(1, &stack) < 0)
801064cc:	8d 45 ec             	lea    -0x14(%ebp),%eax
801064cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801064d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801064da:	e8 36 ef ff ff       	call   80105415 <argint>
801064df:	85 c0                	test   %eax,%eax
801064e1:	79 07                	jns    801064ea <sys_thread_create+0x60>
    return -1;
801064e3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064e8:	eb 1d                	jmp    80106507 <sys_thread_create+0x7d>
  return thread_create((void*)tMain, (void*)stack, (void*)arg);
801064ea:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064ed:	89 c1                	mov    %eax,%ecx
801064ef:	8b 45 ec             	mov    -0x14(%ebp),%eax
801064f2:	89 c2                	mov    %eax,%edx
801064f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064f7:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801064fb:	89 54 24 04          	mov    %edx,0x4(%esp)
801064ff:	89 04 24             	mov    %eax,(%esp)
80106502:	e8 3d e5 ff ff       	call   80104a44 <thread_create>
}
80106507:	c9                   	leave  
80106508:	c3                   	ret    

80106509 <sys_thread_join>:
...
80106516:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010651d:	e8 f3 ee ff ff       	call   80105415 <argint>
80106522:	85 c0                	test   %eax,%eax
80106524:	79 07                	jns    8010652d <sys_thread_join+0x24>
    return -1;
80106526:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010652b:	eb 0b                	jmp    80106538 <sys_thread_join+0x2f>
  return thread_join((void**)stack);
8010652d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106530:	89 04 24             	mov    %eax,(%esp)
80106533:	e8 d7 e6 ff ff       	call   80104c0f <thread_join>
}
80106538:	c9                   	leave  
80106539:	c3                   	ret    

8010653a <sys_mtx_create>:
...
8010653d:	83 ec 28             	sub    $0x28,%esp
  int locked;
  if(argint(0, &locked) < 0)
80106540:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106543:	89 44 24 04          	mov    %eax,0x4(%esp)
80106547:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010654e:	e8 c2 ee ff ff       	call   80105415 <argint>
80106553:	85 c0                	test   %eax,%eax
80106555:	79 07                	jns    8010655e <sys_mtx_create+0x24>
    return -1;
80106557:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010655c:	eb 0b                	jmp    80106569 <sys_mtx_create+0x2f>
  return mtx_create(locked);
8010655e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106561:	89 04 24             	mov    %eax,(%esp)
80106564:	e8 c8 ea ff ff       	call   80105031 <mtx_create>
}
80106569:	c9                   	leave  
8010656a:	c3                   	ret    

8010656b <sys_mtx_lock>:
...
8010657f:	e8 91 ee ff ff       	call   80105415 <argint>
80106584:	85 c0                	test   %eax,%eax
80106586:	79 07                	jns    8010658f <sys_mtx_lock+0x24>
    return -1;
80106588:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010658d:	eb 0b                	jmp    8010659a <sys_mtx_lock+0x2f>
  return mtx_create(lock_id);
8010658f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106592:	89 04 24             	mov    %eax,(%esp)
80106595:	e8 97 ea ff ff       	call   80105031 <mtx_create>
}
8010659a:	c9                   	leave  
8010659b:	c3                   	ret    

8010659c <sys_mtx_unlock>:
...
8010659f:	83 ec 28             	sub    $0x28,%esp
  int lock_id;
  if(argint(0, &lock_id) < 0)
801065a2:	8d 45 f4             	lea    -0xc(%ebp),%eax
801065a5:	89 44 24 04          	mov    %eax,0x4(%esp)
801065a9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065b0:	e8 60 ee ff ff       	call   80105415 <argint>
801065b5:	85 c0                	test   %eax,%eax
801065b7:	79 07                	jns    801065c0 <sys_mtx_unlock+0x24>
    return -1;
801065b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065be:	eb 0b                	jmp    801065cb <sys_mtx_unlock+0x2f>
  return mtx_create(lock_id);
801065c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c3:	89 04 24             	mov    %eax,(%esp)
801065c6:	e8 66 ea ff ff       	call   80105031 <mtx_create>
}
801065cb:	c9                   	leave  
801065cc:	c3                   	ret    
...
801065d9:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
...
801065f1:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801065f8:	00 
801065f9:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106600:	e8 c8 ff ff ff       	call   801065cd <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106605:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
8010660c:	00 
8010660d:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106614:	e8 b4 ff ff ff       	call   801065cd <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106619:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106620:	00 
80106621:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106628:	e8 a0 ff ff ff       	call   801065cd <outb>
  picenable(IRQ_TIMER);
8010662d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106634:	e8 15 d4 ff ff       	call   80103a4e <picenable>
}
80106639:	c9                   	leave  
8010663a:	c3                   	ret    
...
8010663c:	06                   	push   %es
  pushl %fs
8010663d:	0f a0                	push   %fs
  pushl %gs
8010663f:	0f a8                	push   %gs
  pushal
80106641:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106642:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106646:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106648:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
8010664a:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
8010664e:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106650:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106652:	54                   	push   %esp
  call trap
80106653:	e8 d8 01 00 00       	call   80106830 <trap>
  addl $4, %esp
80106658:	83 c4 04             	add    $0x4,%esp
...
8010665b:	61                   	popa   
  popl %gs
8010665c:	0f a9                	pop    %gs
  popl %fs
8010665e:	0f a1                	pop    %fs
  popl %es
80106660:	07                   	pop    %es
  popl %ds
80106661:	1f                   	pop    %ds
...
80106669:	83 ec 10             	sub    $0x10,%esp
  ...
  pd[0] = size-1;
8010666c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010666f:	83 e8 01             	sub    $0x1,%eax
80106672:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106676:	8b 45 08             	mov    0x8(%ebp),%eax
80106679:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010667d:	8b 45 08             	mov    0x8(%ebp),%eax
80106680:	c1 e8 10             	shr    $0x10,%eax
80106683:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106687:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010668a:	0f 01 18             	lidtl  (%eax)
}
8010668d:	c9                   	leave  
8010668e:	c3                   	ret    
...
80106695:	0f 20 d0             	mov    %cr2,%eax
80106698:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
8010669b:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
8010669e:	c9                   	leave  
8010669f:	c3                   	ret    
...
801066a3:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
801066a6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801066ad:	e9 c3 00 00 00       	jmp    80106775 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801066b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066b5:	8b 04 85 b0 b0 10 80 	mov    -0x7fef4f50(,%eax,4),%eax
801066bc:	89 c2                	mov    %eax,%edx
801066be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066c1:	66 89 14 c5 e0 48 11 	mov    %dx,-0x7feeb720(,%eax,8)
801066c8:	80 
801066c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066cc:	66 c7 04 c5 e2 48 11 	movw   $0x8,-0x7feeb71e(,%eax,8)
801066d3:	80 08 00 
801066d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d9:	0f b6 14 c5 e4 48 11 	movzbl -0x7feeb71c(,%eax,8),%edx
801066e0:	80 
801066e1:	83 e2 e0             	and    $0xffffffe0,%edx
801066e4:	88 14 c5 e4 48 11 80 	mov    %dl,-0x7feeb71c(,%eax,8)
801066eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066ee:	0f b6 14 c5 e4 48 11 	movzbl -0x7feeb71c(,%eax,8),%edx
801066f5:	80 
801066f6:	83 e2 1f             	and    $0x1f,%edx
801066f9:	88 14 c5 e4 48 11 80 	mov    %dl,-0x7feeb71c(,%eax,8)
80106700:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106703:	0f b6 14 c5 e5 48 11 	movzbl -0x7feeb71b(,%eax,8),%edx
8010670a:	80 
8010670b:	83 e2 f0             	and    $0xfffffff0,%edx
8010670e:	83 ca 0e             	or     $0xe,%edx
80106711:	88 14 c5 e5 48 11 80 	mov    %dl,-0x7feeb71b(,%eax,8)
80106718:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010671b:	0f b6 14 c5 e5 48 11 	movzbl -0x7feeb71b(,%eax,8),%edx
80106722:	80 
80106723:	83 e2 ef             	and    $0xffffffef,%edx
80106726:	88 14 c5 e5 48 11 80 	mov    %dl,-0x7feeb71b(,%eax,8)
8010672d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106730:	0f b6 14 c5 e5 48 11 	movzbl -0x7feeb71b(,%eax,8),%edx
80106737:	80 
80106738:	83 e2 9f             	and    $0xffffff9f,%edx
...
8010674c:	80 
8010674d:	83 ca 80             	or     $0xffffff80,%edx
80106750:	88 14 c5 e5 48 11 80 	mov    %dl,-0x7feeb71b(,%eax,8)
80106757:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010675a:	8b 04 85 b0 b0 10 80 	mov    -0x7fef4f50(,%eax,4),%eax
80106761:	c1 e8 10             	shr    $0x10,%eax
80106764:	89 c2                	mov    %eax,%edx
80106766:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106769:	66 89 14 c5 e6 48 11 	mov    %dx,-0x7feeb71a(,%eax,8)
80106770:	80 
void
tvinit(void)
{
...
80106775:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
8010677c:	0f 8e 30 ff ff ff    	jle    801066b2 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106782:	a1 b0 b1 10 80       	mov    0x8010b1b0,%eax
80106787:	66 a3 e0 4a 11 80    	mov    %ax,0x80114ae0
8010678d:	66 c7 05 e2 4a 11 80 	movw   $0x8,0x80114ae2
80106794:	08 00 
80106796:	0f b6 05 e4 4a 11 80 	movzbl 0x80114ae4,%eax
8010679d:	83 e0 e0             	and    $0xffffffe0,%eax
801067a0:	a2 e4 4a 11 80       	mov    %al,0x80114ae4
801067a5:	0f b6 05 e4 4a 11 80 	movzbl 0x80114ae4,%eax
801067ac:	83 e0 1f             	and    $0x1f,%eax
801067af:	a2 e4 4a 11 80       	mov    %al,0x80114ae4
801067b4:	0f b6 05 e5 4a 11 80 	movzbl 0x80114ae5,%eax
801067bb:	83 c8 0f             	or     $0xf,%eax
801067be:	a2 e5 4a 11 80       	mov    %al,0x80114ae5
801067c3:	0f b6 05 e5 4a 11 80 	movzbl 0x80114ae5,%eax
801067ca:	83 e0 ef             	and    $0xffffffef,%eax
801067cd:	a2 e5 4a 11 80       	mov    %al,0x80114ae5
801067d2:	0f b6 05 e5 4a 11 80 	movzbl 0x80114ae5,%eax
801067d9:	83 c8 60             	or     $0x60,%eax
801067dc:	a2 e5 4a 11 80       	mov    %al,0x80114ae5
801067e1:	0f b6 05 e5 4a 11 80 	movzbl 0x80114ae5,%eax
801067e8:	83 c8 80             	or     $0xffffff80,%eax
801067eb:	a2 e5 4a 11 80       	mov    %al,0x80114ae5
801067f0:	a1 b0 b1 10 80       	mov    0x8010b1b0,%eax
801067f5:	c1 e8 10             	shr    $0x10,%eax
801067f8:	66 a3 e6 4a 11 80    	mov    %ax,0x80114ae6
  
  initlock(&tickslock, "time");
801067fe:	c7 44 24 04 0c 8a 10 	movl   $0x80108a0c,0x4(%esp)
80106805:	80 
80106806:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
8010680d:	e8 55 e5 ff ff       	call   80104d67 <initlock>
}
80106812:	c9                   	leave  
80106813:	c3                   	ret    
...
80106817:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
8010681a:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106821:	00 
80106822:	c7 04 24 e0 48 11 80 	movl   $0x801148e0,(%esp)
80106829:	e8 38 fe ff ff       	call   80106666 <lidt>
}
8010682e:	c9                   	leave  
8010682f:	c3                   	ret    
...
80106836:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106839:	8b 45 08             	mov    0x8(%ebp),%eax
8010683c:	8b 40 30             	mov    0x30(%eax),%eax
8010683f:	83 f8 40             	cmp    $0x40,%eax
80106842:	75 3f                	jne    80106883 <trap+0x53>
    if(proc->killed)
80106844:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010684a:	8b 40 24             	mov    0x24(%eax),%eax
8010684d:	85 c0                	test   %eax,%eax
8010684f:	74 05                	je     80106856 <trap+0x26>
      exit();
80106851:	e8 9a db ff ff       	call   801043f0 <exit>
    proc->tf = tf;
80106856:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010685c:	8b 55 08             	mov    0x8(%ebp),%edx
8010685f:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106862:	e8 75 ec ff ff       	call   801054dc <syscall>
    if(proc->killed)
80106867:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010686d:	8b 40 24             	mov    0x24(%eax),%eax
80106870:	85 c0                	test   %eax,%eax
80106872:	74 0a                	je     8010687e <trap+0x4e>
      exit();
80106874:	e8 77 db ff ff       	call   801043f0 <exit>
    return;
80106879:	e9 2d 02 00 00       	jmp    80106aab <trap+0x27b>
8010687e:	e9 28 02 00 00       	jmp    80106aab <trap+0x27b>
  }

  switch(tf->trapno){
80106883:	8b 45 08             	mov    0x8(%ebp),%eax
80106886:	8b 40 30             	mov    0x30(%eax),%eax
80106889:	83 e8 20             	sub    $0x20,%eax
8010688c:	83 f8 1f             	cmp    $0x1f,%eax
8010688f:	0f 87 bc 00 00 00    	ja     80106951 <trap+0x121>
80106895:	8b 04 85 b4 8a 10 80 	mov    -0x7fef754c(,%eax,4),%eax
8010689c:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
8010689e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801068a4:	0f b6 00             	movzbl (%eax),%eax
801068a7:	84 c0                	test   %al,%al
801068a9:	75 31                	jne    801068dc <trap+0xac>
      acquire(&tickslock);
801068ab:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
801068b2:	e8 d1 e4 ff ff       	call   80104d88 <acquire>
      ticks++;
801068b7:	a1 e0 50 11 80       	mov    0x801150e0,%eax
801068bc:	83 c0 01             	add    $0x1,%eax
801068bf:	a3 e0 50 11 80       	mov    %eax,0x801150e0
      wakeup(&ticks);
801068c4:	c7 04 24 e0 50 11 80 	movl   $0x801150e0,(%esp)
801068cb:	e8 d4 df ff ff       	call   801048a4 <wakeup>
      release(&tickslock);
801068d0:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
801068d7:	e8 0e e5 ff ff       	call   80104dea <release>
    }
    lapiceoi();
801068dc:	e8 be c5 ff ff       	call   80102e9f <lapiceoi>
    break;
801068e1:	e9 41 01 00 00       	jmp    80106a27 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801068e6:	e8 df bd ff ff       	call   801026ca <ideintr>
    lapiceoi();
801068eb:	e8 af c5 ff ff       	call   80102e9f <lapiceoi>
    break;
801068f0:	e9 32 01 00 00       	jmp    80106a27 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801068f5:	e8 91 c3 ff ff       	call   80102c8b <kbdintr>
    lapiceoi();
801068fa:	e8 a0 c5 ff ff       	call   80102e9f <lapiceoi>
    break;
801068ff:	e9 23 01 00 00       	jmp    80106a27 <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106904:	e8 97 03 00 00       	call   80106ca0 <uartintr>
    lapiceoi();
80106909:	e8 91 c5 ff ff       	call   80102e9f <lapiceoi>
    break;
8010690e:	e9 14 01 00 00       	jmp    80106a27 <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106913:	8b 45 08             	mov    0x8(%ebp),%eax
80106916:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106919:	8b 45 08             	mov    0x8(%ebp),%eax
8010691c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106920:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106923:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106929:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
8010692f:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106933:	89 54 24 08          	mov    %edx,0x8(%esp)
80106937:	89 44 24 04          	mov    %eax,0x4(%esp)
8010693b:	c7 04 24 14 8a 10 80 	movl   $0x80108a14,(%esp)
80106942:	e8 59 9a ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106947:	e8 53 c5 ff ff       	call   80102e9f <lapiceoi>
    break;
8010694c:	e9 d6 00 00 00       	jmp    80106a27 <trap+0x1f7>
...
80106959:	74 11                	je     8010696c <trap+0x13c>
8010695b:	8b 45 08             	mov    0x8(%ebp),%eax
8010695e:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106962:	0f b7 c0             	movzwl %ax,%eax
80106965:	83 e0 03             	and    $0x3,%eax
80106968:	85 c0                	test   %eax,%eax
8010696a:	75 46                	jne    801069b2 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010696c:	e8 1e fd ff ff       	call   8010668f <rcr2>
80106971:	8b 55 08             	mov    0x8(%ebp),%edx
80106974:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106977:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010697e:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106981:	0f b6 ca             	movzbl %dl,%ecx
80106984:	8b 55 08             	mov    0x8(%ebp),%edx
80106987:	8b 52 30             	mov    0x30(%edx),%edx
8010698a:	89 44 24 10          	mov    %eax,0x10(%esp)
8010698e:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106992:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106996:	89 54 24 04          	mov    %edx,0x4(%esp)
8010699a:	c7 04 24 38 8a 10 80 	movl   $0x80108a38,(%esp)
801069a1:	e8 fa 99 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801069a6:	c7 04 24 6a 8a 10 80 	movl   $0x80108a6a,(%esp)
801069ad:	e8 88 9b ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801069b2:	e8 d8 fc ff ff       	call   8010668f <rcr2>
801069b7:	89 c2                	mov    %eax,%edx
801069b9:	8b 45 08             	mov    0x8(%ebp),%eax
801069bc:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801069bf:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801069c5:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801069c8:	0f b6 f0             	movzbl %al,%esi
801069cb:	8b 45 08             	mov    0x8(%ebp),%eax
801069ce:	8b 58 34             	mov    0x34(%eax),%ebx
801069d1:	8b 45 08             	mov    0x8(%ebp),%eax
801069d4:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801069d7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069dd:	83 c0 6c             	add    $0x6c,%eax
...
801069e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801069e9:	8b 40 10             	mov    0x10(%eax),%eax
801069ec:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801069f0:	89 7c 24 18          	mov    %edi,0x18(%esp)
801069f4:	89 74 24 14          	mov    %esi,0x14(%esp)
801069f8:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801069fc:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106a00:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106a03:	89 74 24 08          	mov    %esi,0x8(%esp)
80106a07:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a0b:	c7 04 24 70 8a 10 80 	movl   $0x80108a70,(%esp)
80106a12:	e8 89 99 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106a17:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a1d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106a24:	eb 01                	jmp    80106a27 <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106a4e:	75 05                	jne    80106a55 <trap+0x225>
    exit();
80106a50:	e8 9b d9 ff ff       	call   801043f0 <exit>
...
80106a5d:	74 1e                	je     80106a7d <trap+0x24d>
80106a5f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a65:	8b 40 0c             	mov    0xc(%eax),%eax
80106a68:	83 f8 04             	cmp    $0x4,%eax
80106a6b:	75 10                	jne    80106a7d <trap+0x24d>
80106a6d:	8b 45 08             	mov    0x8(%ebp),%eax
80106a70:	8b 40 30             	mov    0x30(%eax),%eax
80106a73:	83 f8 20             	cmp    $0x20,%eax
80106a76:	75 05                	jne    80106a7d <trap+0x24d>
    yield();
80106a78:	e8 ed dc ff ff       	call   8010476a <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106a7d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a83:	85 c0                	test   %eax,%eax
80106a85:	74 24                	je     80106aab <trap+0x27b>
80106a87:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a8d:	8b 40 24             	mov    0x24(%eax),%eax
80106a90:	85 c0                	test   %eax,%eax
80106a92:	74 17                	je     80106aab <trap+0x27b>
80106a94:	8b 45 08             	mov    0x8(%ebp),%eax
80106a97:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106a9b:	0f b7 c0             	movzwl %ax,%eax
80106a9e:	83 e0 03             	and    $0x3,%eax
80106aa1:	83 f8 03             	cmp    $0x3,%eax
80106aa4:	75 05                	jne    80106aab <trap+0x27b>
    exit();
80106aa6:	e8 45 d9 ff ff       	call   801043f0 <exit>
}
80106aab:	83 c4 3c             	add    $0x3c,%esp
80106aae:	5b                   	pop    %ebx
80106aaf:	5e                   	pop    %esi
80106ab0:	5f                   	pop    %edi
80106ab1:	5d                   	pop    %ebp
...
80106abc:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106ac0:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106ac4:	89 c2                	mov    %eax,%edx
80106ac6:	ec                   	in     (%dx),%al
80106ac7:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106aca:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106ace:	c9                   	leave  
80106acf:	c3                   	ret    
...
80106adc:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106ae0:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106ae3:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106ae7:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106aeb:	ee                   	out    %al,(%dx)
}
80106aec:	c9                   	leave  
80106aed:	c3                   	ret    
...
80106afb:	00 
80106afc:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b03:	e8 c8 ff ff ff       	call   80106ad0 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106b08:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106b0f:	00 
80106b10:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b17:	e8 b4 ff ff ff       	call   80106ad0 <outb>
  outb(COM1+0, 115200/9600);
80106b1c:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106b23:	00 
80106b24:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b2b:	e8 a0 ff ff ff       	call   80106ad0 <outb>
  outb(COM1+1, 0);
80106b30:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b37:	00 
80106b38:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b3f:	e8 8c ff ff ff       	call   80106ad0 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106b44:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106b4b:	00 
80106b4c:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b53:	e8 78 ff ff ff       	call   80106ad0 <outb>
  outb(COM1+4, 0);
80106b58:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b5f:	00 
80106b60:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106b67:	e8 64 ff ff ff       	call   80106ad0 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106b6c:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106b73:	00 
80106b74:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b7b:	e8 50 ff ff ff       	call   80106ad0 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106b80:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b87:	e8 27 ff ff ff       	call   80106ab3 <inb>
80106b8c:	3c ff                	cmp    $0xff,%al
80106b8e:	75 02                	jne    80106b92 <uartinit+0xa4>
    return;
80106b90:	eb 6a                	jmp    80106bfc <uartinit+0x10e>
  uart = 1;
80106b92:	c7 05 70 b6 10 80 01 	movl   $0x1,0x8010b670
80106b99:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106b9c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106ba3:	e8 0b ff ff ff       	call   80106ab3 <inb>
  inb(COM1+0);
80106ba8:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106baf:	e8 ff fe ff ff       	call   80106ab3 <inb>
  picenable(IRQ_COM1);
80106bb4:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106bbb:	e8 8e ce ff ff       	call   80103a4e <picenable>
  ioapicenable(IRQ_COM1, 0);
80106bc0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106bc7:	00 
80106bc8:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106bcf:	e8 75 bd ff ff       	call   80102949 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106bd4:	c7 45 f4 34 8b 10 80 	movl   $0x80108b34,-0xc(%ebp)
80106bdb:	eb 15                	jmp    80106bf2 <uartinit+0x104>
    uartputc(*p);
...
80106be9:	e8 10 00 00 00       	call   80106bfe <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106bee:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106bf2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bf5:	0f b6 00             	movzbl (%eax),%eax
80106bf8:	84 c0                	test   %al,%al
80106bfa:	75 e1                	jne    80106bdd <uartinit+0xef>
    uartputc(*p);
}
80106bfc:	c9                   	leave  
80106bfd:	c3                   	ret    
...
80106c01:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106c04:	a1 70 b6 10 80       	mov    0x8010b670,%eax
80106c09:	85 c0                	test   %eax,%eax
80106c0b:	75 02                	jne    80106c0f <uartputc+0x11>
    return;
80106c0d:	eb 4b                	jmp    80106c5a <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106c0f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106c16:	eb 10                	jmp    80106c28 <uartputc+0x2a>
    microdelay(10);
80106c18:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106c1f:	e8 a0 c2 ff ff       	call   80102ec4 <microdelay>
{
  int i;
...
80106c28:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106c2c:	7f 16                	jg     80106c44 <uartputc+0x46>
80106c2e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c35:	e8 79 fe ff ff       	call   80106ab3 <inb>
80106c3a:	0f b6 c0             	movzbl %al,%eax
80106c3d:	83 e0 20             	and    $0x20,%eax
80106c40:	85 c0                	test   %eax,%eax
80106c42:	74 d4                	je     80106c18 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106c44:	8b 45 08             	mov    0x8(%ebp),%eax
80106c47:	0f b6 c0             	movzbl %al,%eax
80106c4a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c4e:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c55:	e8 76 fe ff ff       	call   80106ad0 <outb>
}
80106c5a:	c9                   	leave  
80106c5b:	c3                   	ret    
...
80106c5f:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106c62:	a1 70 b6 10 80       	mov    0x8010b670,%eax
80106c67:	85 c0                	test   %eax,%eax
80106c69:	75 07                	jne    80106c72 <uartgetc+0x16>
    return -1;
80106c6b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c70:	eb 2c                	jmp    80106c9e <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106c72:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c79:	e8 35 fe ff ff       	call   80106ab3 <inb>
80106c7e:	0f b6 c0             	movzbl %al,%eax
80106c81:	83 e0 01             	and    $0x1,%eax
80106c84:	85 c0                	test   %eax,%eax
80106c86:	75 07                	jne    80106c8f <uartgetc+0x33>
    return -1;
80106c88:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c8d:	eb 0f                	jmp    80106c9e <uartgetc+0x42>
  return inb(COM1+0);
80106c8f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c96:	e8 18 fe ff ff       	call   80106ab3 <inb>
...
80106ca6:	c7 04 24 5c 6c 10 80 	movl   $0x80106c5c,(%esp)
80106cad:	e8 fb 9a ff ff       	call   801007ad <consoleintr>
}
80106cb2:	c9                   	leave  
80106cb3:	c3                   	ret    
...
80106cb6:	6a 00                	push   $0x0
  jmp alltraps
80106cb8:	e9 7e f9 ff ff       	jmp    8010663b <alltraps>
...
80106cbf:	6a 01                	push   $0x1
  jmp alltraps
80106cc1:	e9 75 f9 ff ff       	jmp    8010663b <alltraps>
...
80106cc8:	6a 02                	push   $0x2
  jmp alltraps
80106cca:	e9 6c f9 ff ff       	jmp    8010663b <alltraps>
...
80106cd1:	6a 03                	push   $0x3
  jmp alltraps
80106cd3:	e9 63 f9 ff ff       	jmp    8010663b <alltraps>
...
80106cda:	6a 04                	push   $0x4
  jmp alltraps
80106cdc:	e9 5a f9 ff ff       	jmp    8010663b <alltraps>
...
80106ce3:	6a 05                	push   $0x5
  jmp alltraps
80106ce5:	e9 51 f9 ff ff       	jmp    8010663b <alltraps>
...
80106cec:	6a 06                	push   $0x6
  jmp alltraps
80106cee:	e9 48 f9 ff ff       	jmp    8010663b <alltraps>
...
80106cf5:	6a 07                	push   $0x7
  jmp alltraps
80106cf7:	e9 3f f9 ff ff       	jmp    8010663b <alltraps>
...
80106cfc:	6a 08                	push   $0x8
  jmp alltraps
80106cfe:	e9 38 f9 ff ff       	jmp    8010663b <alltraps>
...
80106d05:	6a 09                	push   $0x9
  jmp alltraps
80106d07:	e9 2f f9 ff ff       	jmp    8010663b <alltraps>
...
80106d0c:	6a 0a                	push   $0xa
  jmp alltraps
80106d0e:	e9 28 f9 ff ff       	jmp    8010663b <alltraps>
...
80106d13:	6a 0b                	push   $0xb
  jmp alltraps
80106d15:	e9 21 f9 ff ff       	jmp    8010663b <alltraps>
...
80106d1a:	6a 0c                	push   $0xc
  jmp alltraps
80106d1c:	e9 1a f9 ff ff       	jmp    8010663b <alltraps>
...
80106d21:	6a 0d                	push   $0xd
  jmp alltraps
80106d23:	e9 13 f9 ff ff       	jmp    8010663b <alltraps>
...
80106d28:	6a 0e                	push   $0xe
  jmp alltraps
80106d2a:	e9 0c f9 ff ff       	jmp    8010663b <alltraps>
...
80106d31:	6a 0f                	push   $0xf
  jmp alltraps
80106d33:	e9 03 f9 ff ff       	jmp    8010663b <alltraps>
...
80106d3a:	6a 10                	push   $0x10
  jmp alltraps
80106d3c:	e9 fa f8 ff ff       	jmp    8010663b <alltraps>
...
80106d41:	6a 11                	push   $0x11
  jmp alltraps
80106d43:	e9 f3 f8 ff ff       	jmp    8010663b <alltraps>
...
80106d4a:	6a 12                	push   $0x12
  jmp alltraps
80106d4c:	e9 ea f8 ff ff       	jmp    8010663b <alltraps>
...
80106d53:	6a 13                	push   $0x13
  jmp alltraps
80106d55:	e9 e1 f8 ff ff       	jmp    8010663b <alltraps>
...
80106d5c:	6a 14                	push   $0x14
  jmp alltraps
80106d5e:	e9 d8 f8 ff ff       	jmp    8010663b <alltraps>
...
80106d65:	6a 15                	push   $0x15
  jmp alltraps
80106d67:	e9 cf f8 ff ff       	jmp    8010663b <alltraps>
...
80106d6e:	6a 16                	push   $0x16
  jmp alltraps
80106d70:	e9 c6 f8 ff ff       	jmp    8010663b <alltraps>
...
80106d77:	6a 17                	push   $0x17
  jmp alltraps
80106d79:	e9 bd f8 ff ff       	jmp    8010663b <alltraps>
...
80106d80:	6a 18                	push   $0x18
  jmp alltraps
80106d82:	e9 b4 f8 ff ff       	jmp    8010663b <alltraps>
...
80106d89:	6a 19                	push   $0x19
  jmp alltraps
80106d8b:	e9 ab f8 ff ff       	jmp    8010663b <alltraps>
...
80106d92:	6a 1a                	push   $0x1a
  jmp alltraps
80106d94:	e9 a2 f8 ff ff       	jmp    8010663b <alltraps>
...
80106d9b:	6a 1b                	push   $0x1b
  jmp alltraps
80106d9d:	e9 99 f8 ff ff       	jmp    8010663b <alltraps>
...
80106da4:	6a 1c                	push   $0x1c
  jmp alltraps
80106da6:	e9 90 f8 ff ff       	jmp    8010663b <alltraps>
...
80106dad:	6a 1d                	push   $0x1d
  jmp alltraps
80106daf:	e9 87 f8 ff ff       	jmp    8010663b <alltraps>
...
80106db6:	6a 1e                	push   $0x1e
  jmp alltraps
80106db8:	e9 7e f8 ff ff       	jmp    8010663b <alltraps>
...
80106dbf:	6a 1f                	push   $0x1f
  jmp alltraps
80106dc1:	e9 75 f8 ff ff       	jmp    8010663b <alltraps>
...
80106dc8:	6a 20                	push   $0x20
  jmp alltraps
80106dca:	e9 6c f8 ff ff       	jmp    8010663b <alltraps>
...
80106dd1:	6a 21                	push   $0x21
  jmp alltraps
80106dd3:	e9 63 f8 ff ff       	jmp    8010663b <alltraps>
...
80106dda:	6a 22                	push   $0x22
  jmp alltraps
80106ddc:	e9 5a f8 ff ff       	jmp    8010663b <alltraps>
...
80106de3:	6a 23                	push   $0x23
  jmp alltraps
80106de5:	e9 51 f8 ff ff       	jmp    8010663b <alltraps>
...
80106dec:	6a 24                	push   $0x24
  jmp alltraps
80106dee:	e9 48 f8 ff ff       	jmp    8010663b <alltraps>
...
80106df5:	6a 25                	push   $0x25
  jmp alltraps
80106df7:	e9 3f f8 ff ff       	jmp    8010663b <alltraps>
...
80106dfe:	6a 26                	push   $0x26
  jmp alltraps
80106e00:	e9 36 f8 ff ff       	jmp    8010663b <alltraps>
...
80106e07:	6a 27                	push   $0x27
  jmp alltraps
80106e09:	e9 2d f8 ff ff       	jmp    8010663b <alltraps>
...
80106e10:	6a 28                	push   $0x28
  jmp alltraps
80106e12:	e9 24 f8 ff ff       	jmp    8010663b <alltraps>
...
80106e19:	6a 29                	push   $0x29
  jmp alltraps
80106e1b:	e9 1b f8 ff ff       	jmp    8010663b <alltraps>
...
80106e22:	6a 2a                	push   $0x2a
  jmp alltraps
80106e24:	e9 12 f8 ff ff       	jmp    8010663b <alltraps>
...
80106e2b:	6a 2b                	push   $0x2b
  jmp alltraps
80106e2d:	e9 09 f8 ff ff       	jmp    8010663b <alltraps>
...
80106e34:	6a 2c                	push   $0x2c
  jmp alltraps
80106e36:	e9 00 f8 ff ff       	jmp    8010663b <alltraps>
...
80106e3d:	6a 2d                	push   $0x2d
  jmp alltraps
80106e3f:	e9 f7 f7 ff ff       	jmp    8010663b <alltraps>
...
80106e46:	6a 2e                	push   $0x2e
  jmp alltraps
80106e48:	e9 ee f7 ff ff       	jmp    8010663b <alltraps>
...
80106e4f:	6a 2f                	push   $0x2f
  jmp alltraps
80106e51:	e9 e5 f7 ff ff       	jmp    8010663b <alltraps>
...
80106e58:	6a 30                	push   $0x30
  jmp alltraps
80106e5a:	e9 dc f7 ff ff       	jmp    8010663b <alltraps>
...
80106e61:	6a 31                	push   $0x31
  jmp alltraps
80106e63:	e9 d3 f7 ff ff       	jmp    8010663b <alltraps>
...
80106e6a:	6a 32                	push   $0x32
  jmp alltraps
80106e6c:	e9 ca f7 ff ff       	jmp    8010663b <alltraps>
...
80106e73:	6a 33                	push   $0x33
  jmp alltraps
80106e75:	e9 c1 f7 ff ff       	jmp    8010663b <alltraps>
...
80106e7c:	6a 34                	push   $0x34
  jmp alltraps
80106e7e:	e9 b8 f7 ff ff       	jmp    8010663b <alltraps>
...
80106e85:	6a 35                	push   $0x35
  jmp alltraps
80106e87:	e9 af f7 ff ff       	jmp    8010663b <alltraps>
...
80106e8e:	6a 36                	push   $0x36
  jmp alltraps
80106e90:	e9 a6 f7 ff ff       	jmp    8010663b <alltraps>
...
80106e97:	6a 37                	push   $0x37
  jmp alltraps
80106e99:	e9 9d f7 ff ff       	jmp    8010663b <alltraps>
...
80106ea0:	6a 38                	push   $0x38
  jmp alltraps
80106ea2:	e9 94 f7 ff ff       	jmp    8010663b <alltraps>
...
80106ea9:	6a 39                	push   $0x39
  jmp alltraps
80106eab:	e9 8b f7 ff ff       	jmp    8010663b <alltraps>
...
80106eb2:	6a 3a                	push   $0x3a
  jmp alltraps
80106eb4:	e9 82 f7 ff ff       	jmp    8010663b <alltraps>
...
80106ebb:	6a 3b                	push   $0x3b
  jmp alltraps
80106ebd:	e9 79 f7 ff ff       	jmp    8010663b <alltraps>
...
80106ec4:	6a 3c                	push   $0x3c
  jmp alltraps
80106ec6:	e9 70 f7 ff ff       	jmp    8010663b <alltraps>
...
80106ecd:	6a 3d                	push   $0x3d
  jmp alltraps
80106ecf:	e9 67 f7 ff ff       	jmp    8010663b <alltraps>
...
80106ed6:	6a 3e                	push   $0x3e
  jmp alltraps
80106ed8:	e9 5e f7 ff ff       	jmp    8010663b <alltraps>
...
80106edf:	6a 3f                	push   $0x3f
  jmp alltraps
80106ee1:	e9 55 f7 ff ff       	jmp    8010663b <alltraps>
...
80106ee8:	6a 40                	push   $0x40
  jmp alltraps
80106eea:	e9 4c f7 ff ff       	jmp    8010663b <alltraps>
...
80106ef1:	6a 41                	push   $0x41
  jmp alltraps
80106ef3:	e9 43 f7 ff ff       	jmp    8010663b <alltraps>
...
80106efa:	6a 42                	push   $0x42
  jmp alltraps
80106efc:	e9 3a f7 ff ff       	jmp    8010663b <alltraps>
...
80106f03:	6a 43                	push   $0x43
  jmp alltraps
80106f05:	e9 31 f7 ff ff       	jmp    8010663b <alltraps>
...
80106f0c:	6a 44                	push   $0x44
  jmp alltraps
80106f0e:	e9 28 f7 ff ff       	jmp    8010663b <alltraps>
...
80106f15:	6a 45                	push   $0x45
  jmp alltraps
80106f17:	e9 1f f7 ff ff       	jmp    8010663b <alltraps>
...
80106f1e:	6a 46                	push   $0x46
  jmp alltraps
80106f20:	e9 16 f7 ff ff       	jmp    8010663b <alltraps>
...
80106f27:	6a 47                	push   $0x47
  jmp alltraps
80106f29:	e9 0d f7 ff ff       	jmp    8010663b <alltraps>
...
80106f30:	6a 48                	push   $0x48
  jmp alltraps
80106f32:	e9 04 f7 ff ff       	jmp    8010663b <alltraps>
...
80106f39:	6a 49                	push   $0x49
  jmp alltraps
80106f3b:	e9 fb f6 ff ff       	jmp    8010663b <alltraps>
...
80106f42:	6a 4a                	push   $0x4a
  jmp alltraps
80106f44:	e9 f2 f6 ff ff       	jmp    8010663b <alltraps>
...
80106f4b:	6a 4b                	push   $0x4b
  jmp alltraps
80106f4d:	e9 e9 f6 ff ff       	jmp    8010663b <alltraps>
...
80106f54:	6a 4c                	push   $0x4c
  jmp alltraps
80106f56:	e9 e0 f6 ff ff       	jmp    8010663b <alltraps>
...
80106f5d:	6a 4d                	push   $0x4d
  jmp alltraps
80106f5f:	e9 d7 f6 ff ff       	jmp    8010663b <alltraps>
...
80106f66:	6a 4e                	push   $0x4e
  jmp alltraps
80106f68:	e9 ce f6 ff ff       	jmp    8010663b <alltraps>
...
80106f6f:	6a 4f                	push   $0x4f
  jmp alltraps
80106f71:	e9 c5 f6 ff ff       	jmp    8010663b <alltraps>
...
80106f78:	6a 50                	push   $0x50
  jmp alltraps
80106f7a:	e9 bc f6 ff ff       	jmp    8010663b <alltraps>
...
80106f81:	6a 51                	push   $0x51
  jmp alltraps
80106f83:	e9 b3 f6 ff ff       	jmp    8010663b <alltraps>
...
80106f8a:	6a 52                	push   $0x52
  jmp alltraps
80106f8c:	e9 aa f6 ff ff       	jmp    8010663b <alltraps>
...
80106f93:	6a 53                	push   $0x53
  jmp alltraps
80106f95:	e9 a1 f6 ff ff       	jmp    8010663b <alltraps>
...
80106f9c:	6a 54                	push   $0x54
  jmp alltraps
80106f9e:	e9 98 f6 ff ff       	jmp    8010663b <alltraps>
...
80106fa5:	6a 55                	push   $0x55
  jmp alltraps
80106fa7:	e9 8f f6 ff ff       	jmp    8010663b <alltraps>
...
80106fae:	6a 56                	push   $0x56
  jmp alltraps
80106fb0:	e9 86 f6 ff ff       	jmp    8010663b <alltraps>
...
80106fb7:	6a 57                	push   $0x57
  jmp alltraps
80106fb9:	e9 7d f6 ff ff       	jmp    8010663b <alltraps>
...
80106fc0:	6a 58                	push   $0x58
  jmp alltraps
80106fc2:	e9 74 f6 ff ff       	jmp    8010663b <alltraps>
...
80106fc9:	6a 59                	push   $0x59
  jmp alltraps
80106fcb:	e9 6b f6 ff ff       	jmp    8010663b <alltraps>
...
80106fd2:	6a 5a                	push   $0x5a
  jmp alltraps
80106fd4:	e9 62 f6 ff ff       	jmp    8010663b <alltraps>
...
80106fdb:	6a 5b                	push   $0x5b
  jmp alltraps
80106fdd:	e9 59 f6 ff ff       	jmp    8010663b <alltraps>
...
80106fe4:	6a 5c                	push   $0x5c
  jmp alltraps
80106fe6:	e9 50 f6 ff ff       	jmp    8010663b <alltraps>
...
80106fed:	6a 5d                	push   $0x5d
  jmp alltraps
80106fef:	e9 47 f6 ff ff       	jmp    8010663b <alltraps>
...
80106ff6:	6a 5e                	push   $0x5e
  jmp alltraps
80106ff8:	e9 3e f6 ff ff       	jmp    8010663b <alltraps>
...
80106fff:	6a 5f                	push   $0x5f
  jmp alltraps
80107001:	e9 35 f6 ff ff       	jmp    8010663b <alltraps>
...
80107008:	6a 60                	push   $0x60
  jmp alltraps
8010700a:	e9 2c f6 ff ff       	jmp    8010663b <alltraps>
...
80107011:	6a 61                	push   $0x61
  jmp alltraps
80107013:	e9 23 f6 ff ff       	jmp    8010663b <alltraps>
...
8010701a:	6a 62                	push   $0x62
  jmp alltraps
8010701c:	e9 1a f6 ff ff       	jmp    8010663b <alltraps>
...
80107023:	6a 63                	push   $0x63
  jmp alltraps
80107025:	e9 11 f6 ff ff       	jmp    8010663b <alltraps>
...
8010702c:	6a 64                	push   $0x64
  jmp alltraps
8010702e:	e9 08 f6 ff ff       	jmp    8010663b <alltraps>
...
80107035:	6a 65                	push   $0x65
  jmp alltraps
80107037:	e9 ff f5 ff ff       	jmp    8010663b <alltraps>
...
8010703e:	6a 66                	push   $0x66
  jmp alltraps
80107040:	e9 f6 f5 ff ff       	jmp    8010663b <alltraps>
...
80107047:	6a 67                	push   $0x67
  jmp alltraps
80107049:	e9 ed f5 ff ff       	jmp    8010663b <alltraps>
...
80107050:	6a 68                	push   $0x68
  jmp alltraps
80107052:	e9 e4 f5 ff ff       	jmp    8010663b <alltraps>
...
80107059:	6a 69                	push   $0x69
  jmp alltraps
8010705b:	e9 db f5 ff ff       	jmp    8010663b <alltraps>
...
80107062:	6a 6a                	push   $0x6a
  jmp alltraps
80107064:	e9 d2 f5 ff ff       	jmp    8010663b <alltraps>
...
8010706b:	6a 6b                	push   $0x6b
  jmp alltraps
8010706d:	e9 c9 f5 ff ff       	jmp    8010663b <alltraps>
...
80107074:	6a 6c                	push   $0x6c
  jmp alltraps
80107076:	e9 c0 f5 ff ff       	jmp    8010663b <alltraps>
...
8010707d:	6a 6d                	push   $0x6d
  jmp alltraps
8010707f:	e9 b7 f5 ff ff       	jmp    8010663b <alltraps>
...
80107086:	6a 6e                	push   $0x6e
  jmp alltraps
80107088:	e9 ae f5 ff ff       	jmp    8010663b <alltraps>
...
8010708f:	6a 6f                	push   $0x6f
  jmp alltraps
80107091:	e9 a5 f5 ff ff       	jmp    8010663b <alltraps>
...
80107098:	6a 70                	push   $0x70
  jmp alltraps
8010709a:	e9 9c f5 ff ff       	jmp    8010663b <alltraps>
...
801070a1:	6a 71                	push   $0x71
  jmp alltraps
801070a3:	e9 93 f5 ff ff       	jmp    8010663b <alltraps>
...
801070aa:	6a 72                	push   $0x72
  jmp alltraps
801070ac:	e9 8a f5 ff ff       	jmp    8010663b <alltraps>
...
801070b3:	6a 73                	push   $0x73
  jmp alltraps
801070b5:	e9 81 f5 ff ff       	jmp    8010663b <alltraps>
...
801070bc:	6a 74                	push   $0x74
  jmp alltraps
801070be:	e9 78 f5 ff ff       	jmp    8010663b <alltraps>
...
801070c5:	6a 75                	push   $0x75
  jmp alltraps
801070c7:	e9 6f f5 ff ff       	jmp    8010663b <alltraps>
...
801070ce:	6a 76                	push   $0x76
  jmp alltraps
801070d0:	e9 66 f5 ff ff       	jmp    8010663b <alltraps>
...
801070d7:	6a 77                	push   $0x77
  jmp alltraps
801070d9:	e9 5d f5 ff ff       	jmp    8010663b <alltraps>
...
801070e0:	6a 78                	push   $0x78
  jmp alltraps
801070e2:	e9 54 f5 ff ff       	jmp    8010663b <alltraps>
...
801070e9:	6a 79                	push   $0x79
  jmp alltraps
801070eb:	e9 4b f5 ff ff       	jmp    8010663b <alltraps>
...
801070f2:	6a 7a                	push   $0x7a
  jmp alltraps
801070f4:	e9 42 f5 ff ff       	jmp    8010663b <alltraps>
...
801070fb:	6a 7b                	push   $0x7b
  jmp alltraps
801070fd:	e9 39 f5 ff ff       	jmp    8010663b <alltraps>
...
80107104:	6a 7c                	push   $0x7c
  jmp alltraps
80107106:	e9 30 f5 ff ff       	jmp    8010663b <alltraps>
...
8010710d:	6a 7d                	push   $0x7d
  jmp alltraps
8010710f:	e9 27 f5 ff ff       	jmp    8010663b <alltraps>
...
80107116:	6a 7e                	push   $0x7e
  jmp alltraps
80107118:	e9 1e f5 ff ff       	jmp    8010663b <alltraps>
...
8010711f:	6a 7f                	push   $0x7f
  jmp alltraps
80107121:	e9 15 f5 ff ff       	jmp    8010663b <alltraps>
...
80107128:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010712d:	e9 09 f5 ff ff       	jmp    8010663b <alltraps>
...
80107134:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107139:	e9 fd f4 ff ff       	jmp    8010663b <alltraps>
...
80107140:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107145:	e9 f1 f4 ff ff       	jmp    8010663b <alltraps>
...
8010714c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107151:	e9 e5 f4 ff ff       	jmp    8010663b <alltraps>
...
80107158:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010715d:	e9 d9 f4 ff ff       	jmp    8010663b <alltraps>
...
80107164:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107169:	e9 cd f4 ff ff       	jmp    8010663b <alltraps>
...
80107170:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107175:	e9 c1 f4 ff ff       	jmp    8010663b <alltraps>
...
8010717c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107181:	e9 b5 f4 ff ff       	jmp    8010663b <alltraps>
...
80107188:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010718d:	e9 a9 f4 ff ff       	jmp    8010663b <alltraps>
...
80107194:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107199:	e9 9d f4 ff ff       	jmp    8010663b <alltraps>
...
801071a0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801071a5:	e9 91 f4 ff ff       	jmp    8010663b <alltraps>
...
801071ac:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801071b1:	e9 85 f4 ff ff       	jmp    8010663b <alltraps>
...
801071b8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801071bd:	e9 79 f4 ff ff       	jmp    8010663b <alltraps>
...
801071c4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801071c9:	e9 6d f4 ff ff       	jmp    8010663b <alltraps>
...
801071d0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801071d5:	e9 61 f4 ff ff       	jmp    8010663b <alltraps>
...
801071dc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801071e1:	e9 55 f4 ff ff       	jmp    8010663b <alltraps>
...
801071e8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801071ed:	e9 49 f4 ff ff       	jmp    8010663b <alltraps>
...
801071f4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801071f9:	e9 3d f4 ff ff       	jmp    8010663b <alltraps>
...
80107200:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107205:	e9 31 f4 ff ff       	jmp    8010663b <alltraps>
...
8010720c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107211:	e9 25 f4 ff ff       	jmp    8010663b <alltraps>
...
80107218:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010721d:	e9 19 f4 ff ff       	jmp    8010663b <alltraps>
...
80107224:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107229:	e9 0d f4 ff ff       	jmp    8010663b <alltraps>
...
80107230:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107235:	e9 01 f4 ff ff       	jmp    8010663b <alltraps>
...
8010723c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107241:	e9 f5 f3 ff ff       	jmp    8010663b <alltraps>
...
80107248:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010724d:	e9 e9 f3 ff ff       	jmp    8010663b <alltraps>
...
80107254:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107259:	e9 dd f3 ff ff       	jmp    8010663b <alltraps>
...
80107260:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107265:	e9 d1 f3 ff ff       	jmp    8010663b <alltraps>
...
8010726c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107271:	e9 c5 f3 ff ff       	jmp    8010663b <alltraps>
...
80107278:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010727d:	e9 b9 f3 ff ff       	jmp    8010663b <alltraps>
...
80107284:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107289:	e9 ad f3 ff ff       	jmp    8010663b <alltraps>
...
80107290:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107295:	e9 a1 f3 ff ff       	jmp    8010663b <alltraps>
...
8010729c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801072a1:	e9 95 f3 ff ff       	jmp    8010663b <alltraps>
...
801072a8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801072ad:	e9 89 f3 ff ff       	jmp    8010663b <alltraps>
...
801072b4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801072b9:	e9 7d f3 ff ff       	jmp    8010663b <alltraps>
...
801072c0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801072c5:	e9 71 f3 ff ff       	jmp    8010663b <alltraps>
...
801072cc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801072d1:	e9 65 f3 ff ff       	jmp    8010663b <alltraps>
...
801072d8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801072dd:	e9 59 f3 ff ff       	jmp    8010663b <alltraps>
...
801072e4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801072e9:	e9 4d f3 ff ff       	jmp    8010663b <alltraps>
...
801072f0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801072f5:	e9 41 f3 ff ff       	jmp    8010663b <alltraps>
...
801072fc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107301:	e9 35 f3 ff ff       	jmp    8010663b <alltraps>
...
80107308:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010730d:	e9 29 f3 ff ff       	jmp    8010663b <alltraps>
...
80107314:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107319:	e9 1d f3 ff ff       	jmp    8010663b <alltraps>
...
80107320:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107325:	e9 11 f3 ff ff       	jmp    8010663b <alltraps>
...
8010732c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107331:	e9 05 f3 ff ff       	jmp    8010663b <alltraps>
...
80107338:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010733d:	e9 f9 f2 ff ff       	jmp    8010663b <alltraps>
...
80107344:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107349:	e9 ed f2 ff ff       	jmp    8010663b <alltraps>
...
80107350:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107355:	e9 e1 f2 ff ff       	jmp    8010663b <alltraps>
...
8010735c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107361:	e9 d5 f2 ff ff       	jmp    8010663b <alltraps>
...
80107368:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010736d:	e9 c9 f2 ff ff       	jmp    8010663b <alltraps>
...
80107374:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107379:	e9 bd f2 ff ff       	jmp    8010663b <alltraps>
...
80107380:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107385:	e9 b1 f2 ff ff       	jmp    8010663b <alltraps>
...
8010738c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107391:	e9 a5 f2 ff ff       	jmp    8010663b <alltraps>
...
80107398:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010739d:	e9 99 f2 ff ff       	jmp    8010663b <alltraps>
...
801073a4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801073a9:	e9 8d f2 ff ff       	jmp    8010663b <alltraps>
...
801073b0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801073b5:	e9 81 f2 ff ff       	jmp    8010663b <alltraps>
...
801073bc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801073c1:	e9 75 f2 ff ff       	jmp    8010663b <alltraps>
...
801073c8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801073cd:	e9 69 f2 ff ff       	jmp    8010663b <alltraps>
...
801073d4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801073d9:	e9 5d f2 ff ff       	jmp    8010663b <alltraps>
...
801073e0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801073e5:	e9 51 f2 ff ff       	jmp    8010663b <alltraps>
...
801073ec:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801073f1:	e9 45 f2 ff ff       	jmp    8010663b <alltraps>
...
801073f8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801073fd:	e9 39 f2 ff ff       	jmp    8010663b <alltraps>
...
80107404:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107409:	e9 2d f2 ff ff       	jmp    8010663b <alltraps>
...
80107410:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107415:	e9 21 f2 ff ff       	jmp    8010663b <alltraps>
...
8010741c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107421:	e9 15 f2 ff ff       	jmp    8010663b <alltraps>
...
80107428:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010742d:	e9 09 f2 ff ff       	jmp    8010663b <alltraps>
...
80107434:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107439:	e9 fd f1 ff ff       	jmp    8010663b <alltraps>
...
80107440:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107445:	e9 f1 f1 ff ff       	jmp    8010663b <alltraps>
...
8010744c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107451:	e9 e5 f1 ff ff       	jmp    8010663b <alltraps>
...
80107458:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010745d:	e9 d9 f1 ff ff       	jmp    8010663b <alltraps>
...
80107464:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107469:	e9 cd f1 ff ff       	jmp    8010663b <alltraps>
...
80107470:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107475:	e9 c1 f1 ff ff       	jmp    8010663b <alltraps>
...
8010747c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107481:	e9 b5 f1 ff ff       	jmp    8010663b <alltraps>
...
80107488:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010748d:	e9 a9 f1 ff ff       	jmp    8010663b <alltraps>
...
80107494:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107499:	e9 9d f1 ff ff       	jmp    8010663b <alltraps>
...
801074a0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801074a5:	e9 91 f1 ff ff       	jmp    8010663b <alltraps>
...
801074ac:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801074b1:	e9 85 f1 ff ff       	jmp    8010663b <alltraps>
...
801074b8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801074bd:	e9 79 f1 ff ff       	jmp    8010663b <alltraps>
...
801074c4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801074c9:	e9 6d f1 ff ff       	jmp    8010663b <alltraps>
...
801074d0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801074d5:	e9 61 f1 ff ff       	jmp    8010663b <alltraps>
...
801074dc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801074e1:	e9 55 f1 ff ff       	jmp    8010663b <alltraps>
...
801074e8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801074ed:	e9 49 f1 ff ff       	jmp    8010663b <alltraps>
...
801074f4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801074f9:	e9 3d f1 ff ff       	jmp    8010663b <alltraps>
...
80107500:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107505:	e9 31 f1 ff ff       	jmp    8010663b <alltraps>
...
8010750c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107511:	e9 25 f1 ff ff       	jmp    8010663b <alltraps>
...
80107518:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010751d:	e9 19 f1 ff ff       	jmp    8010663b <alltraps>
...
80107524:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107529:	e9 0d f1 ff ff       	jmp    8010663b <alltraps>
...
80107530:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107535:	e9 01 f1 ff ff       	jmp    8010663b <alltraps>
...
8010753c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107541:	e9 f5 f0 ff ff       	jmp    8010663b <alltraps>
...
80107548:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010754d:	e9 e9 f0 ff ff       	jmp    8010663b <alltraps>
...
80107554:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107559:	e9 dd f0 ff ff       	jmp    8010663b <alltraps>
...
80107560:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107565:	e9 d1 f0 ff ff       	jmp    8010663b <alltraps>
...
8010756c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107571:	e9 c5 f0 ff ff       	jmp    8010663b <alltraps>
...
80107578:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010757d:	e9 b9 f0 ff ff       	jmp    8010663b <alltraps>
...
80107584:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107589:	e9 ad f0 ff ff       	jmp    8010663b <alltraps>
...
80107590:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107595:	e9 a1 f0 ff ff       	jmp    8010663b <alltraps>
...
8010759c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801075a1:	e9 95 f0 ff ff       	jmp    8010663b <alltraps>
...
801075a8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801075ad:	e9 89 f0 ff ff       	jmp    8010663b <alltraps>
...
801075b4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801075b9:	e9 7d f0 ff ff       	jmp    8010663b <alltraps>
...
801075c0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801075c5:	e9 71 f0 ff ff       	jmp    8010663b <alltraps>
...
801075cc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801075d1:	e9 65 f0 ff ff       	jmp    8010663b <alltraps>
...
801075d8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801075dd:	e9 59 f0 ff ff       	jmp    8010663b <alltraps>
...
801075e4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801075e9:	e9 4d f0 ff ff       	jmp    8010663b <alltraps>
...
801075f0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801075f5:	e9 41 f0 ff ff       	jmp    8010663b <alltraps>
...
801075fc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107601:	e9 35 f0 ff ff       	jmp    8010663b <alltraps>
...
80107608:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010760d:	e9 29 f0 ff ff       	jmp    8010663b <alltraps>
...
80107614:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107619:	e9 1d f0 ff ff       	jmp    8010663b <alltraps>
...
80107620:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107625:	e9 11 f0 ff ff       	jmp    8010663b <alltraps>
...
8010762c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107631:	e9 05 f0 ff ff       	jmp    8010663b <alltraps>
...
80107638:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010763d:	e9 f9 ef ff ff       	jmp    8010663b <alltraps>
...
80107644:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107649:	e9 ed ef ff ff       	jmp    8010663b <alltraps>
...
80107650:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107655:	e9 e1 ef ff ff       	jmp    8010663b <alltraps>
...
8010765c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107661:	e9 d5 ef ff ff       	jmp    8010663b <alltraps>
...
80107668:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010766d:	e9 c9 ef ff ff       	jmp    8010663b <alltraps>
...
80107674:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107679:	e9 bd ef ff ff       	jmp    8010663b <alltraps>
...
80107680:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107685:	e9 b1 ef ff ff       	jmp    8010663b <alltraps>
...
8010768c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107691:	e9 a5 ef ff ff       	jmp    8010663b <alltraps>
...
80107698:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010769d:	e9 99 ef ff ff       	jmp    8010663b <alltraps>
...
801076a4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801076a9:	e9 8d ef ff ff       	jmp    8010663b <alltraps>
...
801076b0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801076b5:	e9 81 ef ff ff       	jmp    8010663b <alltraps>
...
801076bc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801076c1:	e9 75 ef ff ff       	jmp    8010663b <alltraps>
...
801076c8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801076cd:	e9 69 ef ff ff       	jmp    8010663b <alltraps>
...
801076d4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801076d9:	e9 5d ef ff ff       	jmp    8010663b <alltraps>
...
801076e0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801076e5:	e9 51 ef ff ff       	jmp    8010663b <alltraps>
...
801076ec:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801076f1:	e9 45 ef ff ff       	jmp    8010663b <alltraps>
...
801076f8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801076fd:	e9 39 ef ff ff       	jmp    8010663b <alltraps>
...
80107704:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107709:	e9 2d ef ff ff       	jmp    8010663b <alltraps>
...
80107710:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107715:	e9 21 ef ff ff       	jmp    8010663b <alltraps>
...
8010771c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107721:	e9 15 ef ff ff       	jmp    8010663b <alltraps>
...
80107729:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
8010772c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010772f:	83 e8 01             	sub    $0x1,%eax
80107732:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107736:	8b 45 08             	mov    0x8(%ebp),%eax
80107739:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010773d:	8b 45 08             	mov    0x8(%ebp),%eax
80107740:	c1 e8 10             	shr    $0x10,%eax
80107743:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107747:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010774a:	0f 01 10             	lgdtl  (%eax)
}
8010774d:	c9                   	leave  
8010774e:	c3                   	ret    
...
8010776e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107772:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107776:	8e e8                	mov    %eax,%gs
}
80107778:	c9                   	leave  
80107779:	c3                   	ret    
...
801077a2:	53                   	push   %ebx
801077a3:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801077a6:	e8 9c b6 ff ff       	call   80102e47 <cpunum>
801077ab:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801077b1:	05 40 f9 10 80       	add    $0x8010f940,%eax
801077b6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801077b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077bc:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801077c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c5:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801077cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ce:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801077d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077d5:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
...
801077f6:	83 e2 9f             	and    $0xffffff9f,%edx
...
8010784d:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107851:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107854:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
8010785b:	ff ff 
8010785d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107860:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107867:	00 00 
80107869:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010786c:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107873:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107876:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010787d:	83 e2 f0             	and    $0xfffffff0,%edx
80107880:	83 ca 02             	or     $0x2,%edx
...
801078a6:	83 e2 9f             	and    $0xffffff9f,%edx
...
801078b9:	83 ca 80             	or     $0xffffff80,%edx
...
80107957:	83 e2 f0             	and    $0xfffffff0,%edx
8010795a:	83 ca 0a             	or     $0xa,%edx
8010795d:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107963:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107966:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010796d:	83 ca 10             	or     $0x10,%edx
...
801079f2:	83 ca 80             	or     $0xffffff80,%edx
801079f5:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801079fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079fe:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107a05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a08:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107a0f:	ff ff 
80107a11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a14:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107a1b:	00 00 
80107a1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a20:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107a27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a2a:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107a31:	83 e2 f0             	and    $0xfffffff0,%edx
80107a34:	83 ca 02             	or     $0x2,%edx
...
80107a79:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107a80:	83 ca 0f             	or     $0xf,%edx
80107a83:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
...
80107b06:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107b0d:	00 00 
80107b0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b12:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107b19:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b1c:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107b22:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b25:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b2c:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b2f:	83 c9 02             	or     $0x2,%ecx
80107b32:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b3b:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b42:	83 c9 10             	or     $0x10,%ecx
80107b45:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b4e:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b55:	83 e1 9f             	and    $0xffffff9f,%ecx
80107b58:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b61:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b68:	83 c9 80             	or     $0xffffff80,%ecx
80107b6b:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b74:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b7b:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b7e:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b87:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b8e:	83 e1 ef             	and    $0xffffffef,%ecx
80107b91:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b9a:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107ba1:	83 e1 df             	and    $0xffffffdf,%ecx
80107ba4:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107baa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bad:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107bb4:	83 c9 40             	or     $0x40,%ecx
80107bb7:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107bbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bc0:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107bc7:	83 c9 80             	or     $0xffffff80,%ecx
80107bca:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107bd0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bd3:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107bd9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bdc:	83 c0 70             	add    $0x70,%eax
80107bdf:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107be6:	00 
80107be7:	89 04 24             	mov    %eax,(%esp)
80107bea:	e8 37 fb ff ff       	call   80107726 <lgdt>
  loadgs(SEG_KCPU << 3);
80107bef:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107bf6:	e8 6a fb ff ff       	call   80107765 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107bfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bfe:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107c04:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107c0b:	00 00 00 00 
}
80107c0f:	83 c4 24             	add    $0x24,%esp
80107c12:	5b                   	pop    %ebx
80107c13:	5d                   	pop    %ebp
80107c14:	c3                   	ret    
...
80107c18:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107c1b:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c1e:	c1 e8 16             	shr    $0x16,%eax
...
80107c35:	83 e0 01             	and    $0x1,%eax
80107c38:	85 c0                	test   %eax,%eax
80107c3a:	74 17                	je     80107c53 <walkpgdir+0x3e>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107c3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c3f:	8b 00                	mov    (%eax),%eax
80107c41:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107c46:	89 04 24             	mov    %eax,(%esp)
80107c49:	e8 44 fb ff ff       	call   80107792 <p2v>
80107c4e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c51:	eb 4b                	jmp    80107c9e <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107c53:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107c57:	74 0e                	je     80107c67 <walkpgdir+0x52>
80107c59:	e8 70 ae ff ff       	call   80102ace <kalloc>
80107c5e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c61:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107c65:	75 07                	jne    80107c6e <walkpgdir+0x59>
      return 0;
80107c67:	b8 00 00 00 00       	mov    $0x0,%eax
80107c6c:	eb 47                	jmp    80107cb5 <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107c6e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c75:	00 
80107c76:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c7d:	00 
80107c7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c81:	89 04 24             	mov    %eax,(%esp)
80107c84:	e8 4a d4 ff ff       	call   801050d3 <memset>
...
80107c8f:	e8 f1 fa ff ff       	call   80107785 <v2p>
80107c94:	83 c8 07             	or     $0x7,%eax
80107c97:	89 c2                	mov    %eax,%edx
80107c99:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c9c:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107c9e:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ca1:	c1 e8 0c             	shr    $0xc,%eax
...
80107cba:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
  
  a = (char*)PGROUNDDOWN((uint)va);
80107cbd:	8b 45 0c             	mov    0xc(%ebp),%eax
80107cc0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
80107cd0:	83 e8 01             	sub    $0x1,%eax
80107cd3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107cd8:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107cdb:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107ce2:	00 
80107ce3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ce6:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cea:	8b 45 08             	mov    0x8(%ebp),%eax
80107ced:	89 04 24             	mov    %eax,(%esp)
80107cf0:	e8 20 ff ff ff       	call   80107c15 <walkpgdir>
80107cf5:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107cf8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107cfc:	75 07                	jne    80107d05 <mappages+0x4e>
      return -1;
80107cfe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107d03:	eb 48                	jmp    80107d4d <mappages+0x96>
    if(*pte & PTE_P)
80107d05:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107d08:	8b 00                	mov    (%eax),%eax
80107d0a:	83 e0 01             	and    $0x1,%eax
80107d0d:	85 c0                	test   %eax,%eax
80107d0f:	74 0c                	je     80107d1d <mappages+0x66>
      panic("remap");
80107d11:	c7 04 24 3c 8b 10 80 	movl   $0x80108b3c,(%esp)
80107d18:	e8 1d 88 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80107d1d:	8b 45 18             	mov    0x18(%ebp),%eax
80107d20:	0b 45 14             	or     0x14(%ebp),%eax
80107d23:	83 c8 01             	or     $0x1,%eax
80107d26:	89 c2                	mov    %eax,%edx
80107d28:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107d2b:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107d2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d30:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107d33:	75 08                	jne    80107d3d <mappages+0x86>
      break;
80107d35:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107d3b:	eb 10                	jmp    80107d4d <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
80107d3d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107d44:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107d4b:	eb 8e                	jmp    80107cdb <mappages+0x24>
  return 0;
}
80107d4d:	c9                   	leave  
80107d4e:	c3                   	ret    
...
80107d53:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107d56:	e8 73 ad ff ff       	call   80102ace <kalloc>
80107d5b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107d5e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107d62:	75 0a                	jne    80107d6e <setupkvm+0x1f>
    return 0;
80107d64:	b8 00 00 00 00       	mov    $0x0,%eax
80107d69:	e9 98 00 00 00       	jmp    80107e06 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107d6e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107d75:	00 
80107d76:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107d7d:	00 
80107d7e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d81:	89 04 24             	mov    %eax,(%esp)
80107d84:	e8 4a d3 ff ff       	call   801050d3 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107d89:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107d90:	e8 fd f9 ff ff       	call   80107792 <p2v>
80107d95:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107d9a:	76 0c                	jbe    80107da8 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107d9c:	c7 04 24 42 8b 10 80 	movl   $0x80108b42,(%esp)
80107da3:	e8 92 87 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107da8:	c7 45 f4 c0 b4 10 80 	movl   $0x8010b4c0,-0xc(%ebp)
80107daf:	eb 49                	jmp    80107dfa <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107db1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107db4:	8b 48 0c             	mov    0xc(%eax),%ecx
80107db7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dba:	8b 50 04             	mov    0x4(%eax),%edx
80107dbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc0:	8b 58 08             	mov    0x8(%eax),%ebx
80107dc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc6:	8b 40 04             	mov    0x4(%eax),%eax
80107dc9:	29 c3                	sub    %eax,%ebx
80107dcb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dce:	8b 00                	mov    (%eax),%eax
80107dd0:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107dd4:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107dd8:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107ddc:	89 44 24 04          	mov    %eax,0x4(%esp)
80107de0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107de3:	89 04 24             	mov    %eax,(%esp)
80107de6:	e8 cc fe ff ff       	call   80107cb7 <mappages>
80107deb:	85 c0                	test   %eax,%eax
80107ded:	79 07                	jns    80107df6 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107def:	b8 00 00 00 00       	mov    $0x0,%eax
80107df4:	eb 10                	jmp    80107e06 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107df6:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107dfa:	81 7d f4 00 b5 10 80 	cmpl   $0x8010b500,-0xc(%ebp)
80107e01:	72 ae                	jb     80107db1 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107e06:	83 c4 34             	add    $0x34,%esp
80107e09:	5b                   	pop    %ebx
80107e0a:	5d                   	pop    %ebp
80107e0b:	c3                   	ret    
...
80107e0f:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107e12:	e8 38 ff ff ff       	call   80107d4f <setupkvm>
80107e17:	a3 38 51 11 80       	mov    %eax,0x80115138
  switchkvm();
80107e1c:	e8 02 00 00 00       	call   80107e23 <switchkvm>
}
80107e21:	c9                   	leave  
80107e22:	c3                   	ret    
...
80107e29:	a1 38 51 11 80       	mov    0x80115138,%eax
80107e2e:	89 04 24             	mov    %eax,(%esp)
80107e31:	e8 4f f9 ff ff       	call   80107785 <v2p>
80107e36:	89 04 24             	mov    %eax,(%esp)
80107e39:	e8 3c f9 ff ff       	call   8010777a <lcr3>
}
80107e3e:	c9                   	leave  
80107e3f:	c3                   	ret    
...
80107e44:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107e47:	e8 90 d0 ff ff       	call   80104edc <pushcli>
...
80107e68:	c1 ea 10             	shr    $0x10,%edx
80107e6b:	89 d1                	mov    %edx,%ecx
80107e6d:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e74:	83 c2 08             	add    $0x8,%edx
80107e77:	c1 ea 18             	shr    $0x18,%edx
80107e7a:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107e81:	67 00 
80107e83:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107e8a:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107e90:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e97:	83 e1 f0             	and    $0xfffffff0,%ecx
80107e9a:	83 c9 09             	or     $0x9,%ecx
80107e9d:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ea3:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107eaa:	83 c9 10             	or     $0x10,%ecx
80107ead:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107eb3:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107eba:	83 e1 9f             	and    $0xffffff9f,%ecx
80107ebd:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ec3:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107eca:	83 c9 80             	or     $0xffffff80,%ecx
80107ecd:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ed3:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107eda:	83 e1 f0             	and    $0xfffffff0,%ecx
80107edd:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ee3:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107eea:	83 e1 ef             	and    $0xffffffef,%ecx
80107eed:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ef3:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107efa:	83 e1 df             	and    $0xffffffdf,%ecx
80107efd:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107f03:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107f0a:	83 c9 40             	or     $0x40,%ecx
80107f0d:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107f13:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107f1a:	83 e1 7f             	and    $0x7f,%ecx
80107f1d:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107f23:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107f29:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f2f:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107f36:	83 e2 ef             	and    $0xffffffef,%edx
80107f39:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107f3f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f45:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107f4b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f51:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107f58:	8b 52 08             	mov    0x8(%edx),%edx
80107f5b:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107f61:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107f64:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107f6b:	e8 df f7 ff ff       	call   8010774f <ltr>
  if(p->pgdir == 0)
80107f70:	8b 45 08             	mov    0x8(%ebp),%eax
80107f73:	8b 40 04             	mov    0x4(%eax),%eax
80107f76:	85 c0                	test   %eax,%eax
80107f78:	75 0c                	jne    80107f86 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107f7a:	c7 04 24 53 8b 10 80 	movl   $0x80108b53,(%esp)
80107f81:	e8 b4 85 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107f86:	8b 45 08             	mov    0x8(%ebp),%eax
80107f89:	8b 40 04             	mov    0x4(%eax),%eax
80107f8c:	89 04 24             	mov    %eax,(%esp)
80107f8f:	e8 f1 f7 ff ff       	call   80107785 <v2p>
80107f94:	89 04 24             	mov    %eax,(%esp)
80107f97:	e8 de f7 ff ff       	call   8010777a <lcr3>
  popcli();
80107f9c:	e8 7f cf ff ff       	call   80104f20 <popcli>
}
80107fa1:	83 c4 14             	add    $0x14,%esp
80107fa4:	5b                   	pop    %ebx
80107fa5:	5d                   	pop    %ebp
80107fa6:	c3                   	ret    
...
80107faa:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107fad:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107fb4:	76 0c                	jbe    80107fc2 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107fb6:	c7 04 24 67 8b 10 80 	movl   $0x80108b67,(%esp)
80107fbd:	e8 78 85 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107fc2:	e8 07 ab ff ff       	call   80102ace <kalloc>
80107fc7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107fca:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107fd1:	00 
80107fd2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107fd9:	00 
80107fda:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fdd:	89 04 24             	mov    %eax,(%esp)
80107fe0:	e8 ee d0 ff ff       	call   801050d3 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107fe5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe8:	89 04 24             	mov    %eax,(%esp)
80107feb:	e8 95 f7 ff ff       	call   80107785 <v2p>
80107ff0:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107ff7:	00 
80107ff8:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107ffc:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108003:	00 
80108004:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010800b:	00 
8010800c:	8b 45 08             	mov    0x8(%ebp),%eax
8010800f:	89 04 24             	mov    %eax,(%esp)
80108012:	e8 a0 fc ff ff       	call   80107cb7 <mappages>
  memmove(mem, init, sz);
80108017:	8b 45 10             	mov    0x10(%ebp),%eax
8010801a:	89 44 24 08          	mov    %eax,0x8(%esp)
8010801e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108021:	89 44 24 04          	mov    %eax,0x4(%esp)
80108025:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108028:	89 04 24             	mov    %eax,(%esp)
8010802b:	e8 72 d1 ff ff       	call   801051a2 <memmove>
}
80108030:	c9                   	leave  
80108031:	c3                   	ret    
...
8010803c:	25 ff 0f 00 00       	and    $0xfff,%eax
80108041:	85 c0                	test   %eax,%eax
80108043:	74 0c                	je     80108051 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80108045:	c7 04 24 84 8b 10 80 	movl   $0x80108b84,(%esp)
8010804c:	e8 e9 84 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108051:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108058:	e9 a9 00 00 00       	jmp    80108106 <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010805d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108060:	8b 55 0c             	mov    0xc(%ebp),%edx
80108063:	01 d0                	add    %edx,%eax
80108065:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010806c:	00 
8010806d:	89 44 24 04          	mov    %eax,0x4(%esp)
80108071:	8b 45 08             	mov    0x8(%ebp),%eax
80108074:	89 04 24             	mov    %eax,(%esp)
80108077:	e8 99 fb ff ff       	call   80107c15 <walkpgdir>
8010807c:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010807f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108083:	75 0c                	jne    80108091 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108085:	c7 04 24 a7 8b 10 80 	movl   $0x80108ba7,(%esp)
...
801080a8:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801080ad:	77 0f                	ja     801080be <loaduvm+0x8c>
      n = sz - i;
801080af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b2:	8b 55 18             	mov    0x18(%ebp),%edx
801080b5:	29 c2                	sub    %eax,%edx
801080b7:	89 d0                	mov    %edx,%eax
801080b9:	89 45 f0             	mov    %eax,-0x10(%ebp)
801080bc:	eb 07                	jmp    801080c5 <loaduvm+0x93>
    else
      n = PGSIZE;
801080be:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801080c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c8:	8b 55 14             	mov    0x14(%ebp),%edx
801080cb:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801080ce:	8b 45 e8             	mov    -0x18(%ebp),%eax
801080d1:	89 04 24             	mov    %eax,(%esp)
801080d4:	e8 b9 f6 ff ff       	call   80107792 <p2v>
801080d9:	8b 55 f0             	mov    -0x10(%ebp),%edx
801080dc:	89 54 24 0c          	mov    %edx,0xc(%esp)
801080e0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801080e4:	89 44 24 04          	mov    %eax,0x4(%esp)
801080e8:	8b 45 10             	mov    0x10(%ebp),%eax
801080eb:	89 04 24             	mov    %eax,(%esp)
801080ee:	e8 61 9c ff ff       	call   80101d54 <readi>
801080f3:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801080f6:	74 07                	je     801080ff <loaduvm+0xcd>
      return -1;
801080f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801080fd:	eb 18                	jmp    80108117 <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801080ff:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108106:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108109:	3b 45 18             	cmp    0x18(%ebp),%eax
8010810c:	0f 82 4b ff ff ff    	jb     8010805d <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108117:	83 c4 24             	add    $0x24,%esp
8010811a:	5b                   	pop    %ebx
8010811b:	5d                   	pop    %ebp
8010811c:	c3                   	ret    
...
80108120:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80108128:	79 0a                	jns    80108134 <allocuvm+0x17>
    return 0;
8010812a:	b8 00 00 00 00       	mov    $0x0,%eax
8010812f:	e9 c1 00 00 00       	jmp    801081f5 <allocuvm+0xd8>
  if(newsz < oldsz)
80108134:	8b 45 10             	mov    0x10(%ebp),%eax
80108137:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010813a:	73 08                	jae    80108144 <allocuvm+0x27>
    return oldsz;
8010813c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010813f:	e9 b1 00 00 00       	jmp    801081f5 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80108144:	8b 45 0c             	mov    0xc(%ebp),%eax
80108147:	05 ff 0f 00 00       	add    $0xfff,%eax
8010814c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108151:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108154:	e9 8d 00 00 00       	jmp    801081e6 <allocuvm+0xc9>
    mem = kalloc();
80108159:	e8 70 a9 ff ff       	call   80102ace <kalloc>
8010815e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108161:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108165:	75 2c                	jne    80108193 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108167:	c7 04 24 c5 8b 10 80 	movl   $0x80108bc5,(%esp)
8010816e:	e8 2d 82 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108173:	8b 45 0c             	mov    0xc(%ebp),%eax
80108176:	89 44 24 08          	mov    %eax,0x8(%esp)
8010817a:	8b 45 10             	mov    0x10(%ebp),%eax
8010817d:	89 44 24 04          	mov    %eax,0x4(%esp)
80108181:	8b 45 08             	mov    0x8(%ebp),%eax
80108184:	89 04 24             	mov    %eax,(%esp)
80108187:	e8 6b 00 00 00       	call   801081f7 <deallocuvm>
      return 0;
8010818c:	b8 00 00 00 00       	mov    $0x0,%eax
80108191:	eb 62                	jmp    801081f5 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108193:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010819a:	00 
8010819b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801081a2:	00 
801081a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081a6:	89 04 24             	mov    %eax,(%esp)
801081a9:	e8 25 cf ff ff       	call   801050d3 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801081ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081b1:	89 04 24             	mov    %eax,(%esp)
801081b4:	e8 cc f5 ff ff       	call   80107785 <v2p>
801081b9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801081bc:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801081c3:	00 
801081c4:	89 44 24 0c          	mov    %eax,0xc(%esp)
801081c8:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081cf:	00 
801081d0:	89 54 24 04          	mov    %edx,0x4(%esp)
801081d4:	8b 45 08             	mov    0x8(%ebp),%eax
801081d7:	89 04 24             	mov    %eax,(%esp)
801081da:	e8 d8 fa ff ff       	call   80107cb7 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
801081ec:	0f 82 67 ff ff ff    	jb     80108159 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108208:	e9 a4 00 00 00       	jmp    801082b1 <deallocuvm+0xba>
...
8010821d:	e9 80 00 00 00       	jmp    801082a2 <deallocuvm+0xab>
...
80108237:	e8 d9 f9 ff ff       	call   80107c15 <walkpgdir>
8010823c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
8010823f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108243:	75 09                	jne    8010824e <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108245:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
8010824c:	eb 4d                	jmp    8010829b <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
8010824e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108251:	8b 00                	mov    (%eax),%eax
80108253:	83 e0 01             	and    $0x1,%eax
80108256:	85 c0                	test   %eax,%eax
80108258:	74 41                	je     8010829b <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
8010825a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010825d:	8b 00                	mov    (%eax),%eax
8010825f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108264:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108267:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010826b:	75 0c                	jne    80108279 <deallocuvm+0x82>
        panic("kfree");
8010826d:	c7 04 24 dd 8b 10 80 	movl   $0x80108bdd,(%esp)
80108274:	e8 c1 82 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
80108279:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010827c:	89 04 24             	mov    %eax,(%esp)
8010827f:	e8 0e f5 ff ff       	call   80107792 <p2v>
80108284:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108287:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010828a:	89 04 24             	mov    %eax,(%esp)
8010828d:	e8 a3 a7 ff ff       	call   80102a35 <kfree>
      *pte = 0;
...
801082a8:	0f 82 74 ff ff ff    	jb     80108222 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801082b6:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
801082b9:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801082bd:	75 0c                	jne    801082cb <freevm+0x18>
    panic("freevm: no pgdir");
801082bf:	c7 04 24 e3 8b 10 80 	movl   $0x80108be3,(%esp)
801082c6:	e8 6f 82 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801082cb:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801082d2:	00 
801082d3:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801082da:	80 
801082db:	8b 45 08             	mov    0x8(%ebp),%eax
801082de:	89 04 24             	mov    %eax,(%esp)
801082e1:	e8 11 ff ff ff       	call   801081f7 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801082e6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801082ed:	eb 48                	jmp    80108337 <freevm+0x84>
    if(pgdir[i] & PTE_P){
...
80108300:	83 e0 01             	and    $0x1,%eax
80108303:	85 c0                	test   %eax,%eax
80108305:	74 2c                	je     80108333 <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108307:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010830a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108311:	8b 45 08             	mov    0x8(%ebp),%eax
80108314:	01 d0                	add    %edx,%eax
80108316:	8b 00                	mov    (%eax),%eax
80108318:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010831d:	89 04 24             	mov    %eax,(%esp)
80108320:	e8 6d f4 ff ff       	call   80107792 <p2v>
80108325:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108328:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010832b:	89 04 24             	mov    %eax,(%esp)
8010832e:	e8 02 a7 ff ff       	call   80102a35 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108333:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108337:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
8010833e:	76 af                	jbe    801082ef <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108346:	e8 ea a6 ff ff       	call   80102a35 <kfree>
}
8010834b:	c9                   	leave  
8010834c:	c3                   	ret    
...
80108353:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010835a:	00 
8010835b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010835e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108362:	8b 45 08             	mov    0x8(%ebp),%eax
80108365:	89 04 24             	mov    %eax,(%esp)
80108368:	e8 a8 f8 ff ff       	call   80107c15 <walkpgdir>
8010836d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108370:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108374:	75 0c                	jne    80108382 <clearpteu+0x35>
    panic("clearpteu");
80108376:	c7 04 24 f4 8b 10 80 	movl   $0x80108bf4,(%esp)
8010837d:	e8 b8 81 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
...
80108396:	53                   	push   %ebx
80108397:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010839a:	e8 b0 f9 ff ff       	call   80107d4f <setupkvm>
8010839f:	89 45 f0             	mov    %eax,-0x10(%ebp)
801083a2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801083a6:	75 0a                	jne    801083b2 <copyuvm+0x1f>
    return 0;
801083a8:	b8 00 00 00 00       	mov    $0x0,%eax
801083ad:	e9 fd 00 00 00       	jmp    801084af <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
801083b2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801083b9:	e9 d0 00 00 00       	jmp    8010848e <copyuvm+0xfb>
...
801083d3:	e8 3d f8 ff ff       	call   80107c15 <walkpgdir>
801083d8:	89 45 ec             	mov    %eax,-0x14(%ebp)
801083db:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801083df:	75 0c                	jne    801083ed <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801083e1:	c7 04 24 fe 8b 10 80 	movl   $0x80108bfe,(%esp)
...
801083f7:	75 0c                	jne    80108405 <copyuvm+0x72>
      panic("copyuvm: page not present");
801083f9:	c7 04 24 18 8c 10 80 	movl   $0x80108c18,(%esp)
80108400:	e8 35 81 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
...
8010841c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010841f:	e8 aa a6 ff ff       	call   80102ace <kalloc>
80108424:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108427:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
8010842b:	75 02                	jne    8010842f <copyuvm+0x9c>
      goto bad;
8010842d:	eb 70                	jmp    8010849f <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
8010842f:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108432:	89 04 24             	mov    %eax,(%esp)
80108435:	e8 58 f3 ff ff       	call   80107792 <p2v>
8010843a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108441:	00 
80108442:	89 44 24 04          	mov    %eax,0x4(%esp)
80108446:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108449:	89 04 24             	mov    %eax,(%esp)
8010844c:	e8 51 cd ff ff       	call   801051a2 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108451:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108454:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108457:	89 04 24             	mov    %eax,(%esp)
8010845a:	e8 26 f3 ff ff       	call   80107785 <v2p>
8010845f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108462:	89 5c 24 10          	mov    %ebx,0x10(%esp)
...
8010847c:	e8 36 f8 ff ff       	call   80107cb7 <mappages>
80108481:	85 c0                	test   %eax,%eax
80108483:	79 02                	jns    80108487 <copyuvm+0xf4>
      goto bad;
80108485:	eb 18                	jmp    8010849f <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108487:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010848e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108491:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108494:	0f 82 24 ff ff ff    	jb     801083be <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
8010849d:	eb 10                	jmp    801084af <copyuvm+0x11c>

bad:
  freevm(d);
8010849f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084a2:	89 04 24             	mov    %eax,(%esp)
801084a5:	e8 09 fe ff ff       	call   801082b3 <freevm>
  return 0;
801084aa:	b8 00 00 00 00       	mov    $0x0,%eax
}
801084af:	83 c4 44             	add    $0x44,%esp
801084b2:	5b                   	pop    %ebx
801084b3:	5d                   	pop    %ebp
801084b4:	c3                   	ret    
...
801084b8:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
801084bb:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801084c2:	00 
801084c3:	8b 45 0c             	mov    0xc(%ebp),%eax
801084c6:	89 44 24 04          	mov    %eax,0x4(%esp)
801084ca:	8b 45 08             	mov    0x8(%ebp),%eax
801084cd:	89 04 24             	mov    %eax,(%esp)
801084d0:	e8 40 f7 ff ff       	call   80107c15 <walkpgdir>
...
8010850b:	e8 82 f2 ff ff       	call   80107792 <p2v>
}
80108510:	c9                   	leave  
80108511:	c3                   	ret    
...
80108515:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
8010851b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
8010851e:	e9 87 00 00 00       	jmp    801085aa <copyout+0x98>
...
8010853b:	e8 75 ff ff ff       	call   801084b5 <uva2ka>
80108540:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108543:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108547:	75 07                	jne    80108550 <copyout+0x3e>
      return -1;
80108549:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010854e:	eb 69                	jmp    801085b9 <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108550:	8b 45 0c             	mov    0xc(%ebp),%eax
80108553:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108556:	29 c2                	sub    %eax,%edx
80108558:	89 d0                	mov    %edx,%eax
8010855a:	05 00 10 00 00       	add    $0x1000,%eax
8010855f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108562:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108565:	3b 45 14             	cmp    0x14(%ebp),%eax
80108568:	76 06                	jbe    80108570 <copyout+0x5e>
      n = len;
8010856a:	8b 45 14             	mov    0x14(%ebp),%eax
8010856d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108570:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108573:	8b 55 0c             	mov    0xc(%ebp),%edx
80108576:	29 c2                	sub    %eax,%edx
80108578:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010857b:	01 c2                	add    %eax,%edx
8010857d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108580:	89 44 24 08          	mov    %eax,0x8(%esp)
80108584:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108587:	89 44 24 04          	mov    %eax,0x4(%esp)
8010858b:	89 14 24             	mov    %edx,(%esp)
8010858e:	e8 0f cc ff ff       	call   801051a2 <memmove>
    len -= n;
80108593:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108596:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108599:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010859c:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
8010859f:	8b 45 ec             	mov    -0x14(%ebp),%eax
801085a2:	05 00 10 00 00       	add    $0x1000,%eax
801085a7:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
801085aa:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
801085ae:	0f 85 6f ff ff ff    	jne    80108523 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
