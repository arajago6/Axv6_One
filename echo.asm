...
main(int argc, char *argv[])
{
  ...
  1f:	b8 50 08 00 00       	mov    $0x850,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 52 08 00 00       	mov    $0x852,%eax
  ...
  45:	c7 44 24 04 54 08 00 	movl   $0x854,0x4(%esp)
  4c:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41d:	0f b6 80 a4 0a 00 00 	movzbl 0xaa4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 57a:	75 09                	jne    585 <printf+0x101>
          s = "(null)";
 57c:	c7 45 f4 59 08 00 00 	movl   $0x859,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 646:	a1 c0 0a 00 00       	mov    0xac0,%eax
...
free(void *ap)
{
 ...
 711:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 716:	c9                   	leave  
 717:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 793:	c7 45 f0 b8 0a 00 00 	movl   $0xab8,-0x10(%ebp)
 79a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79d:	a3 c0 0a 00 00       	mov    %eax,0xac0
 7a2:	a1 c0 0a 00 00       	mov    0xac0,%eax
 7a7:	a3 b8 0a 00 00       	mov    %eax,0xab8
    base.s.size = 0;
 7ac:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 7b3:	00 00 00 
  }
 ...
 809:	a3 c0 0a 00 00       	mov    %eax,0xac0
      return (void*)(p + 1);
 ...
 814:	eb 38                	jmp    84e <malloc+0xde>
    ...
    if(p == freep)
 816:	a1 c0 0a 00 00       	mov    0xac0,%eax
